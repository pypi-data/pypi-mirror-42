...
class CreatePromptRequest(object):
    ...
    def __init__(self, body=None, title=None, reject_text=None, expires_in=None, long_poll=None, user=None, approve_text=None, approve_redirect_url=None, reject_redirect_url=None, metadata=None):  # noqa: E501
