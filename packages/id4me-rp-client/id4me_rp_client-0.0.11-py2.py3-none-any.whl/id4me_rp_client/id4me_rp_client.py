...
class ID4meContext(object):
    def __init__(self, id4me, identity_authority, issuer):
        ...
        #     else None
        # self.userinfo_encrypted_response_alg = registration['userinfo_encrypted_response_alg'] \
        #     if 'userinfo_encrypted_response_alg' in registration \
        #     else None
        self.nonce = None
    ...
    def get_rp_context(self, id4me):
        ...
        if registration is None:
            if self.save_client_registration is None:
                raise ID4meRelyingPartyRegistrationException(
                    "Authority {} not found in store and dynamic registration disabled "
