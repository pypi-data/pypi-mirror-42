    ...
    def set_properties(self, res):
        ...
        for key, value in res.items():
            if hasattr(self, key):
                ...
                raise Exception("Object %s does not have a %s attribute" %
                                (self.ID, key))
...
class ProjectVersion(LbBaseGraphObject):
    ...
    __primarykey__ = "name"
    __primarylabel__ = 'ProjectVersion'
    ...
    def __init__(self, project, version):
        self.project_name = str(project).upper()
...
class DatapkgVersion(LbBaseGraphObject):
    ...
    __primarykey__ = "name"
    __primarylabel__ = 'DatapkgVersion'

    name = Property()
    datapkg_name = Property()
    version = Property()

    def __init__(self, datapkg, version):
        self.datapkg_name = str(datapkg).upper()
        self.version = str(version)
