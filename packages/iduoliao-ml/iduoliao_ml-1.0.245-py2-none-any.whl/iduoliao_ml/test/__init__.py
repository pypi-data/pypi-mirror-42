...
def recordEsToRedis():
	...
	while True:
		...
		for nextUid in nextUids:
			...
			hits = es.scrollSearch('statistics_works_hot_fixed_backups', 'recommendviewrecordsearch', {"query":{"bool":{"must":[{"range":{"time":{"lte":1550567400000}}},{"term":{"uid":{"value":nextUid}}}]}},"size":10000})
			for hit in hits:
