...
class GetHitsThread(threading.Thread):
	...
	def run(self):
		self.hits = es.scrollSearch('statistics_works_hot_fixed_backups', 'recommendviewrecordsearch', {"query":{"bool":{"must":[{"range":{"time":{"lte":1550567166000}}},{"range":{"uid":{"gte":first,"lte":last}}}]}},"size":10000})
