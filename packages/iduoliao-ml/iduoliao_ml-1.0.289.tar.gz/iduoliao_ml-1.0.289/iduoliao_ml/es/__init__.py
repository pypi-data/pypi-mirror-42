...
#dataEsclient = Elasticsearch(['10.168.0.119:9200', '10.168.0.121:9200', '10.168.0.127:9200'], http_auth=('huangzhen', 'df25j0934j4y09hjoijoigef'), timeout=60)
...
dataEsclient = Elasticsearch(['10.0.0.53:9200', '10.167.0.246:9200', '10.168.0.143:9200'], http_auth=('huangzhen', 'df25j0934j4y09hjoijoigef'), timeout=120)
