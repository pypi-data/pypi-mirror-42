...
import os
XBOS_SERVICES_UTILS3_CONFIG_PATH = os.environ["XBOS_SERVICES_UTILS3_CONFIG_PATH"]
...
def get_zones(bldg):
    ...
    path = XBOS_SERVICES_UTILS3_CONFIG_PATH + "/all_zones.yml"
...
def get_buildings():
    ...
    path = XBOS_SERVICES_UTILS3_CONFIG_PATH + "/all_buildings.yml"
    with open(path, "r") as f:
        data = yaml.load(f)
    return data
