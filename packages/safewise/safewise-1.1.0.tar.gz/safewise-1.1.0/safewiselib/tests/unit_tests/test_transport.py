...
from safewiselib.transport.bridge import BridgeTransport
...
def test_import_all_transports():
    from safewiselib.transport.bridge import BridgeTransport
    from safewiselib.transport.hid import HidTransport
    from safewiselib.transport.webusb import WebUsbTransport
    from safewiselib.transport.udp import UdpTransport
...
def test_transport_dependencies():
    import safewiselib.transport.hid as hid_transport
