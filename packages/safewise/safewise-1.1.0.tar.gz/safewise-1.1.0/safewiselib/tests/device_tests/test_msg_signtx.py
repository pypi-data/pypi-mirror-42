...
from safewiselib import btc, messages as proto
from safewiselib.tools import H_, CallException, btc_hash, parse_path
...
def check_sign_tx(
    ...
    for i, inp in enumerate(inputs):
        ...
        if unknown_path and SafeWISE_VERSION != 1:
...
class TestMsgSigntx(SafeWISETest):
    ...
    def test_two_two(self):
        ...
        # The transaction was produced before SafeWISE implemented BIP-66, so the signature
