...
from tornado.auth import AuthError, OAuth2Mixin, OAuthMixin, OpenIdMixin, TwitterMixin
from tornado.auth import _non_deprecated_return_future, _auth_return_future
...
class SnowlandMixin(OAuth2Mixin):
    ...
    _OAUTH_SETTINGS_KEY = 'snowland_oauth'
