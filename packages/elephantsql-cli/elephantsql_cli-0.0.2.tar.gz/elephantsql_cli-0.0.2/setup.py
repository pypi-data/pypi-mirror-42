...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'elephantsql_cli' / "version.py")
)
...
setup(
    name='elephantsql_cli',
    description="CLI implementation of the ElephantSQL API",
    ...
    entry_points="""
    [console_scripts]
    elephant=elephantsql_cli.cli:cli
    """,
    ...
    url='https://github.com/flyudvik/elephantsql_cli',
    download_url=(
        f'https://github.com/flyudvik/'
        f'elephantsql_cli/archive/{version}.tar.gz'
    ),
    keywords=[
