...
def send_exchange_mail(recipients, subject, message=None, html_message=None,
                       sender=None, reply_to=None, cc=None, bcc=None, attachments=None,
                       username="", password="", host="", smtp_addr="",
                       fullname=None, autodiscover=False, use_ssl=True, service_endpoint=None,
    ...
    sender = Mailbox(email_address=sender)
...
def send_exchange_template_mail(recipients, template, context, language="en",
                                sender=None, reply_to=None, cc=None, bcc=None, attachments=None,
                                username="", password="", host="", smtp_addr="",
                                fullname=None, autodiscover=False, use_ssl=True, service_endpoint=None,
                                access_type=DELEGATE, auth_type=None, version=None
    ...
    return send_exchange_mail(
        recipients=recipients, subject=subject, message=None, html_message=html_message,
        sender=sender, reply_to=reply_to, cc=cc, bcc=bcc, attachments=attachments,
        username=username, password=password, host=host, smtp_addr=smtp_addr,
        fullname=fullname, autodiscover=autodiscover, use_ssl=use_ssl, service_endpoint=service_endpoint,
        access_type=access_type, auth_type=auth_type, version=version
    )
