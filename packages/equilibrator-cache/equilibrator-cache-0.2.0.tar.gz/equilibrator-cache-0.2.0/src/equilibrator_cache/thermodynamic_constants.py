...
@ureg.check(None, "[concentration]", "[temperature]", None, None, None)
def legendre_transform(
    ...
    :param num_protons:
    :param charge:
    :param p_mg: the -log10([Mg2+])
    :param num_magnesiums: number of magnesium ions associated to the species
