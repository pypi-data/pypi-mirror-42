...
class MlRepo(Repo):
    def __init__(self, config, repo_root, data_volume_config, read_only=False, require_path=True, **kwargs):
        ...
        super(MlRepo, self).__init__(repo_root, require_path=require_path)
    ...
    def create_object_store(self):
        ...
        elif self.data_volume_config.object_store_type in ['null', 'linked']:
