...
from pyforms_lite.controls import ControlText, ControlFile, ControlDir
...
class MeleeUploader(BaseWidget):
    def __init__(self):
        ...
        # Match Values
        self._file = ControlFile("File")
        self._dir = ControlDir("Directory")
        ...
        # Main Menu Layout
        self.mainmenu = [
            {'Settings': [{'YouTube Log Out': self.__reset_cred_event}, {'Toggle SA Hook': self.__show_sa_form}, {'Toggle OBS Hook': self.__show_obs_form}, {'Toggle SC Hook': self.__show_sc_form}, {'Test it': self.__change_form}],
    ...
    def __change_form(self):
        self.formset = [{"-Match": ["_dir", (' ', "_mprefix", "_mtype", "_msuffix", ' '), (' ', "_p1sponsor", "_p1", ' '), (' ', "_p1char", ' '), (' ', "_p2sponsor", "_p2", ' '), (' ', "_p2char", ' ')],
                         "-Status-": ["_output", "=", "_qview"],
                         "Event-": ["_privacy", "_titleformat", ("_ename", "_ename_min"), "_pID", "_bracket", "_tags", "_description"]},
                        (' ', '_button', ' ')]
