...
class Simulation:
	...
	def train(self, max_steps=100_000, instances=1, visualize=False, plot=None, max_subprocesses=0):
		...
		if max_subprocesses == 0:
			...
			self._sp_train(max_steps, instances, visualize, plot, max_subprocesses)
		elif max_subprocesses > 0:
	...
	def _sp_train(self, max_steps, instances, visualize, plot, max_subprocesses):
