...
class ElasticSearchPipeline(object):
    ...
    crawler = None
    items_buffer = []
    bulk_insert_errors_key = 'custom/es_pipeline/insert_errors'
    bulk_insert_count_key = 'custom/es_pipeline/insert_count'
...
class JurisprudenciaOABPipeline(object):
    ...
    es = None
    items_buffer = []
    bulk_insert_errors_key = 'custom/oab_pipeline/insert_errors'
    bulk_insert_count_key = 'custom/oab_pipeline/insert_count'
