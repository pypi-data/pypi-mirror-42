...
def main():
    ...
    # FIXME: legacy environment variables needed for lhcb-proxy-init to work
    #        (used in LHCbGrid.xenv so they can be removed once we switch to
    #        "DiracOS")
    control.set('LCG_releases_base', join(mysiteroot, 'lcg', 'releases'))
