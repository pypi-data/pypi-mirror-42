...
class FitOutput:
    ...
    def __init__(self, automl_settings: AutoMLBaseSettings, pipeline: AutoMLPipeline) -> None:
        ...
        """
        self._settings = automl_settings    # type: AutoMLBaseSettings
        self._errors = {}                   # type: Dict[str, Dict[str, Union[BaseException, str]]]
        self._pipeline = pipeline           # type: AutoMLPipeline
    ...
    def get_sanitized_output_dict(self) -> Dict[str, str]:
        ...
        output.pop('run_template')
        output.pop('run_preprocessor')
        output.pop('run_algorithm')
        return output
