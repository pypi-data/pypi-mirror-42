...
class RollingWindowFeaturizer(AbstractTimeSeriesTransformer):
    ...
    def __init__(self, window_size, transform_dict, window_opts=None,
                 transform_opts=None, max_horizon=1,
                 origin_time_colname=constants.TimeSeriesInternal.ORIGIN_TIME_COLNAME_DEFAULT,
                 dropna=False,
                 logger=None,
                 **kwargs):
        """
