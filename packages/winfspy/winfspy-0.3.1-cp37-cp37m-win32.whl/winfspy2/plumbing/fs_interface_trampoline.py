...
def _file_system_interface_factory(enable_set_delete=False):
    ...
    try:
        ...
        if enable_set_delete:
            # `SetDelete` takes precedence on `CanDelete`
...
file_system_interface = _file_system_interface_factory()
