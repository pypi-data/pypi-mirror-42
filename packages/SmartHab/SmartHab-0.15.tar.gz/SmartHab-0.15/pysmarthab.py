...
class _Network:
    ...
    def __init__(self, base_url, security=_Security()):
        self.state = State()
    ...
    def send_request(self, endpoint, params=None, key=None, verb='GET'):
        ...
        res = requests.request(verb,
                               ...
                               params=all_params, headers={'Accept': 'application/json'}, timeout=10)
...
class SmartHab:
    ...
    def __init__(self, base_url=DEFAULT_BASE_API_URL, state=None, network=None):
        ...
        if self._network is None:
            self._network = _Network(base_url)
    ...
    def get_device_list(self):
        ...
        res = self._send_request(Endpoint.GET_OBJECTS)
    ...
    def _send_request(self, endpoint, params=None, key=None, verb='GET'):
        try:
...
class Device(abc.ABC):
    ...
    def update(self):
        ...
        res = self._client._network.send_request(Endpoint.GET_OBJECT_STATE,
    ...
    def state(self, state):
        ...
        r_state = self._client._network.send_request(Endpoint.SET_OBJECT_STATE,
                                                     params, verb='POST')
