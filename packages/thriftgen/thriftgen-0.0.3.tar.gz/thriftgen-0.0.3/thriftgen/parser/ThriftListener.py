...
class ThriftListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ThriftParser#comment_multiline.
    def enterComment_multiline(self, ctx:ThriftParser.Comment_multilineContext):
        pass

    # Exit a parse tree produced by ThriftParser#comment_multiline.
    def exitComment_multiline(self, ctx:ThriftParser.Comment_multilineContext):
        pass


    # Enter a parse tree produced by ThriftParser#comment_singleline.
    def enterComment_singleline(self, ctx:ThriftParser.Comment_singlelineContext):
        pass

    # Exit a parse tree produced by ThriftParser#comment_singleline.
    def exitComment_singleline(self, ctx:ThriftParser.Comment_singlelineContext):
        pass
