...
int _cffi_f_zmq_curve_public(char * x0, char * x1)
{
...
int _cffi_const_PYZMQ_DRAFT_API(long long *out_value)
{
  *out_value = (long long)(PYZMQ_DRAFT_API);
  return (PYZMQ_DRAFT_API) <= 0;
}
...
int _cffi_const_ZMQ_BLOCKY(long long *out_value)
{
  *out_value = (long long)(ZMQ_BLOCKY);
  return (ZMQ_BLOCKY) <= 0;
}

int _cffi_const_ZMQ_CLIENT(long long *out_value)
{
  *out_value = (long long)(ZMQ_CLIENT);
  return (ZMQ_CLIENT) <= 0;
}
...
int _cffi_const_ZMQ_CONNECT_TIMEOUT(long long *out_value)
{
  *out_value = (long long)(ZMQ_CONNECT_TIMEOUT);
  return (ZMQ_CONNECT_TIMEOUT) <= 0;
}
...
int _cffi_const_ZMQ_DGRAM(long long *out_value)
{
  *out_value = (long long)(ZMQ_DGRAM);
  return (ZMQ_DGRAM) <= 0;
}

int _cffi_const_ZMQ_DISH(long long *out_value)
{
  *out_value = (long long)(ZMQ_DISH);
  return (ZMQ_DISH) <= 0;
}
...
int _cffi_const_ZMQ_GATHER(long long *out_value)
{
  *out_value = (long long)(ZMQ_GATHER);
  return (ZMQ_GATHER) <= 0;
}
...
int _cffi_const_ZMQ_HEARTBEAT_IVL(long long *out_value)
{
  *out_value = (long long)(ZMQ_HEARTBEAT_IVL);
  return (ZMQ_HEARTBEAT_IVL) <= 0;
}

int _cffi_const_ZMQ_HEARTBEAT_TIMEOUT(long long *out_value)
{
  *out_value = (long long)(ZMQ_HEARTBEAT_TIMEOUT);
  return (ZMQ_HEARTBEAT_TIMEOUT) <= 0;
}

int _cffi_const_ZMQ_HEARTBEAT_TTL(long long *out_value)
{
  *out_value = (long long)(ZMQ_HEARTBEAT_TTL);
  return (ZMQ_HEARTBEAT_TTL) <= 0;
}
...
int _cffi_const_ZMQ_INVERT_MATCHING(long long *out_value)
{
  *out_value = (long long)(ZMQ_INVERT_MATCHING);
  return (ZMQ_INVERT_MATCHING) <= 0;
}
...
int _cffi_const_ZMQ_MULTICAST_MAXTPDU(long long *out_value)
{
  *out_value = (long long)(ZMQ_MULTICAST_MAXTPDU);
  return (ZMQ_MULTICAST_MAXTPDU) <= 0;
}
...
int _cffi_const_ZMQ_POLLPRI(long long *out_value)
{
  *out_value = (long long)(ZMQ_POLLPRI);
  return (ZMQ_POLLPRI) <= 0;
}
...
int _cffi_const_ZMQ_RADIO(long long *out_value)
{
  *out_value = (long long)(ZMQ_RADIO);
  return (ZMQ_RADIO) <= 0;
}
...
int _cffi_const_ZMQ_SCATTER(long long *out_value)
{
  *out_value = (long long)(ZMQ_SCATTER);
  return (ZMQ_SCATTER) <= 0;
}

int _cffi_const_ZMQ_SERVER(long long *out_value)
{
  *out_value = (long long)(ZMQ_SERVER);
  return (ZMQ_SERVER) <= 0;
}
...
int _cffi_const_ZMQ_STREAM_NOTIFY(long long *out_value)
{
  *out_value = (long long)(ZMQ_STREAM_NOTIFY);
  return (ZMQ_STREAM_NOTIFY) <= 0;
}
...
int _cffi_const_ZMQ_TCP_MAXRT(long long *out_value)
{
  *out_value = (long long)(ZMQ_TCP_MAXRT);
  return (ZMQ_TCP_MAXRT) <= 0;
}
...
int _cffi_const_ZMQ_THREAD_SAFE(long long *out_value)
{
  *out_value = (long long)(ZMQ_THREAD_SAFE);
  return (ZMQ_THREAD_SAFE) <= 0;
}
...
int _cffi_const_ZMQ_USE_FD(long long *out_value)
{
  *out_value = (long long)(ZMQ_USE_FD);
  return (ZMQ_USE_FD) <= 0;
}
...
int _cffi_const_ZMQ_VMCI_BUFFER_MAX_SIZE(long long *out_value)
{
  *out_value = (long long)(ZMQ_VMCI_BUFFER_MAX_SIZE);
  return (ZMQ_VMCI_BUFFER_MAX_SIZE) <= 0;
}

int _cffi_const_ZMQ_VMCI_BUFFER_MIN_SIZE(long long *out_value)
{
  *out_value = (long long)(ZMQ_VMCI_BUFFER_MIN_SIZE);
  return (ZMQ_VMCI_BUFFER_MIN_SIZE) <= 0;
}

int _cffi_const_ZMQ_VMCI_BUFFER_SIZE(long long *out_value)
{
  *out_value = (long long)(ZMQ_VMCI_BUFFER_SIZE);
  return (ZMQ_VMCI_BUFFER_SIZE) <= 0;
}

int _cffi_const_ZMQ_VMCI_CONNECT_TIMEOUT(long long *out_value)
{
  *out_value = (long long)(ZMQ_VMCI_CONNECT_TIMEOUT);
  return (ZMQ_VMCI_CONNECT_TIMEOUT) <= 0;
}
...
int _cffi_const_ZMQ_XPUB_MANUAL(long long *out_value)
{
  *out_value = (long long)(ZMQ_XPUB_MANUAL);
  return (ZMQ_XPUB_MANUAL) <= 0;
}
...
int _cffi_const_ZMQ_XPUB_VERBOSER(long long *out_value)
{
  *out_value = (long long)(ZMQ_XPUB_VERBOSER);
  return (ZMQ_XPUB_VERBOSER) <= 0;
}

int _cffi_const_ZMQ_XPUB_WELCOME_MSG(long long *out_value)
{
  *out_value = (long long)(ZMQ_XPUB_WELCOME_MSG);
  return (ZMQ_XPUB_WELCOME_MSG) <= 0;
}
