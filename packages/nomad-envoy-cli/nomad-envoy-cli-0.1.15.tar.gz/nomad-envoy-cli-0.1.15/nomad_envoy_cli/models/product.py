...
class Product(object):
    ...
    def __init__(self, product_id=None, name=None, skus=None, currency='RMB', mass_unit='Kilogram', time_unit='days', barcode=None, description=None, price=None, net_weight=None, gross_weight=None, images=None, is_onsale=None, status=None, category=None, vendor=None, country=None, shelf_life=None):  # noqa: E501
    ...
    def vendor(self):
        ...
        The name of the product's vendor  # noqa: E501
