...
class SSHConnectionPool(pi._requires.urllib3.connectionpool.HTTPConnectionPool):
    scheme = 'ssh'
...
class SSHAdapter(pi._requires.requests.adapters.HTTPAdapter):

    __attrs__ = pi._requires.requests.adapters.HTTPAdapter.__attrs__ + [
    ...
    def __init__(self, base_url, timeout=60,
        ...
        parsed = pi._requires.six.moves.urllib_parse.urlparse(base_url)
