...
class AuthConfig(dict):
    ...
    def resolve_authconfig(self, registry=None):
        ...
        for key, conf in pi._requires.six.iteritems(self.auths):
    ...
    def _resolve_authconfig_credstore(self, registry, credstore_name):
        ...
        try:
            ...
            return res
        except pi._requires.dockerpycreds.CredentialsNotFound:
            log.debug('No entry found')
            return None
    ...
    def _get_store_instance(self, name):
        if name not in self._stores:
            self._stores[name] = pi._requires.dockerpycreds.Store(
