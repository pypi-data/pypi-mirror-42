...
def fontcell(path_to_config):
    ...
    if parallelization:
        ...
        doc.save_csv(ontology1, proyect_path + os.sep + 'files' + os.sep + 'onto1_for_parallel.csv')
        doc.save_csv(ontology2, proyect_path + os.sep + 'files' + os.sep + 'onto2_for_parallel.csv')
        ...
        doc.save_txt(list_of_variables_str, proyect_path + os.sep + 'files' + os.sep + 'parallelization_config.txt')
