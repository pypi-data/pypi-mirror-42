...
class Transaction(object):
    ...
    attribute_map = {
        ...
        'raw_descrtiption': 'raw_descrtiption',
        'amount': 'amount',
        'date': 'date',
    ...
    def __init__(self, id=None, description=None, raw_descrtiption=None, amount=None, date=None, updated_at=None, is_deleted=None, category=None, account=None):  # noqa: E501
        """Transaction - a model defined in OpenAPI"""  # noqa: E501

        self._id = None
        self._description = None
        self._raw_descrtiption = None
        self._amount = None
        self._date = None
        ...
        if raw_descrtiption is not None:
            self.raw_descrtiption = raw_descrtiption
    ...
    @property
    def raw_descrtiption(self):
        """Gets the raw_descrtiption of this Transaction.  # noqa: E501


        :return: The raw_descrtiption of this Transaction.  # noqa: E501
        :rtype: str
        """
        return self._raw_descrtiption

    @raw_descrtiption.setter
    def raw_descrtiption(self, raw_descrtiption):
        """Sets the raw_descrtiption of this Transaction.


        :param raw_descrtiption: The raw_descrtiption of this Transaction.  # noqa: E501
        :type: str
        """

        self._raw_descrtiption = raw_descrtiption
