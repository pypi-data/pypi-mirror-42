    ...
    def complete_setup(cls, item_cls):
        ...
        for key, other_model_cls, relation_type, reverse_key in \
            ...
            if key in item_cls.norewrite_fields:
                raise NotRewritableExceptionsAreNotYetSupported(
                    'Not rewritable relations are not yet supported')
        ...
        # norewrite_fields (already valid field names, but field from relations
        # not allowed)