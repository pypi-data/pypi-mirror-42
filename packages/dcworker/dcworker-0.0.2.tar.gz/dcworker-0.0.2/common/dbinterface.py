...
SELECT workder_uuid, passcode, workdir, logdir, port, gpu_uuid FROM {};
""".format(WORKER_REGISTRATION_TABLE_NAME)
...
SELECT dataset_name, dataset_url, local_path, dataset_persist, dataset_ready, refcount
FROM {};
""".format(DATASET_TABLE_NAME)
...
INSERT INTO {}(dataset_name, dataset_url, local_path, dataset_persist, dataset_ready, refcount)
VALUES(%s, %s, %s, %s, %s, %s);
""".format(DATASET_TABLE_NAME)
