...
def resnet34kvasirpytorchload():
    ...
    if not os.path.exists(pathModel + os.sep + 'ResNet34Kvasir.py'):
        ...
        wget.download(
            'https://unirioja-my.sharepoint.com/:u:/g/personal/adines_unirioja_es/Edg-3LK7P5RBggEfkOU86fIByryGl3tmsvqhuBoGsXZ91A?download=1',
            out=pathModel + os.sep + 'ResNet34Kvasir.py')
    if not os.path.exists(pathWeights + os.sep + 'ResNet34Kvasir.pth'):
        ...
        wget.download(
            ...
            out=pathWeights + os.sep + 'ResNet34Kvasir.pth')
...
def commonPostProcess(result):
    ...
    if not os.path.exists(path + os.sep + 'synset_words.txt'):
        ...
        wget.download(
            ...
            out=path + os.sep + 'synset_words.txt')
