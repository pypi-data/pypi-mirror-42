    ...
    for m in mtypes:
        ...
        while flag:
            ...
            if hierarchi is True:
                ...
                layer_genome.to_csv(layer_directory+"/Samples_of_Layer_"+str(H_iteration)+".text", sep = "\t")
                similarity_dataframe.to_csv(layer_directory+"/Samples_Similarity_of_Layer_"+str(H_iteration)+".text", sep = "\t")
                del layer_genome
