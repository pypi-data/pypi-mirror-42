...
{'': ['*'],
 'pyxbos': ['drivers/dark_sky/api',
            'drivers/dark_sky/api',
            'drivers/dark_sky/api',
            'drivers/dark_sky/config.yaml',
            'drivers/dark_sky/config.yaml',
            'drivers/dark_sky/config.yaml',
            'drivers/dark_sky/dark_sky.py',
            'drivers/dark_sky/dark_sky.py',
            'drivers/dark_sky/dark_sky.py',
            'drivers/hue/hue.py',
            'drivers/hue/hue.py',
            'drivers/hue/requirements.txt',
            'drivers/hue/requirements.txt',
            'drivers/system_monitor/requirements.txt',
            'drivers/system_monitor/requirements.txt',
            'drivers/system_monitor/systemmonitor.py',
            'drivers/system_monitor/systemmonitor.py',
            'wave/*',
            'wavemq/*']}
