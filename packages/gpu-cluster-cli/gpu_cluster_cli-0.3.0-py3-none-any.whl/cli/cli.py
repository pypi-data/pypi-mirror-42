...
def check_level(session):
    ...
    userlevel = response_parser(res)['usertype']
        ...
        if parsed_info is not None:
            ...
            while True:
                target_userlevel = input(
                    'Input new user level for [{}] (superuser, normal): '.format(target_username))

                if target_userlevel in ["superuser", "normal"]:
                    break
                else:
            ...
            change_res = sess.post(
                ...
                data={'usertype': target_userlevel})
