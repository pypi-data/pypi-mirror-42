...
class ModelProperty(object):
    ...
    def __init__(self, format=None, position=None, description=None, vendor_extensions=None, title=None, xml=None, example=None, read_only=False, type=None):  # noqa: E501
