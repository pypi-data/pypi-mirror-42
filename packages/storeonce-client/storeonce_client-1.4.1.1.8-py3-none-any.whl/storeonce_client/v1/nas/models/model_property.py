...
class ModelProperty(object):
    ...
    def __init__(self, read_only=False, example=None, xml=None, format=None, position=None, description=None, title=None, vendor_extensions=None, type=None):  # noqa: E501
