...
class ModelProperty(object):
    ...
    def __init__(self, xml=None, example=None, read_only=False, position=None, format=None, description=None, title=None, vendor_extensions=None, type=None):  # noqa: E501
