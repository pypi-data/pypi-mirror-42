...
class ModelProperty(object):
    ...
    def __init__(self, position=None, format=None, description=None, title=None, vendor_extensions=None, xml=None, example=None, read_only=False, type=None):  # noqa: E501
