...
class ModelProperty(object):
    ...
    def __init__(self, format=None, position=None, description=None, title=None, vendor_extensions=None, example=None, read_only=False, xml=None, type=None):  # noqa: E501
