...
class ModelProperty(object):
    ...
    def __init__(self, vendor_extensions=None, xml=None, example=None, read_only=False, position=None, format=None, description=None, title=None, type=None):  # noqa: E501
