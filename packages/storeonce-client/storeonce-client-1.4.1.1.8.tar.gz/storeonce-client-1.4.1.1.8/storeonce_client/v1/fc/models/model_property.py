...
class ModelProperty(object):
    ...
    def __init__(self, xml=None, example=None, read_only=False, format=None, position=None, description=None, title=None, vendor_extensions=None, type=None):  # noqa: E501
