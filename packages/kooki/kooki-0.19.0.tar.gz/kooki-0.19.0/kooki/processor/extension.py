...
from .renderer import render, KookiRenderer
...
class Caller():
    ...
    def deprecation_message(self, message):
        pretty_output.warning(textwrap.dedent('''\
            Warning: {}
            {}
    ...
    def find_deprecated(self, file_path):
        self.deprecation_message(''''find' alone is deprecated, use 'kooki.find' instead.''')
    ...
    def ext_deprecated(self, path, *args, **kwargs):
        self.deprecation_message(''''ext' alone is deprecated, use 'kooki.ext' instead''')
    ...
    def load_deprecated(self, content, template_extension):
        self.deprecation_message(''''load' alone is deprecated, use 'kooki.load' instead''')
    ...
    def get_deprecated(self, key, default=''):
        self.deprecation_message(''''get' alone is deprecated, use 'kooki.get' instead''')
