...
class KookiRenderer(Renderer):
    ...
    def header(self, text, level, raw):
        ...
        if raw in KookiRenderer.toc_history:
            ...
            return self.extensions.__header__(renderer=KookiRenderer.data, text=text, level=level, raw=raw, uid=uid)
    ...
    def image(self, src, title, alt_text):
        ...
        return self.extensions.__image__(renderer=KookiRenderer.data, src=src, notitle=notitle, title=title, alt_text=alt_text)
