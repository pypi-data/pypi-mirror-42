...
class WAS (wsgiappservice.WAS):
    ...
    def Futures (self, reqs, __do_not_use_this_keyword__ = None, **args):
        return futures.Futures (self._clone (True), reqs, **(__do_not_use_this_keyword__ or args))
    futures = Futures
    
# Patch skitai was and response classes ----------------------------------
from skitai.http_request import http_request
from skitai.handlers.http2.request import request as http2_request
from .response import http_response, http2_response 

skitai.set_was_class (WAS)
http_request.response_class = http_response
