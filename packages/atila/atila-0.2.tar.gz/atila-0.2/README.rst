...
*Atila* is WSGI container integrated with Skitai App Engine for backend services.
...
Skitai is the most efficinet with single threading with multi workers.

With single thread it is the problem usign getwait or getswait It is almost works as IO blocking situation.

was.futures returns Futures instance for delaying response until every awaitable jobs are finushed. 
