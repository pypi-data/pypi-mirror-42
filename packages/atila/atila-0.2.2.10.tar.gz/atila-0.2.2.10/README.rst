...
*Atila* is simple and minimal WSGI framework integrated with `Skitai App Engine`_ for backend services.
...
also WS_SIMPLE_NT, WS_THREADSAFE_NT and WS_GROUPCHAT_NT works out of threading pool. It means websocket response has IO blocking operation, entire Skitai event loop will be blocked. 
