...
from . import extractTranslations
    ...
    try:
        for e in sys.argv[1:]:
            ...
            if e == "generateexcel" or e == "toexcel":
                ...
                quit()
            elif e == 'extracttranslations' or e == "extract":
                extractTranslations.Extract(*processArgs.processExtractTranslationsArgs(sys.argv[2:]))
                quit()
    except TypeError:
        quit()
