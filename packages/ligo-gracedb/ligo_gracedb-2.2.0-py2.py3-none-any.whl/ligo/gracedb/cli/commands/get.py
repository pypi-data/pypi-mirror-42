...
class GetCommand(RegisteredCommandBase):
    ...
    description = textwrap.dedent("""\
        ...
        EMObservation, VOEvent, signoff, event, or superevent
    """)
...
class GetEmobservationCommand(GetChildBase):
    name = "emobservation"
    description = textwrap.dedent("""\
        Retrieve information about a single EMObservation attached to an
        event or superevent
    """)
    ...
    def add_custom_arguments(self, parser):
        parser.add_argument("N", type=int,
            help="Index number of the EMObservation")
        return parser
...
class GetLogCommand(GetChildBase):
    name = "log"
    description = "Retrieve a log entry"
    parent_parsers = (object_id_parser,)
...
class GetVoeventCommand(GetChildBase):
    name = "voevent"
    description = "Retrieve a VOEvent attached to an event or superevent"
    parent_parsers = (object_id_parser,)
