...
tag_parser.add_argument("-t", "--tag-name", dest="tag_name",
    help="Tag name or comma-separated list of tag names", default=None)
tag_parser.add_argument("-d", "--tag-display-name", dest="tag_display_name",
    type=str, default=None, help=("Tag display name or comma-separated list "
    "of tag display names (ignored for existing tags)"))

# Label parser
label_parser = argparse.ArgumentParser(add_help=False)
label_parser.add_argument("-l", "--labels", dest="labels", type=str,
    default=None, help="Label name or comma-separated list of label names")
