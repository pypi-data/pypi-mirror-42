...
class BTDiscountInfo(object):
    ...
    def __init__(self, created_by=None, owner_id=None, created_at=None, plan_id=None, percent_off=None, amount_off=None, coupon_type=None, coupon_valid_months=None, expires_at=None, used_at=None, trial_end_date=None, account_balance=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
