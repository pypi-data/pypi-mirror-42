...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, is_read_only=None, can_delete=None, parent=None, type=None, description=None, microversion=None, created_at=None, thumbnail=None, parents=None, document_id=None, modified_at=None, last_modifier=None, creator=None, override_date=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
