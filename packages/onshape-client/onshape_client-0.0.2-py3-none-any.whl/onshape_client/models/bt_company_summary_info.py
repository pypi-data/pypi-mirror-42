...
class BTCompanySummaryInfo(object):
    ...
    def __init__(self, state=None, type=None, description=None, admin=None, owner_id=None, domain_prefix=None, image=None, no_public_documents=None, enterprise_base_url=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
