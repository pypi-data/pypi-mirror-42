...
class BTWorkflowSnapshotInfo(object):
    ...
    def __init__(self, actions=None, state=None, is_setup=None, approver_ids=None, notifier_ids=None, rejected_by=None, is_frozen=None, approved_by=None, is_discarded=None, metadata_state=None):  # noqa: E501
