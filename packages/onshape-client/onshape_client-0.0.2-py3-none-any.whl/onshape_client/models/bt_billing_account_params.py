...
class BTBillingAccountParams(object):
    ...
    def __init__(self, address=None, force_create=None, password=None, user_id=None, plan_id=None, company_id=None, seats=None, domain_prefix=None, token=None, payment_type=None, trial_period_days=None, company_plan=None, promonthly_enabled=None, company_name=None, reseller_name=None):  # noqa: E501
