...
class BTElementParams(object):
    ...
    def __init__(self, location=None, source_document_id=None, source_workspace_id=None, notify_user=None, media_type=None, create_drawing_if_possible=None, format=None, document_id=None, filename=None, workspace_id=None, element_id=None, translate_stored_file=None, is_initial_upload=None, foreign_id=None, upload_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, unit=None, project_id=None, parent_id=None, original_foreign_id=None, update_existing_import_features=None, blob_microversion_id=None, blob_element_id=None, specify_units=None):  # noqa: E501
