...
class BTWorkflowActionInfo(object):
    ...
    def __init__(self, tooltip=None, allow_if_no_approvers=None, allow_if_approvers=None, always_allow=None, is_approver_action=None, action=None, label=None, required_properties=None, ui_hint=None, is_admin_override=None):  # noqa: E501
