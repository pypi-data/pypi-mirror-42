...
class BTBillingPlanParams(object):
    ...
    def __init__(self, name=None, description=None, group=None, plan_id=None, client_id=None, application_id=None, interval=None, plan_type=None, trial_period_days=None, consumable_quantity=None, amount_cents=None, hidden=None):  # noqa: E501
