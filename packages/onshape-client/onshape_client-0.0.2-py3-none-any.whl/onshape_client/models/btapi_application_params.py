...
class BTAPIApplicationParams(object):
    ...
    def __init__(self, hidden_from_plus_menu_=None, name=None, state=None, description=None, internal_grant_on_demand=None, client_id=None, developer_id=None, redirect_ur_ls=None, ui_spec=None, supports_merge=None, admin_team_id=None, hidden_from_plus_menu=None, store_entry_is_public=None, developer_email=None, primary_format=None, scope_names=None, base_href=None, supports_collaboration=None):  # noqa: E501
