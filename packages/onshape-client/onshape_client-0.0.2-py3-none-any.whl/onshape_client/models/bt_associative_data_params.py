...
class BTAssociativeDataParams(object):
    ...
    def __init__(self, type=None, data=None, id_tag=None, configuration=None, microversion_id=None, version_id=None, document_id=None, document_microversion=None, associative_data_id=None, operation=None, view_id=None, occurrence_id=None, is_hidden_base_view=None, workspace_id=None, element_id=None):  # noqa: E501
