...
class JsonNode(object):
    ...
    def __init__(self, array=None, null=None, value_node=None, float=None, object=None, container_node=None, missing_node=None, pojo=None, number=None, integral_number=None, floating_point_number=None, short=None, int=None, long=None, double=None, big_decimal=None, big_integer=None, boolean=None, binary=None, node_type=None, textual=None):  # noqa: E501
