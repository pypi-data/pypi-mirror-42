...
class BTDocumentElementInfo(object):
    ...
    def __init__(self, name=None, id=None, type=None, microversion_id=None, thumbnail_info=None, element_type=None, data_type=None, thumbnails=None, filename=None, foreign_data_id=None, length_units=None, angle_units=None, mass_units=None):  # noqa: E501
