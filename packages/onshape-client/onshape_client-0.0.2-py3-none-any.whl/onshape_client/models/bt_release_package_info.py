...
class BTReleasePackageInfo(object):
    ...
    def __init__(self, detailed=None, column_names=None, comments=None, items=None, package_thumbnail=None, is_setup=None, workspace_id=None, is_frozen=None, revision_rule_id=None, linked_version_ids=None, version_id=None, is_discarded=None, properties=None, name_as_property=None, description_as_property=None, description=None, is_obsoletion=None, company_id=None, workflow=None, document_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
