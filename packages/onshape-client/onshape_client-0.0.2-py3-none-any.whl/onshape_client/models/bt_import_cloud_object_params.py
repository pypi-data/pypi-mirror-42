...
class BTImportCloudObjectParams(object):
    ...
    def __init__(self, name=None, public=None, mime_type=None, notify_user=None, url=None, owner_type=None, cloud_storage_provider=None, cloud_object_id=None, size_bytes=None, access_token=None, owner_id=None, cloud_storage_account_id=None, foreign_id=None, upload_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, unit=None, project_id=None, parent_id=None, original_foreign_id=None, update_existing_import_features=None, blob_microversion_id=None, blob_element_id=None, specify_units=None):  # noqa: E501
