...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, options=None, data=None, user_id=None, company_id=None, client_id=None, url=None, events=None, filter=None, version_id=None, document_id=None, project_id=None, folder_id=None, workspace_id=None, element_id=None, part_id=None):  # noqa: E501
