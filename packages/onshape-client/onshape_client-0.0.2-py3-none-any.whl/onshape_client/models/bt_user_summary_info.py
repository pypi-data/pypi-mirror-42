...
class BTUserSummaryInfo(object):
    ...
    def __init__(self, email=None, source=None, first_name=None, last_name=None, is_guest=None, is_light=None, global_permissions=None, last_login_time=None, company=None, state=None, image=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
