...
class BTStandardContentHierarchyInfo(object):
    ...
    def __init__(self, type=None, existing_versions=None, category=None, standard=None, default_workspace=None, types=None, production_version_id=None, test_version_id=None, document_type=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
