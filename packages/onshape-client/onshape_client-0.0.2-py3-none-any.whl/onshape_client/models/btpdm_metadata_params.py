...
class BTPDMMetadataParams(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, title3=None, revision=None, title2=None, title1=None, vendor=None, configuration=None, element_id=None, part_number=None, project=None, part_id=None, product_line=None, custom_properties=None):  # noqa: E501
