...
class BTPurchaseParams(object):
    ...
    def __init__(self, email=None, password=None, user_id=None, plan_id=None, seats=None, domain_prefix=None, payment_type=None, trial_period_days=None, light_seats=None, allow_deprecated_plan=None, reseller_name=None):  # noqa: E501
