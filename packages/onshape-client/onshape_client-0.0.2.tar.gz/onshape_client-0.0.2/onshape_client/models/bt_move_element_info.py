...
class BTMoveElementInfo(object):
    ...
    def __init__(self, new_document_version_id=None, new_document_id=None, element_original_to_new_map=None, is_new_document=None, new_document_name=None, new_workspace_id=None, error_message=None):  # noqa: E501
