...
class BTBillingPlanSummaryInfo(object):
    ...
    def __init__(self, hidden=None, onshape_plan=None, description=None, application_id=None, interval=None, deprecated=None, plan_type=None, consumable_quantity=None, amount_cents=None, company_plan=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
