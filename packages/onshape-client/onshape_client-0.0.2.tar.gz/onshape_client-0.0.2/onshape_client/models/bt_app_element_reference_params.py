...
class BTAppElementReferenceParams(object):
    ...
    def __init__(self, update_sketch_info=None, revision=None, id_tag=None, transaction_id=None, parent_change_id=None, sketch_id=None, sketch_ids=None, return_error=None, part_number=None, is_sketch_only=None, target_document_id=None, target_element_id=None, target_version_id=None, pure_sketch=None, target_microversion_id=None, has_document_microversions=None, id_tag_microversion_id=None, track_new_versions=None, target_configuration=None):  # noqa: E501
