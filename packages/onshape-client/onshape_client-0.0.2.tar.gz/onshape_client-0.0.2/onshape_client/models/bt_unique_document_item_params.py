...
class BTUniqueDocumentItemParams(object):
    ...
    def __init__(self, revision=None, element_type=None, part_number=None, version_id=None, document_id=None, workspace_id=None, element_id=None, part_id=None, api_configuration=None):  # noqa: E501
