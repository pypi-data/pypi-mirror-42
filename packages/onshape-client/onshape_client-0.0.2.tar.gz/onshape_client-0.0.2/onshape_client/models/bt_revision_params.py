...
class BTRevisionParams(object):
    ...
    def __init__(self, revision=None, company_id=None, element_type=None, part_number=None, insertable_id=None, release_id=None, version_id=None, document_id=None, element_id=None):  # noqa: E501
