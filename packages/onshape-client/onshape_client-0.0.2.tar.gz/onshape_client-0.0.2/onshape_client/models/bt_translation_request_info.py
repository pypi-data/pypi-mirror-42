...
class BTTranslationRequestInfo(object):
    ...
    def __init__(self, request_element_id=None, request_state=None, result_external_data_ids=None, workspace_id=None, result_element_ids=None, result_document_id=None, failure_reason=None, document_id=None, version_id=None, result_workspace_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
