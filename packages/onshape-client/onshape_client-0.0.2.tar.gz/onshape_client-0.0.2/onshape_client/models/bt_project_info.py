...
class BTProjectInfo(object):
    ...
    def __init__(self, permission_scheme=None, trash=None, permission_set=None, role_map_entries=None, owner=None, description=None, created_by=None, modified_by=None, created_at=None, project_id=None, can_move=None, is_container=None, modified_at=None, is_enterprise_owned=None, tree_href=None, is_mutable=None, resource_type=None, has_pending_owner=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
