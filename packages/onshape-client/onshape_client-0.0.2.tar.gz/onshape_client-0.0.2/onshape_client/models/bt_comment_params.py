...
class BTCommentParams(object):
    ...
    def __init__(self, message=None, id=None, assignee=None, version_id=None, document_id=None, parent_id=None, view_data=None, workspace_id=None, element_id=None, element_query=None, element_feature=None, element_occurrence=None, assembly_feature=None):  # noqa: E501
