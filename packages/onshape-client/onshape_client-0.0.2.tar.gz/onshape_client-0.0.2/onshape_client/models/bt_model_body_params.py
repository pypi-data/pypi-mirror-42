...
class BTModelBodyParams(object):
    ...
    def __init__(self, configuration=None, element_microversion_id=None, document_id=None, workspace_id=None, element_id=None, part_query=None, part_id=None):  # noqa: E501
