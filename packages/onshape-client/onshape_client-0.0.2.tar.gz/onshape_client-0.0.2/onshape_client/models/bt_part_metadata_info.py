...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, name=None, id=None, state=None, href=None, description=None, title3=None, revision=None, title2=None, title1=None, vendor=None, thumbnail_configuration_id=None, microversion_id=None, thumbnail_info=None, material=None, configuration_id=None, part_number=None, element_id=None, part_query=None, project=None, custom_properties=None, part_id=None, product_line=None, unflattened_part_id=None, referencing_configured_part_node_ids=None, appearance=None, custom_property_definitions=None, body_type=None, is_mesh=None, is_flattened_body=None, is_hidden=None, ordinal=None, property_source_types=None):  # noqa: E501
