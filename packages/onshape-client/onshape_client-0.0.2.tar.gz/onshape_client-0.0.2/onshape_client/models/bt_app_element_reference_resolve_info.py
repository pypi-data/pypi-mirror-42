...
class BTAppElementReferenceResolveInfo(object):
    ...
    def __init__(self, target_element_microversion_id=None, resolved_element_microversion_id=None, revision=None, id_tag=None, sketch_ids=None, part_number=None, is_sketch_only=None, change_id=None, target_document_id=None, target_element_id=None, target_version_id=None, reference_id=None, target_document_microversion_id=None, is_configurable=None, resolved_document_microversion_id=None, id_tag_is_valid=None, is_flattened_part=None, track_new_versions=None, target_configuration=None, error_code=None, error_value=None, error_description=None):  # noqa: E501
