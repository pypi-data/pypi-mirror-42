...
class BTMoveElementParams(object):
    ...
    def __init__(self, name=None, need_new_version=None, is_copy=None, is_deep_copy=None, anchor_element_id=None, generate_unknown_messages=None, description=None, tags=None, import_data=None, target_workspace_id=None, element_original_to_new_map=None, is_new_document=None, source_document_id=None, source_workspace_id=None, owner_id=None, owner_type=None, parent_id=None, project_id=None, version_name=None, elements=None, is_public=None, target_document_id=None, is_group_anchor=None, owner_email=None):  # noqa: E501
