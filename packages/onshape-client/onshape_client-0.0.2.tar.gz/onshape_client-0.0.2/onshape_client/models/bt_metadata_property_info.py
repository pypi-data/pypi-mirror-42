...
class BTMetadataPropertyInfo(object):
    ...
    def __init__(self, name=None, default_value=None, initial_value=None, dirty=None, editable=None, property_id=None, required=None, schema_id=None, value_type=None, enum_values=None, validator=None, property_source=None, ui_hints=None):  # noqa: E501
