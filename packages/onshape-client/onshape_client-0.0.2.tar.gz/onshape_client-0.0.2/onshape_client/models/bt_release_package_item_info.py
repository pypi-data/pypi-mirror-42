...
class BTReleasePackageItemInfo(object):
    ...
    def __init__(self, properties=None, mime_type=None, workspace_id=None, company_id=None, configuration=None, diff_thumbnail_configuration_key=None, small_thumbnail_href=None, is_revision_managed=None, errors=None, is_included_editable=None, element_type=None, document_id=None, version_id=None, element_id=None, configuration_key=None, part_id=None, rpid=None, obsoletion_revision_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
