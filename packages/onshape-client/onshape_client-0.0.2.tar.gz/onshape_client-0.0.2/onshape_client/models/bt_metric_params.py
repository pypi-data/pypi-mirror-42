...
class BTMetricParams(object):
    ...
    def __init__(self, system_id=None, property_map=None, event_type=None, document_id=None, event_name=None, event_namespace=None, event_time=None, element_id=None):  # noqa: E501
