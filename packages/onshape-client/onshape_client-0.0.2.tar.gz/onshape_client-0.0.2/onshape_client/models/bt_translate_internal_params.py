...
class BTTranslateInternalParams(object):
    ...
    def __init__(self, model_scope=None, notify_user=None, store_in_document=None, connection_id=None, cloud_object_id=None, trigger_auto_download=None, part_ids=None, cloud_storage_account_id=None, format_name=None, version_string=None, source_name=None, destination_name=None, flatten=None, include_export_ids=None, text_as_geometry=None, show_overridden_dimensions=None, current_sheet_only=None, image_width=None, image_height=None, color_method=None, splines_as_polylines=None, selectable_pdf_text=None, grouping=None, import_in_background=None, foreign_id=None, upload_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, unit=None, project_id=None, parent_id=None, original_foreign_id=None, update_existing_import_features=None, blob_microversion_id=None, blob_element_id=None, specify_units=None):  # noqa: E501
