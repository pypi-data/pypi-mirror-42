...
class BTBoundingBoxParams(object):
    ...
    def __init__(self, sketch_id=None, include_hidden=None, element_microversion_id=None, document_id=None, workspace_id=None, element_id=None, part_query=None, part_id=None, include_wire_bodies=None, display_state_id=None):  # noqa: E501
