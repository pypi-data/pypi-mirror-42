...
class BTReleasePackageItem(object):
    ...
    def __init__(self, name=None, id=None, state=None, revision=None, mime_type=None, created_by=None, modified_by=None, microversion_id=None, workspace_id=None, created_at=None, company_id=None, configuration=None, revision_rule_id=None, is_included=None, remote_state=None, diff_thumbnail_configuration_key=None, small_thumbnail_href=None, initial_revision=None, is_revision_managed=None, errors=None, children=None, element_type=None, part_number=None, document_id=None, version_id=None, element_id=None, configuration_key=None, modified_at=None, part_id=None, rpid=None, obsoletion_revision_id=None):  # noqa: E501
