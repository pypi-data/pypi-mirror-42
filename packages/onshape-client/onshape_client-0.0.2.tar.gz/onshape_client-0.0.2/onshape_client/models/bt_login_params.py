...
class BTLoginParams(object):
    ...
    def __init__(self, email=None, password=None, device_id=None, random_token=None, totp=None, enable_totp=None, remember_totp=None, web_client_capabilities=None, renderer_performance_measurement=None):  # noqa: E501
