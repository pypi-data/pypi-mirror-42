...
class BTShareParams(object):
    ...
    def __init__(self, message=None, entries=None, permission=None, encoded_configuration=None, update=None, document_id=None, folder_id=None, permission_set=None, workspace_id=None, element_id=None):  # noqa: E501
