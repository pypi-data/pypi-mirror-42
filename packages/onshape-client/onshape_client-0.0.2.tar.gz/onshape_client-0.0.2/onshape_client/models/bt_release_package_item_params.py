...
class BTReleasePackageItemParams(object):
    ...
    def __init__(self, properties=None, id=None, configuration=None, is_included=None, href=None, part_number=None, version_id=None, document_id=None, workspace_id=None, element_id=None, part_id=None):  # noqa: E501
