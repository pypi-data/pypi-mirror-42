...
class BTLocationInfo(object):
    ...
    def __init__(self, from_node=None, line=None, version=None, document=None, top_level=None, element_microversion=None, module_ids=None, language_version=None, changeable_child_field_indices=None, column=None, end_line=None, end_column=None, character=None, parse_node_id=None, end_character=None, parse_node_id_raw=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, first_child_field=None, child_list_indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
