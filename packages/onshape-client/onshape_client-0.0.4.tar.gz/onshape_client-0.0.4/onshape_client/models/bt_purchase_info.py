...
class BTPurchaseInfo(object):
    ...
    def __init__(self, state=None, last_modified=None, group=None, plan_type=None, amount_cents=None, duration=None, currency=None, account_id=None, payment_type=None, card=None, light_seats=None, canceled_at=None, plan_id=None, plan=None, seats=None, subscription_begin_at=None, subscription_end_at=None, subscription_id=None, application=None, client_id=None, subscribers=None, trial_end=None, actual_amount_paid_cents=None, plan_name=None, coupon_percent_off=None, reseller_name=None, subscription_fields=None, purchase_date=None, pending_cancelation=None, next_charge=None, prorated_charges=None, prorated_total=None, coupon_amount_off=None, duration_months=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
