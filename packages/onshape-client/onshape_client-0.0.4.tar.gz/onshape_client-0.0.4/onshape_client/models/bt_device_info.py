...
class BTDeviceInfo(object):
    ...
    def __init__(self, mobile=None, description=None, version=None, device_name=None, operating_system=None, client_type=None, device_type=None, browser=None, manufacturer=None):  # noqa: E501
