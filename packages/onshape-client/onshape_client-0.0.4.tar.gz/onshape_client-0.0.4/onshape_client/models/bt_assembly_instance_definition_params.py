...
class BTAssemblyInstanceDefinitionParams(object):
    ...
    def __init__(self, is_whole_part_studio=None, revision=None, document_id=None, version_id=None, element_id=None, part_number=None, configuration=None, part_id=None, microversion_id=None, feature_id=None, is_assembly=None):  # noqa: E501
