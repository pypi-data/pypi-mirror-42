...
class BTWorkflowPropertyInfo(object):
    ...
    def __init__(self, is_notifier_property=None, is_approver_property=None, name=None, default_value=None, initial_value=None, dirty=None, required=None, schema_id=None, value_type=None, property_id=None, enum_values=None, editable=None, property_source=None, validator=None, ui_hints=None):  # noqa: E501
