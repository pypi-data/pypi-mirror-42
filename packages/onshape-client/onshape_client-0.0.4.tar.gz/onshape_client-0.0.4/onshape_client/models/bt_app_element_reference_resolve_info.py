...
class BTAppElementReferenceResolveInfo(object):
    ...
    def __init__(self, target_element_microversion_id=None, resolved_element_microversion_id=None, revision=None, part_number=None, change_id=None, target_document_id=None, target_element_id=None, target_configuration=None, target_version_id=None, is_sketch_only=None, id_tag_is_valid=None, reference_id=None, target_document_microversion_id=None, is_configurable=None, resolved_document_microversion_id=None, is_flattened_part=None, track_new_versions=None, sketch_ids=None, id_tag=None, error_code=None, error_value=None, error_description=None):  # noqa: E501
