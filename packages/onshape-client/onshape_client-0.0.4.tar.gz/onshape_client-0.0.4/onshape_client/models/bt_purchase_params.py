...
class BTPurchaseParams(object):
    ...
    def __init__(self, password=None, trial_period_days=None, light_seats=None, allow_deprecated_plan=None, user_id=None, email=None, plan_id=None, seats=None, domain_prefix=None, payment_type=None, reseller_name=None):  # noqa: E501
