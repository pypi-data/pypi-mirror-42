...
class BTProjectInfo(object):
    ...
    def __init__(self, permission_set=None, trash=None, permission_scheme=None, role_map_entries=None, owner=None, description=None, project_id=None, can_move=None, is_container=None, created_at=None, tree_href=None, is_mutable=None, resource_type=None, is_enterprise_owned=None, modified_at=None, created_by=None, modified_by=None, has_pending_owner=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
