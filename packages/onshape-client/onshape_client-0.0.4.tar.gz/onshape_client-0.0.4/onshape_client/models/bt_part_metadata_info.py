...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, revision=None, vendor=None, project=None, href=None, element_id=None, part_number=None, custom_properties=None, configuration_id=None, product_line=None, title1=None, title2=None, title3=None, part_query=None, part_id=None, unflattened_part_id=None, material=None, microversion_id=None, thumbnail_info=None, thumbnail_configuration_id=None, body_type=None, is_flattened_body=None, is_mesh=None, appearance=None, custom_property_definitions=None, referencing_configured_part_node_ids=None, is_hidden=None, ordinal=None, property_source_types=None):  # noqa: E501
