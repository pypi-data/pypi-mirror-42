...
class BTDocumentScope(object):
    ...
    def __init__(self, asserted_element_type=None, document_microversion_id=None, version_id=None, document_id=None, configuration=None, workspace_id=None, element_id=None):  # noqa: E501
