...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, data=None, options=None, project_id=None, folder_id=None, filter=None, part_id=None, url=None, events=None, user_id=None, version_id=None, document_id=None, company_id=None, client_id=None, workspace_id=None, element_id=None):  # noqa: E501
