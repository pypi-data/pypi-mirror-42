...
class BTWorkflowSnapshotInfo(object):
    ...
    def __init__(self, actions=None, state=None, approver_ids=None, notifier_ids=None, rejected_by=None, is_setup=None, approved_by=None, is_frozen=None, is_discarded=None, metadata_state=None):  # noqa: E501
