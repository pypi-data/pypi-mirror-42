...
class BTMoveElementParams(object):
    ...
    def __init__(self, name=None, generate_unknown_messages=None, need_new_version=None, is_copy=None, is_deep_copy=None, anchor_element_id=None, description=None, tags=None, owner_id=None, project_id=None, parent_id=None, is_public=None, version_name=None, target_document_id=None, elements=None, owner_type=None, is_group_anchor=None, target_workspace_id=None, source_document_id=None, source_workspace_id=None, import_data=None, element_original_to_new_map=None, is_new_document=None, owner_email=None):  # noqa: E501
