...
class BTCloudStorageObjectInfo(object):
    ...
    def __init__(self, mime_type=None, parent_id=None, cloud_storage_account_id=None, thumbnail_info=None, cloud_storage_provider=None, cloud_storage_object_id=None, size_bytes=None, web_view_link=None, icon_link=None, created_by_id=None, modified_by_id=None, owner=None, description=None, project_id=None, can_move=None, is_container=None, created_at=None, tree_href=None, is_mutable=None, resource_type=None, is_enterprise_owned=None, modified_at=None, created_by=None, modified_by=None, has_pending_owner=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
