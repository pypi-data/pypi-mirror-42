...
class BTCommentInfo(object):
    ...
    def __init__(self, message=None, state=None, element_occurrences=None, assembly_features=None, can_resolve_or_reopen=None, can_delete=None, version_id=None, view_data=None, workspace_id=None, element_id=None, user=None, element_query=None, element_feature=None, assignee=None, assigned_at=None, top_level=None, reopened_by=None, reopened_at=None, attachment=None, resolved_by=None, resolved_at=None, parent_id=None, thumbnail=None, created_at=None, document_id=None, release_package_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
