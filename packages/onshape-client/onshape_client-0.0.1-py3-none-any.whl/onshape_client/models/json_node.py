...
class JsonNode(object):
    ...
    def __init__(self, array=None, null=None, float=None, node_type=None, textual=None, object=None, int=None, short=None, number=None, pojo=None, value_node=None, container_node=None, missing_node=None, integral_number=None, floating_point_number=None, long=None, double=None, big_decimal=None, big_integer=None, boolean=None, binary=None):  # noqa: E501
