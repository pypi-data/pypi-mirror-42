...
class BTReleasePackageInfo(object):
    ...
    def __init__(self, properties=None, is_setup=None, detailed=None, column_names=None, comments=None, items=None, package_thumbnail=None, description=None, version_id=None, workspace_id=None, document_id=None, company_id=None, is_obsoletion=None, workflow=None, is_frozen=None, revision_rule_id=None, linked_version_ids=None, is_discarded=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
