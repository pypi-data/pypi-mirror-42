...
class BTMoveElementParams(object):
    ...
    def __init__(self, name=None, generate_unknown_messages=None, is_copy=None, need_new_version=None, is_deep_copy=None, anchor_element_id=None, version_name=None, elements=None, description=None, tags=None, owner_type=None, parent_id=None, project_id=None, is_public=None, target_document_id=None, import_data=None, target_workspace_id=None, element_original_to_new_map=None, is_new_document=None, owner_id=None, source_document_id=None, source_workspace_id=None, is_group_anchor=None, owner_email=None):  # noqa: E501
