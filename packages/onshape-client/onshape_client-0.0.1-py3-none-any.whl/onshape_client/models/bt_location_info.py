...
class BTLocationInfo(object):
    ...
    def __init__(self, from_node=None, version=None, line=None, top_level=None, document=None, element_microversion=None, language_version=None, module_ids=None, column=None, end_line=None, changeable_child_field_indices=None, end_column=None, parse_node_id=None, parse_node_id_raw=None, character=None, end_character=None, node_id=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, first_child_field=None, child_list_indices=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
