...
class BTPDMMetadataParams(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, revision=None, configuration=None, element_id=None, part_number=None, part_id=None, project=None, custom_properties=None, vendor=None, product_line=None, title1=None, title2=None, title3=None):  # noqa: E501
