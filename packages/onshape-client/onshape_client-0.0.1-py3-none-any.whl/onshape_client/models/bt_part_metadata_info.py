...
class BTPartMetadataInfo(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, revision=None, microversion_id=None, element_id=None, href=None, part_number=None, custom_properties=None, thumbnail_info=None, configuration_id=None, part_query=None, material=None, part_id=None, project=None, vendor=None, product_line=None, title1=None, title2=None, title3=None, unflattened_part_id=None, thumbnail_configuration_id=None, is_mesh=None, body_type=None, is_flattened_body=None, referencing_configured_part_node_ids=None, appearance=None, custom_property_definitions=None, is_hidden=None, ordinal=None, property_source_types=None):  # noqa: E501
