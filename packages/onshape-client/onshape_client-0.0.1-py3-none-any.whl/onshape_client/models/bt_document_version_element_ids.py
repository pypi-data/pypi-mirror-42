...
class BTDocumentVersionElementIds(object):
    ...
    def __init__(self, version_id=None, element_id=None, document_id=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
