...
class BTDrawingParams(object):
    ...
    def __init__(self, location=None, size=None, language=None, revision=None, decimal_separator=None, units=None, views=None, compute_intersection=None, document_microversion_id=None, hidden_lines=None, include_surfaces=None, is_surface=None, pure_sketch=None, is_sketch_only=None, workspace_id=None, element_id=None, sketch_id=None, sketch_ids=None, part_number=None, external_document_id=None, external_document_version_id=None, element_configuration=None, template_document_id=None, template_workspace_id=None, template_name=None, template_args=None, template_element_id=None, drawing_name=None, projection=None, standard=None, border=None, titleblock=None, number_horizontal_zones=None, number_vertical_zones=None, start_zones=None, document_id=None, part_query=None, part_id=None, element_microversion_id=None, model_type=None, template_version_id=None):  # noqa: E501
