...
class BTReleasePackageItemInfo(object):
    ...
    def __init__(self, properties=None, mime_type=None, errors=None, configuration=None, version_id=None, element_type=None, workspace_id=None, element_id=None, document_id=None, company_id=None, part_id=None, configuration_key=None, small_thumbnail_href=None, diff_thumbnail_configuration_key=None, is_revision_managed=None, is_included_editable=None, rpid=None, obsoletion_revision_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
