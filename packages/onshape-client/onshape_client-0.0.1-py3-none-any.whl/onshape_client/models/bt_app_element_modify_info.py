...
class BTAppElementModifyInfo(object):
    ...
    def __init__(self, element_id=None, change_id=None, transaction_id=None, parent_change_id=None, error_code=None, error_value=None, error_description=None):  # noqa: E501
