...
class BTExportModelParams(object):
    ...
    def __init__(self, configuration=None, workspace_id=None, element_id=None, document_id=None, document_version_id=None, link_document_workspace_id=None, microversion=None, link_document_id=None, sheet_metal_flat=None, include_bend_lines=None, include_sketches=None, flatten=None, splines_as_polylines=None, is_parting_out=None, include_bend_centerlines=None, batch_flat_patterns=None, format=None, version=None, view=None, user_id=None, mode=None, scale=None, units=None, cloud_object_id=None, part_query=None, element_ids=None, part_ids=None, angle_tolerance=None, chord_tolerance=None, max_facet_width=None, store_in_document=None, cloud_storage_account_id=None, trigger_auto_download=None, destination_name=None, include_export_ids=None, feature_ids=None, min_facet_width=None, resolution=None, grouping=None, zip_single_file_output=None, include_foreign_data=None, deep_search_for_foreign_data=None, include_std=None, include_release_management_data=None, include_linked_documents=None, extract_to_s3=None):  # noqa: E501
