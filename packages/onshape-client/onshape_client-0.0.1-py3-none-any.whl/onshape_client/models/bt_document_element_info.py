...
class BTDocumentElementInfo(object):
    ...
    def __init__(self, name=None, id=None, type=None, microversion_id=None, element_type=None, filename=None, thumbnail_info=None, thumbnails=None, data_type=None, foreign_data_id=None, length_units=None, angle_units=None, mass_units=None):  # noqa: E501
