...
class BTDocumentSearchParams(object):
    ...
    def __init__(self, type=None, raw_query=None, offset=None, limit=None, document_filter=None, sort_column=None, sort_order=None, found_in=None, when=None, owner_id=None, parent_id=None):  # noqa: E501
