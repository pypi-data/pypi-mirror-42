...
class BTVersionOrWorkspaceParams(object):
    ...
    def __init__(self, name=None, description=None, microversion_id=None, version_id=None, workspace_id=None, document_id=None, read_only=None, is_release=None, from_history=None, client_interaction_mode=None):  # noqa: E501
