...
class BTCompanySummaryInfo(object):
    ...
    def __init__(self, state=None, type=None, description=None, image=None, admin=None, no_public_documents=None, enterprise_base_url=None, domain_prefix=None, owner_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
