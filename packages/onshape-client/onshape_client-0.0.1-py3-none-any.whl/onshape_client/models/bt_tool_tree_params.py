...
class BTToolTreeParams(object):
    ...
    def __init__(self, context=None, priority=None, id=None, active=None, namespace=None, icon=None, owner_type=None, capability=None, owner_id=None, node_type=None, tool_name=None, tooltip_key=None, expanded_tooltip_key=None, command=None, command_details=None, feature_spec_name=None, fs_version=None, use_dynamic_snippet=None, use_history=None, mini=None, collection_name=None, icon_initials=None, context_menu=None, is_newer_version_available=None):  # noqa: E501
