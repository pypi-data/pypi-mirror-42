...
class BTShareParams(object):
    ...
    def __init__(self, message=None, entries=None, permission=None, workspace_id=None, element_id=None, update=None, document_id=None, folder_id=None, permission_set=None, encoded_configuration=None):  # noqa: E501
