...
class BTReleasePackageItem(object):
    ...
    def __init__(self, name=None, id=None, state=None, mime_type=None, revision=None, errors=None, configuration=None, microversion_id=None, version_id=None, children=None, element_type=None, workspace_id=None, element_id=None, modified_at=None, created_at=None, document_id=None, part_number=None, company_id=None, part_id=None, created_by=None, modified_by=None, configuration_key=None, revision_rule_id=None, is_included=None, remote_state=None, initial_revision=None, small_thumbnail_href=None, diff_thumbnail_configuration_key=None, is_revision_managed=None, rpid=None, obsoletion_revision_id=None):  # noqa: E501
