...
class BTMetricParams(object):
    ...
    def __init__(self, property_map=None, system_id=None, element_id=None, event_type=None, event_name=None, event_namespace=None, event_time=None, document_id=None):  # noqa: E501
