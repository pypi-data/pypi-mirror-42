...
class BTUniqueDocumentItemParams(object):
    ...
    def __init__(self, revision=None, version_id=None, element_type=None, workspace_id=None, element_id=None, part_number=None, document_id=None, part_id=None, api_configuration=None):  # noqa: E501
