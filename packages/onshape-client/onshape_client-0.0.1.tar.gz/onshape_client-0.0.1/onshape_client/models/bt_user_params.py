...
class BTUserParams(object):
    ...
    def __init__(self, name=None, message=None, id=None, state=None, token=None, source=None, password=None, description=None, country_code=None, role=None, first_name=None, last_name=None, email=None, default_company_name=None, plan_id=None, seats=None, forum_id=None, phone_number=None, recaptcha=None, invite_friend_request=None, approve_user=None, cad_system_at_signup=None, company_plan=None, eula_accepted=None, upgrade_to_education_plan=None):  # noqa: E501
