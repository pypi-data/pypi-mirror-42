...
class BTGlobalTreeNodeInfo(object):
    ...
    def __init__(self, owner=None, description=None, modified_at=None, project_id=None, can_move=None, is_container=None, created_at=None, is_enterprise_owned=None, created_by=None, modified_by=None, tree_href=None, is_mutable=None, resource_type=None, has_pending_owner=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
