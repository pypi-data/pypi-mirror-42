...
class BTWorkspaceInfo(object):
    ...
    def __init__(self, is_read_only=None, can_delete=None, parent=None, type=None, description=None, modified_at=None, last_modifier=None, creator=None, thumbnail=None, created_at=None, document_id=None, parents=None, microversion=None, override_date=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
