...
class BTDocumentScope(object):
    ...
    def __init__(self, configuration=None, version_id=None, document_microversion_id=None, workspace_id=None, element_id=None, document_id=None, asserted_element_type=None):  # noqa: E501
