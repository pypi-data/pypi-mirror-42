...
class BTReleasePackageItemParams(object):
    ...
    def __init__(self, properties=None, id=None, configuration=None, version_id=None, workspace_id=None, element_id=None, href=None, part_number=None, document_id=None, part_id=None, is_included=None):  # noqa: E501
