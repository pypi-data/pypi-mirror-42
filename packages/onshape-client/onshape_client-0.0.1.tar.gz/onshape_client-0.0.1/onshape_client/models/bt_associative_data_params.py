...
class BTAssociativeDataParams(object):
    ...
    def __init__(self, type=None, configuration=None, microversion_id=None, version_id=None, data=None, workspace_id=None, element_id=None, id_tag=None, view_id=None, document_microversion=None, associative_data_id=None, operation=None, occurrence_id=None, is_hidden_base_view=None, document_id=None):  # noqa: E501
