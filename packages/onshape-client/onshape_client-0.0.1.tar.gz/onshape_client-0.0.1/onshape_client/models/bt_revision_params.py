...
class BTRevisionParams(object):
    ...
    def __init__(self, revision=None, version_id=None, element_type=None, element_id=None, part_number=None, insertable_id=None, release_id=None, document_id=None, company_id=None):  # noqa: E501
