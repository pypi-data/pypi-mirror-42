...
class BTWebhookParams(object):
    ...
    def __init__(self, id=None, url=None, options=None, user_id=None, version_id=None, filter=None, data=None, workspace_id=None, element_id=None, events=None, document_id=None, company_id=None, client_id=None, project_id=None, folder_id=None, part_id=None):  # noqa: E501
