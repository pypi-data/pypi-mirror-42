...
class BTTranslationRequestInfo(object):
    ...
    def __init__(self, request_element_id=None, request_state=None, result_external_data_ids=None, version_id=None, workspace_id=None, document_id=None, result_element_ids=None, result_document_id=None, failure_reason=None, result_workspace_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
