...
class BTAppViewParams(object):
    ...
    def __init__(self, parameters=None, broken_out_section=None, bom_reference_id=None, display_state_id=None, view_matrix=None, crop_view=None, view_direction=None, cut_point=None, offset_section_points=None, model_reference_id=None, include_hidden_instances=None, view_scale=None, compute_intersection=None, is_broken_out_section=None, is_crop_view=None, show_tangent_lines=None, hidden_lines=None, modification_id=None, perspective=None, projection_angle=None, show_threads=None, is_partial_section=None, broken_out_point_numbers=None, broken_out_end_conditions=None, broken_out_b_boxes=None, include_surfaces=None, is_surface=None, depth_section_end_condition=None, transaction_id=None, parent_change_id=None, occurrence_or_part_id_to_geometry_properties=None):  # noqa: E501
