...
class BTDocumentParams(object):
    ...
    def __init__(self, name=None, generate_unknown_messages=None, is_empty_content=None, description=None, tags=None, owner_type=None, is_public=None, not_revision_managed=None, beta_capability_ids=None, owner_id=None, project_id=None, parent_id=None, owner_email=None):  # noqa: E501
