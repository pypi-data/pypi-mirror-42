...
class BTStandardContentHierarchyInfo(object):
    ...
    def __init__(self, type=None, existing_versions=None, default_workspace=None, category=None, document_type=None, standard=None, types=None, production_version_id=None, test_version_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
