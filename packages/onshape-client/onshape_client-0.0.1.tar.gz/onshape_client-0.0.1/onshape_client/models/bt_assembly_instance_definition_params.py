...
class BTAssemblyInstanceDefinitionParams(object):
    ...
    def __init__(self, is_whole_part_studio=None, revision=None, configuration=None, microversion_id=None, version_id=None, element_id=None, document_id=None, part_number=None, feature_id=None, part_id=None, is_assembly=None):  # noqa: E501
