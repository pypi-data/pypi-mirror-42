...
class BTAppElementReferenceParams(object):
    ...
    def __init__(self, update_sketch_info=None, revision=None, target_version_id=None, pure_sketch=None, is_sketch_only=None, transaction_id=None, parent_change_id=None, sketch_id=None, sketch_ids=None, id_tag=None, part_number=None, target_document_id=None, target_element_id=None, target_configuration=None, return_error=None, has_document_microversions=None, target_microversion_id=None, id_tag_microversion_id=None, track_new_versions=None):  # noqa: E501
