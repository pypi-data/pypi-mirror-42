...
class BTPurchaseParams(object):
    ...
    def __init__(self, password=None, user_id=None, payment_type=None, email=None, plan_id=None, seats=None, domain_prefix=None, trial_period_days=None, light_seats=None, allow_deprecated_plan=None, reseller_name=None):  # noqa: E501
