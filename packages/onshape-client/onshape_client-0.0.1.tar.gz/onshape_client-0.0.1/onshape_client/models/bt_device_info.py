...
class BTDeviceInfo(object):
    ...
    def __init__(self, version=None, description=None, client_type=None, device_name=None, operating_system=None, device_type=None, browser=None, manufacturer=None, mobile=None):  # noqa: E501
