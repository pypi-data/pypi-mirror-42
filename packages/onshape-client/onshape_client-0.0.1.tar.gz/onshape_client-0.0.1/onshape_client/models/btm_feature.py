...
class BTMFeature(object):
    ...
    def __init__(self, sketch=None, full_feature_type=None, imported_microversion_id=None, external_document_with_version_and_element_id=None, imported_workspace_element_id=None, revision_data=None, all_parameters=None, namespace_field_index=None, regenerate_as_version=None, plane=None, suppression_state_field_index=None, suppressed_field_index=None, namespace=None, node_id=None, _import=None, combined_namespace=None, for_export=None, import_microversion=None, name=None, suppressed=None, parameters=None, suppression_state=None, feature_id=None, feature_type=None, sub_features=None, return_after_subfeatures=None, changeable_child_field_indices=None, first_child_field=None, child_list_indices=None, suppressed_parse_node=None, name_parse_node=None, child_nodes=None, has_user_code=None, source_parse_tree_nodes=None, child_locations=None, child_map_indices=None, atomic_child_indices=None, node_id_raw=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
