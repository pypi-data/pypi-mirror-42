...
class BTDocumentWithVersionAndElementId(object):
    ...
    def __init__(self, document_id=None, document_version_id=None, element_id=None, part_number=None, revision=None, unique_version_id=None, valid_revision_reference=None):  # noqa: E501
