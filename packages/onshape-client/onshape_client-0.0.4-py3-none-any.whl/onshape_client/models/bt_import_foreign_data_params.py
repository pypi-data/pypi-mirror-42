...
class BTImportForeignDataParams(object):
    ...
    def __init__(self, size=None, filename=None, owner_id=None, owner_type=None, file_format=None, public_document=None, notify_user=None, document_id=None, media_type=None, unit=None, project_id=None, parent_id=None, foreign_id=None, upload_id=None, split_assemblies_into_multiple_documents=None, flatten_assemblies=None, gety_axis_is_up=None, allow_faulty_parts=None, original_foreign_id=None, update_existing_import_features=None, blob_microversion_id=None, blob_element_id=None, specify_units=None):  # noqa: E501
