...
class BTExportModelParams(object):
    ...
    def __init__(self, document_id=None, element_id=None, link_document_id=None, workspace_id=None, configuration=None, microversion=None, document_version_id=None, link_document_workspace_id=None, sheet_metal_flat=None, include_bend_lines=None, include_sketches=None, flatten=None, splines_as_polylines=None, is_parting_out=None, include_bend_centerlines=None, batch_flat_patterns=None, user_id=None, trigger_auto_download=None, version=None, format=None, mode=None, scale=None, units=None, part_ids=None, part_query=None, angle_tolerance=None, chord_tolerance=None, max_facet_width=None, store_in_document=None, cloud_storage_account_id=None, view=None, element_ids=None, cloud_object_id=None, destination_name=None, include_export_ids=None, feature_ids=None, min_facet_width=None, resolution=None, grouping=None, zip_single_file_output=None, include_foreign_data=None, deep_search_for_foreign_data=None, include_std=None, include_release_management_data=None, include_linked_documents=None, extract_to_s3=None):  # noqa: E501
