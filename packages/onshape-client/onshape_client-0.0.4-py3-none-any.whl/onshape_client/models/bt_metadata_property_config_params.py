...
class BTMetadataPropertyConfigParams(object):
    ...
    def __init__(self, default_value=None, min_date=None, max_date=None, display_name=None, pattern=None, required=None, publish_state=None, schema_id=None, property_id=None, min_length=None, max_length=None, min_value=None, max_value=None, min_count=None, max_count=None, multiline=None, enum_values=None):  # noqa: E501
