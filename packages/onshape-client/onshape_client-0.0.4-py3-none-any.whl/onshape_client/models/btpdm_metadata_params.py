...
class BTPDMMetadataParams(object):
    ...
    def __init__(self, name=None, id=None, state=None, description=None, revision=None, vendor=None, project=None, element_id=None, part_number=None, custom_properties=None, product_line=None, title1=None, title2=None, title3=None, part_id=None, configuration=None):  # noqa: E501
