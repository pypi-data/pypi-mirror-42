...
class BTUserParams(object):
    ...
    def __init__(self, name=None, message=None, id=None, state=None, description=None, source=None, recaptcha=None, invite_friend_request=None, approve_user=None, cad_system_at_signup=None, company_plan=None, eula_accepted=None, password=None, token=None, forum_id=None, role=None, phone_number=None, first_name=None, last_name=None, email=None, default_company_name=None, plan_id=None, seats=None, country_code=None, upgrade_to_education_plan=None):  # noqa: E501
