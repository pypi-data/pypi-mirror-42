...
class BTDocumentElementInfo(object):
    ...
    def __init__(self, name=None, id=None, type=None, element_type=None, filename=None, data_type=None, foreign_data_id=None, length_units=None, angle_units=None, mass_units=None, microversion_id=None, thumbnail_info=None, thumbnails=None):  # noqa: E501
