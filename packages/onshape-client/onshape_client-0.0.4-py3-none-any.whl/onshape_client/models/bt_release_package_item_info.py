...
class BTReleasePackageItemInfo(object):
    ...
    def __init__(self, properties=None, element_type=None, mime_type=None, document_id=None, version_id=None, element_id=None, company_id=None, configuration=None, part_id=None, workspace_id=None, configuration_key=None, diff_thumbnail_configuration_key=None, small_thumbnail_href=None, is_revision_managed=None, errors=None, is_included_editable=None, rpid=None, obsoletion_revision_id=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
