...
class BTExportTessellatedFacesFacet(object):
    ...
    def __init__(self, normal=None, indices=None, normals=None, vertices=None, texture_coordinates=None, type_id=None, export_type_name=None, connection_source=None, unknown_class=None):  # noqa: E501
