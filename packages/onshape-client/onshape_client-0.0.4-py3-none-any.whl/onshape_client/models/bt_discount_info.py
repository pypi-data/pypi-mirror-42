...
class BTDiscountInfo(object):
    ...
    def __init__(self, expires_at=None, owner_id=None, created_at=None, percent_off=None, amount_off=None, coupon_type=None, coupon_valid_months=None, plan_id=None, created_by=None, used_at=None, trial_end_date=None, account_balance=None, name=None, id=None, href=None, view_ref=None):  # noqa: E501
