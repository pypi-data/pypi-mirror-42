...
class BTBillingPlanParams(object):
    ...
    def __init__(self, name=None, description=None, group=None, application_id=None, plan_type=None, trial_period_days=None, consumable_quantity=None, amount_cents=None, hidden=None, interval=None, plan_id=None, client_id=None):  # noqa: E501
