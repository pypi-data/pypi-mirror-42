...
class BTReleasePackageItem(object):
    ...
    def __init__(self, name=None, id=None, state=None, revision=None, element_type=None, mime_type=None, created_at=None, document_id=None, version_id=None, element_id=None, part_number=None, company_id=None, children=None, configuration=None, part_id=None, microversion_id=None, workspace_id=None, configuration_key=None, modified_at=None, created_by=None, modified_by=None, revision_rule_id=None, is_included=None, remote_state=None, diff_thumbnail_configuration_key=None, small_thumbnail_href=None, initial_revision=None, is_revision_managed=None, errors=None, rpid=None, obsoletion_revision_id=None):  # noqa: E501
