...
class BTDocumentParams(object):
    ...
    def __init__(self, name=None, generate_unknown_messages=None, is_empty_content=None, description=None, tags=None, owner_id=None, project_id=None, parent_id=None, is_public=None, owner_type=None, beta_capability_ids=None, not_revision_managed=None, owner_email=None):  # noqa: E501
