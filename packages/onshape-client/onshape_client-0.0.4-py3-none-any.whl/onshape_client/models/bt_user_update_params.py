...
class BTUserUpdateParams(object):
    ...
    def __init__(self, name=None, id=None, description=None, forum_id=None, old_password=None, new_password=None, phone_number=None, first_name=None, last_name=None, default_company_name=None, country_code=None):  # noqa: E501
