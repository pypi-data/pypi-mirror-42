...
class cifConverter:
    ...
    def saveCif(self, saveDir, overwrite=False):
        """
    ...
    def setupCif(self):
        ...
        #print self.labelVal
        #print len(self.symbolVal), len(self.aniso11Val), len(self.aniso22Val), len(self.aniso33Val), len(self.aniso12Val), len(self.aniso13Val), len(self.aniso23Val)
        for i in range(len(self.aniso11Val)):
            #print i
...
if __name__ == "__main__":
    CIFs = os.listdir('/media/emilkjaer/Seagate Expansion Drive/ICSD/TestCIF')
    count = 0
    for CIF in CIFs:
        #print count
        count +=1
        os.chdir('/media/emilkjaer/Seagate Expansion Drive/ICSD/TestCIF')
        WO_test = cifConverter(CIF)
        WO_test.readCif()
        WO_test.getInfo()
    #WO_test.setBiso(1, param=[11, 22], atom='W')
        WO_test.changeAtom('D', 'H')
        WO_test.saveCif(saveDir='/media/emilkjaer/Seagate Expansion Drive/ICSD/CCTestCIF')
