...
if __name__ == '__main__':
    ...
    testObj.setSaveDir('/media/emilkjaer/Seagate Expansion Drive/ICSD/Pear')        
    testObj.loadCIF('/media/emilkjaer/Seagate Expansion Drive/ICSD/CCTestCIF')
    ...
    #testObj.fitScale(save=True)
    #testObj.fitCell(rank=20, save=True)
