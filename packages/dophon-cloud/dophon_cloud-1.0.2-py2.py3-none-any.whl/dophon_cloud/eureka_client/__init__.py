...
ha_type = eval(client_config.ha if hasattr(client_config, 'ha') else 'eureka_client.HA_STRATEGY_RANDOM')
...
client_proxy, discovery_proxy = eureka_client.init(eureka_server=client_config.center,
                                                   app_name=app_name,
