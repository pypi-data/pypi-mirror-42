...
class PermutationGate(ops.MultiQubitGate):
...
class LinearPermutationGate(PermutationGate):
    ...
    def __init__(self,
        ...
        """
        super(LinearPermutationGate, self).__init__(len(permutation), swap_gate)
    ...
    def __repr__(self):
        return (u'cirq.contrib.acquaintance.LinearPermutationGate('
                u'{!r}, {!r})'.format(self._permutation, self.swap_gate))
