...
setup(
    name="wg-countdown-timer",
    python_requires=">=3.6",
    version=get_version("wg-countdown-timer"),
    ...
    packages=get_packages("wg-countdown-timer"),
    data_files=[("", ["LICENSE", "wg-countdown-timer/countdown.js"])],
    install_requires=["starlette", "apscheduler"],
    classifiers=[
