...
class WGCountdownTimer():
    ...
    def initialize(cls) -> None:
        ...
        cls.server.add_route('/v0/countdown/start', CountdownTimerActionEndpoints.start, methods=['POST'])
        cls.server.add_route('/v0/countdown/reset', CountdownTimerActionEndpoints.reset, methods=['POST'])
        cls.server.add_route('/v0/countdown/stop', CountdownTimerActionEndpoints.stop, methods=['POST'])
        cls.server.add_route('/v0/countdown/pause', CountdownTimerActionEndpoints.pause, methods=['POST'])
        cls.server.add_route('/v0/countdown/resume', CountdownTimerActionEndpoints.resume, methods=['POST'])
