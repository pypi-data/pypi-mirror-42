...
var CountdownTimer = new function(){
     ...
     */
    self.updateSeconds = function(seconds /*: Number */) {
     ...
     */
    self.updateUntilBreak = function(until_break /*: Number */) {
    ...
    self.initialize = function() {
        const self = self;
        const countdown_change_ws = new WebSocket("/v0/ws/countdown/change");
        ...
        const subscribers_ws = new WebSocket("/v0/ws/countdown/change/subscribers");
