...
class RookDuplicateAugIdException(RookMonitorException):
    def __init__(self, aug_id):
        super(RookDuplicateAugIdException, self).__init__("Failed to set breakpoint %s due to duplicate"
                                                          " aug ID", {'aug_id': aug_id})
