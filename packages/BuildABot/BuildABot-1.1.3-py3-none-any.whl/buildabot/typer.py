...
class Typer:
    ...
    @staticmethod
    def define_type(name: str, check):
        """
        Define a type
...
Typer.define_type('int', check_int)
Typer.define_type('float', check_float)
Typer.define_type('number', check_number)
Typer.define_type('bool', check_bool)
Typer.define_type('str', check_str)
