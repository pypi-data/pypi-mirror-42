...
class iOSBuild:
    ...
    def XcodeToIPA(self,ProjectPath,p12file_dis,provision_dis,exportOptionPlistPath,iPASavePath,P12PassWord,IPAName,SHA1,ShowLog):
        ...
        provision_bds_dir = "~/Library/MobileDevice/Provisioning Profiles/";
    ...
    def BuildIPA(self, IPASavePath, SSLCommonName, uuid_mobileprovision, ExportOptionPlistPath,IPAName):
        ...
        if (os.path.exists("Unity-iPhone.ipa")):
            ...
            os.rename("Unity-iPhone.ipa", IPAName + time_str + ".ipa");
