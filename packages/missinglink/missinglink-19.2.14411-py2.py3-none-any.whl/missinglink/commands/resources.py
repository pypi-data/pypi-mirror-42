...
# cloud creds
@click.option('--link-aws/--no-aws-link', required=False, default=True, help='Allow the resource manager to access you current AWS configuration folder.')
@click.option('--env-aws/--no-aws-env', required=False, default=True, help='Allow the resource manager to access you current AWS environment variables.')
@click.option('--link-gcp/--no-gcp', required=False, default=True, help='Allow the resource manager to access you current `gcloud` configuration folder.')
@click.option('--link-azure/--no-azure', required=False, default=True, help='Allow the resource manager to access you current Azure configuration folder.')
...
@click.option('--show-defaults/--no-defaults', required=False, default=False, help="Show default values as well")
@click.option('--create', required=False, default=None, type=click.Choice(['aws', 'local', 'azure']), help="Create new aws/azure/local group.")
@click.option('--show-description/--no-description', required=False, default=False, help="Show parameter descriptions as well.")
...
@click.option('--unset', required=False, default=[], type=str, multiple=True, help="Reset parameter value. If the same parameter is specified as in both `--set` and `--unset`, it will be unset.")
@click.pass_context
