    ...
    def create(
        ...
        Args:
            ...
            converters (Dict[frameworks.ModelFramework,(keras.model.Model) ->
                ...
                function.
            model_uids (Dict[`frameworks.ModelFramework`,str]): Dictionary
                mapping model framework to model uids.  If model_uid not set
        ...
        keras_model_uid = model_uids.get(fritz.frameworks.KERAS)
