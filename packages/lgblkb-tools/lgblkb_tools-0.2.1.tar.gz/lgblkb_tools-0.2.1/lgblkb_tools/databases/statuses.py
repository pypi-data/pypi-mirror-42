...
fallback_status_mapper[back_status.Unprocessed]=['0','',
                                                 back_status.Running.Download,
                                                 back_status.QueuedFor.Download,
                                                 back_status.QueuedFor.HistoricDownload,
                                                 back_status.Running.ImageCheck,
                                                 back_status.Error_DownloadResultsEmpty,
                                                 back_status.Error_NoOptimalProduct,
                                                 back_status.NoAvailableProducts]
fallback_status_mapper[back_status.SubmittedTo.AtmosphericCorrection]=[back_status.Running.AtmosphericCorrection,
                                                                       back_status.QueuedFor.AtmosphericCorrection,
                                                                       back_status.WaitingFinish.AtmosphericCorrection]
fallback_status_mapper[back_status.SubmittedTo.IndexProcessing]=[back_status.QueuedFor.IndexProcessing,
                                                                 back_status.Running.IndexProcessing]
fallback_status_mapper[back_status.SubmittedTo.ImageCheck]=[back_status.QueuedFor.ImageCheck,
                                                            back_status.QueuedFor.Download,
                                                            back_status.Running.ImageCheck,
                                                            back_status.Running.Download,
                                                            back_status.NoAvailableProducts]
