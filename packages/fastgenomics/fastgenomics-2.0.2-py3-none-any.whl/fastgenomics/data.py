...
checks if the files exist.
    ...
    def get_input_file_mapping(self):
        ...
        if self.env_input_file_mapping and mapping_file.exists():
            raise RuntimeError(
                'Environmental variable INPUT_FILE_MAPPING was defined and a mapping file "{mapping_file}" was found.  Please use just one of the abouve to define the input file mapping.'
            )
        elif self.env_input_file_mapping:
            logger.debug(
            ...
            raise RuntimeError(
                'Environmental variable INPUT_FILE_MAPPING was undefined and a mapping file was not found under "{mapping_file}".  Please use one or the other to define the file mapping.'
            )
