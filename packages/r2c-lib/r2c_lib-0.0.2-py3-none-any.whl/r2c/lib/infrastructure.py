...
class Infrastructure(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def get_message(self, src: str, block: bool):
        """
    ...
    @abc.abstractmethod
    def put_message(self, dst: str, message: Message):
        """
            Send MESSAGE to DST
    ...
    @abc.abstractmethod
    def put_file(self, dst: str, filename: str, key: str):
        pass
    ...
    @abc.abstractmethod
    def get_file_metadata(self, src: str, key: str):
        pass

    @abc.abstractmethod
    def put_object(self, dst: str, obj: str, key: str):
        pass

    @abc.abstractmethod
    def put_notify(self, dst: str, message: Message):
        pass


class LocalDirInfra(Infrastructure):
    def __init__(self, directory=DEFAULT_LOCAL_RUN_DIR):
    ...
    def get_message(self, src, block=False):
        raise NotImplementedError("Local Dir Infras don't support queue operations")

    def put_message(self, dst, message: Message):
        raise NotImplementedError("Local Dir Infras don't support queue operations")
    ...
    def read_objects(self, src: str, prefix: str):
        """
    ...
    def read_keys(self, src: str, prefix: str):
        """
        Generator that iterates over all files in a given src directory with a prefix.
        prefix="" iterates over all objects.
    ...
    def put_file(self, dst: str, filename: str, key: str, metadata=None):
        """
