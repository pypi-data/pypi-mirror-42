...
Python external for controlling the Decibel ScorePlayer canvas mode, v0.2.4
...
class scoreStaveObject(scoreCanvasObject):
    #This inherits from the canvas object to avoid duplicating the clear method.
    def setSize(self, width, height):
        self.sendCommand('setSize', int(width), int(height))
