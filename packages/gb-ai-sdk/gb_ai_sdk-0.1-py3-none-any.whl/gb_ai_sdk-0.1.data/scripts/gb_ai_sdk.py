...
PATH_TO_CKPT = "C:/Users/Administrator/Desktop/Vishal_dot_net/objectgeekyb/frozen_inference_graph.pb"
PATH_TO_LABELS = "C:/Users/Administrator/Desktop/Vishal_dot_net/objectgeekyb/graph.pbtxt"
PATH_TO_TEST_IMAGES_DIR = "C:/Users/Administrator/Desktop/Vishal_dot_net/objectgeekyb/inp"
PATH_TO_OUTPUT_IMAGES_DIR = "C:/Users/Administrator/Desktop/Vishal_dot_net/objectgeekyb/outp"
VIDEO_NAME = "C:/Users/Administrator/Desktop/Vishal_dot_net/objectgeekyb/inp/test2.mp4"
...
def run_detection_on_video():
    ...
    while (cap.isOpened()):
        ...
        if ret == True:
            ...
            if count_frame%2==0:
                ts = time.clock()
                output_dict = run_on_image(image_np)
                ts2 = time.clock()
                print(ts2 - ts)
