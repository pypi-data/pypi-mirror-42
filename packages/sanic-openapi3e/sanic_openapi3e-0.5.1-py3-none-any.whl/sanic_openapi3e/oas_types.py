...
In the spec, there are references to lists and arrays, they have been implemented as sets. Some terms in the spec are
unsuitable for python, they have been changed in the code:
...
* Enums (ServerVariable, Schema) are implemented as sets, and loose their inherent order.
...
def _assert_type(element, types, name, clazz):
    ...
    assert isinstance(element, types), "Incorrect type ({}) for {}.{}".format(
        type(element), clazz.__qualname__, name
    )
...
class OObject:
    ...
    def _serialize(value):
        ...
        if isinstance(value, dict):
            return {openapi_keyname(k): OObject._serialize(v) for k, v in value.items()}

        if isinstance(value, (list, set)):
            return [OObject._serialize(v) for v in value]
    ...
    def serialize(self):
        ...
        for k, v in self.__dict__.items():
            ...
            if k2 == "parameters" and self.__class__.__qualname__ in (
                ...
                v2 = list(OObject._serialize(e) for e in v)
            else:
    ...
    def __repr__(self):
        return "{}{}".format(
            self.__class__.__qualname__, json.dumps(self.serialize(), sort_keys=True)
        )
...
class OInteger(OType):
    ...
    formats = {"int32", "int64"}  # type: Optional[Set[str]]
...
class ONumber(OType):
    ...
    formats = {"float", "double"}  # type: Optional[Set[str]]
...
class OBoolean(OType):
    ...
    formats = None  # type: Optional[Set[str]]
...
class Contact(OObject):
    def __init__(self, name, url, email):
        ...
        :type email: str
        """
        _assert_type(name, (str, NoneType), "name", self.__class__)
        _assert_type(url, (str, NoneType), "url", self.__class__)
        _assert_type(email, (str, NoneType), "email", self.__class__)
...
class Info(OObject):
    def __init__(
        ...
        """
        _assert_type(title, (str, NoneType), "title", self.__class__)
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(
            terms_of_service, (str, NoneType), "terms_of_service", self.__class__
        )
        _assert_type(contact, (Contact, NoneType), "contact", self.__class__)
        _assert_type(_license, (License, NoneType), "_license", self.__class__)
        _assert_type(version, (str, NoneType), "version", self.__class__)
...
class ServerVariable(OObject):
    def __init__(self, enum=None, default=None, description=None):
        ...
        """
        _assert_type(enum, (set, NoneType), "enum", self.__class__)
        _assert_type(default, (str, NoneType), "default", self.__class__)
        _assert_type(description, (str, NoneType), "description", self.__class__)
        ...
        self.enum = set(enum)  # type: Set[str]
...
class Server(OObject):
    def __init__(self, url=None, description=None, variables=None):
        ...
        _assert_type(url, (str, NoneType), "url", self.__class__)
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(variables, (str, NoneType), "variables", self.__class__)
...
class Reference(OObject):
    def __init__(self, _ref=None):
        ...
        :type _ref: str
        """
        _assert_type(_ref, (str, NoneType), "_ref ($ref)", self.__class__)
...
class Discriminator(OObject):
    def __init__(self, property_name=None, mapping=None):
        ...
        """
        _assert_type(property_name, (str, NoneType), "property_name", self.__class__)
        _assert_type(mapping, (dict, NoneType), "mapping", self.__class__)
...
class XML(OObject):
    def __init__(
        ...
        """
        _assert_type(name, (str, NoneType), "name", self.__class__)
        _assert_type(namespace, (str, NoneType), "namespace", self.__class__)
        _assert_type(prefix, (str, NoneType), "prefix", self.__class__)
        _assert_type(attribute, (bool, NoneType), "attribute", self.__class__)
        _assert_type(wrapped, (bool, NoneType), "wrapped", self.__class__)
...
class ExternalDocumentation(OObject):
    def __init__(self, name=None, url=None):
        ...
        :param name: A short description of the target documentation. CommonMark syntax MAY be used for rich text
            representation.
...
class Schema(OObject):
    ...
    def __init__(
        ...
        :param required: The value of this keyword MUST be an array.  This array MUST have at least one element.
            ...
            if its property set contains all elements in this keyword's array value. Note: sanic-openapi implements
        ...
        :param enum: The value of this keyword MUST be an array.  This array SHOULD have at least one element.
            ...
            keyword's array value. Note: sanic-openapi implements these checks as a Set of Any.
        ...
        _assert_type(title, (str, NoneType), "title", self.__class__)
        _assert_type(multiple_of, (int, NoneType), "multiple_of", self.__class__)
        _assert_type(maximum, (int, float, NoneType), "maximum", self.__class__)
        _assert_type(
            exclusive_maximum, (bool, NoneType), "exclusive_maximum", self.__class__
        )
        _assert_type(minimum, (int, float, NoneType), "minimum", self.__class__)
        _assert_type(
            exclusive_minimum, (bool, NoneType), "exclusive_minimum", self.__class__
        )
        _assert_type(max_length, (int, NoneType), "max_length", self.__class__)
        _assert_type(min_length, (int, NoneType), "min_length", self.__class__)
        _assert_type(pattern, (str, NoneType), "pattern", self.__class__)
        _assert_type(max_items, (int, NoneType), "max_items", self.__class__)
        _assert_type(min_items, (int, NoneType), "min_items", self.__class__)
        _assert_type(unique_items, (bool, NoneType), "unique_items", self.__class__)
        _assert_type(max_properties, (int, NoneType), "max_properties", self.__class__)
        _assert_type(min_properties, (int, NoneType), "min_properties", self.__class__)
        _assert_type(required, (set, NoneType), "required", self.__class__)
        _assert_type(enum, (set, NoneType), "enum", self.__class__)

        # JSON Schema definition but their definitions were adjusted to the OpenAPI Specification.
        _assert_type(_type, (str, NoneType), "_type", self.__class__)
        _assert_type(all_of, (Schema, Reference, NoneType), "all_of", self.__class__)
        _assert_type(one_of, (Schema, Reference, NoneType), "one_of", self.__class__)
        _assert_type(any_of, (Schema, Reference, NoneType), "any_of", self.__class__)
        _assert_type(_not, (Schema, Reference, NoneType), "_not", self.__class__)
        _assert_type(items, (dict, NoneType), "items", self.__class__)
        # TODO - finish the definition of "items", it is incomplete. Is it supposed to be a dict of Schemae?
        _assert_type(
            properties, (Schema, Reference, NoneType), "properties", self.__class__
        )
        _assert_type(
            additional_properties,
            (Schema, Reference, NoneType),
            "additional_properties",
            self.__class__,
        )
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(_format, (str, NoneType), "_format", self.__class__)
        _assert_type(
            default, (str, int, float, bool, NoneType), "default", self.__class__
        )

        # The OAS extensions
        _assert_type(nullable, (bool, NoneType), "nullable", self.__class__)
        _assert_type(
            discriminator, (Discriminator, NoneType), "discriminator", self.__class__
        )
        _assert_type(read_only, (bool, NoneType), "read_only", self.__class__)
        _assert_type(write_only, (bool, NoneType), "write_only", self.__class__)
        _assert_type(xml, (XML, NoneType), "xml", self.__class__)
        _assert_type(
            external_docs,
            (ExternalDocumentation, NoneType),
            "external_docs",
            self.__class__,
        )
        # Note: example is defined to have the type `Any`
        _assert_type(deprecated, (bool, NoneType), "deprecated", self.__class__)
        ...
        self.required = required  # type: Optional[Set[str]]
        """
        ...
        Note: sanic-openapi implements these checks as a Set of str.
        """

        self.enum = enum  # type: Optional[Set[Any]]
        """
        ...
        Note: sanic-openapi implements these checks as a Set of Any.
        """
...
class Example(OObject):
    def __init__(self, summary=None, description=None, value=None, external_value=None):
        ...
        """
        _assert_type(summary, (str, NoneType), "summary", self.__class__)
        _assert_type(description, (str, NoneType), "description", self.__class__)
        # Note: value can be Any
        _assert_type(external_value, (str, NoneType), "external_value", self.__class__)
...
class Header(OObject):
    def __init__(
        ...
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(required, (bool, NoneType), "required", self.__class__)
        _assert_type(deprecated, (bool, NoneType), "deprecated", self.__class__)
        _assert_type(
            allow_empty_value, (bool, NoneType), "allow_empty_value", self.__class__
        )
        _assert_type(style, (str, NoneType), "style", self.__class__)
        _assert_type(explode, (bool, NoneType), "explode", self.__class__)
        _assert_type(allow_reserved, (bool, NoneType), "allow_reserved", self.__class__)
        _assert_type(schema, (Schema, Reference, NoneType), "schema", self.__class__)
        # Note: examples is specified to be "Any"
        _assert_type(examples, (dict, NoneType), "examples", self.__class__)
        _assert_type(content, (MediaType, NoneType), "content", self.__class__)
...
class Encoding(OObject):
    def __init__(
        ...
        :type allow_reserved:
        """
        _assert_type(content_type, (str, NoneType), "content_type", self.__class__)
        _assert_type(headers, (dict, NoneType), "headers", self.__class__)
        _assert_type(style, (str, NoneType), "style", self.__class__)
        _assert_type(explode, (bool, NoneType), "explode", self.__class__)
        _assert_type(allow_reserved, (bool, NoneType), "allow_reserved", self.__class__)
...
class MediaType(OObject):
    def __init__(self, schema=None, example=None, examples=None, encoding=None):
        ...
        _assert_type(examples, (dict, NoneType), "examples", self.__class__)
        _assert_type(encoding, (dict, NoneType), "encoding", self.__class__)
...
class Parameter(OObject):
    def __init__(
        ...
        _assert_type(name, (str, NoneType), "name", self.__class__)
        _assert_type(_in, (str, NoneType), "_in", self.__class__)
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(required, (bool, NoneType), "required", self.__class__)
        _assert_type(deprecated, (bool, NoneType), "deprecated", self.__class__)
        _assert_type(
...
class Link(OObject):
    def __init__(
        ...
        """
        # TODO docstrings
        _assert_type(operation_ref, (str, NoneType), "operation_ref", self.__class__)
        _assert_type(operation_id, (str, NoneType), "operation_id", self.__class__)
        _assert_type(parameters, (dict, NoneType), "parameters", self.__class__)
        # Note: request_body can be Any
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(server, (Server, NoneType), "server", self.__class__)
...
class Response(OObject):
    ...
    def __init__(self, description=None, headers=None, content=None, links=None):
        ...
        _assert_type(description, (str, NoneType), "description", self.__class__)
        _assert_type(headers, (dict, NoneType), "headers", self.__class__)
        _assert_type(content, (dict, NoneType), "content", self.__class__)
        _assert_type(links, (dict, NoneType), "links", self.__class__)
...
class Components(OObject):
    def __init__(
        ...
        """
        _assert_type(schemas, (dict, NoneType), "schemas", self.__class__)
        _assert_type(responses, (dict, NoneType), "responses", self.__class__)
        _assert_type(parameters, (dict, NoneType), "parameters", self.__class__)
        _assert_type(examples, (dict, NoneType), "examples", self.__class__)
        _assert_type(request_bodies, (dict, NoneType), "request_bodies", self.__class__)
        _assert_type(headers, (dict, NoneType), "headers", self.__class__)
        _assert_type(
            security_schemes, (dict, NoneType), "security_schemes", self.__class__
        )
        _assert_type(links, (dict, NoneType), "links", self.__class__)
        _assert_type(callbacks, (dict, NoneType), "callbacks", self.__class__)
...
class Operation(OObject):
    def __init__(
        ...
        :type external_docs: ExternalDocumentation
        :type operation_id: str
        :type parameters: Set[Parameter]
        :type request_body: Union[RequestBody, Reference]
        :type responses: Responses
        :type callbacks: Dict[str, Union[Callback, Reference]]
        :type deprecated: bool
        :type security: Set[SecurityRequirement]
        :type servers: Set[Server]
        """
        # TODO  - types
        _assert_type(parameters, (set, NoneType), "parameters", self.__class__)

        # TODO - validations
        _assert_required(responses, "responses", self.__class__)

        # assignment and docs
        self.tags = tags  # type: Set[str]
        """
        ...
        self.parameters = parameters  # type: Set[Parameter]
        """
        ...
        """
        # TODO - check that this use of set does not break swagger UI.
        ...
        self.security = security  # type: Set[SecurityRequirement]
        """
        ...
        self.servers = servers  # type: Set[Server]
        """
...
class PathItem(OObject):
    def __init__(
        ...
        :param parameters: A -list- set of parameters that are applicable for all the operations described under this
            path. These parameters can be overridden at the operation level, but cannot be removed there. The -list- set
            MUST NOT include duplicated parameters. A unique parameter is defined by a combination of a name and
            location. The -list- set can use the Reference Object to link to parameters that are defined at the OpenAPI
            Object's components/parameters.
        :param x_tags_holder: sanic-openapi implementation extension to allow tags on the PathItem until they can be
            passed to the Operation/s.
        :param x_deprecated_holder: sanic-openapi implementation extension to allow deprecated on the PathItem until
            they can be passed to the Operation/s.
        :param x_responses_holder: sanic-openapi implementation extension to allow Responses on the PathItem until
            they can be passed to the Operation/s.
        :param x_exclude: sanic-openapi extension to completly exclude the path from the spec.
        ...
        :type servers: Optional[Set[Server]]
        :type parameters: Optional[Set[Union[Parameter,Reference]]]
        :type x_tags_holder: Optional[Set[Tag]]
        ...
        self.servers = servers  # type: Optional[Set[Server]]
        """An alternative server array to service all operations in this path."""

        self.parameters = (
            parameters if parameters is not None else set()
        )  # type: Optional[Set[Parameter]]
        """
        A -list- set of parameters that are applicable for all the operations described under this path. These 
        parameters can be overridden at the operation level, but cannot be removed there. The -list- set MUST NOT 
        include duplicated parameters. A unique parameter is defined by a combination of a name and location. The 
        -list- set can use the Reference Object to link to parameters that are defined at the OpenAPI Object's 
        components/parameters.
        """

        self.x_tags_holder = (
            x_tags_holder if x_tags_holder is not None else set()
        )  # type: Optional[Set[Tag]]
...
class Paths(OObject):
    # TODO - will an update of the ``serialise`` be needed?
    def __init__(self, path_items=None):
        ...
        :param path_items The paths
        :type path_items: Dict[Any, PathItem]
        """
        self.__dict__ = (
            path_items if path_items is not None else OrderedDict()
        )  # type: Dict[Any, PathItem]
        """
        A python dict of relative path to an individual endpoint. The field name MUST begin with a slash. The path is 
    ...
    def __getitem__(self, item):
        """A defaultdict interface."""
        if item not in self.__dict__:
            self.__dict__[item] = PathItem()
...
class OpenAPIv3(OObject):
    ...
    def __init__(
        ...
        :type security: Optional[Set[SecurityRequirement]]
        :type tags: OptionalSet[Tag]]
        :type external_docs: Optional[ExternalDocumentation]
        """

        _assert_type(openapi, (str, NoneType), "openapi", self.__class__)
        _assert_type(info, (Info, NoneType), "info", self.__class__)
        _assert_type(servers, (set, NoneType), "servers", self.__class__)
        _assert_type(paths, (Paths, NoneType), "paths", self.__class__)
        _assert_type(components, (Components, NoneType), "components", self.__class__)
        _assert_type(security, (set, NoneType), "security", self.__class__)
        _assert_type(tags, (set, NoneType), "tags", self.__class__)
        _assert_type(
            external_docs,
            (ExternalDocumentation, NoneType),
            "external_docs",
        ...
        _assert_required(paths, "paths", self.__class__)
        ...
        self.security = security  # type: Optional[Set[SecurityRequirement]]
        """
        ...
        self.tags = tags  # type: Optional[Set[Tag]]
        """
