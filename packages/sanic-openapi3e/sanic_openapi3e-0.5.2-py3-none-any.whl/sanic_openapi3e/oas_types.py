...
class ExternalDocumentation(OObject):
    def __init__(self, description=None, url=None):
        ...
        :type url: str
        """
        _assert_type(description, (str, NoneType), "name", self.__class__)
        _assert_type(url, (str, NoneType), "url", self.__class__)
...
class Paths(OObject):
    ...
    def __init__(self, path_items=None):
        ...
        :type path_items: OrderedDict[str, PathItem]
        """
        self.__dict__ = (
            path_items if path_items is not None else OrderedDict()
        )  # type: OrderedDict[Any, PathItem]
        """
...
class OpenAPIv3(OObject):
    ...
    def __init__(
        ...
        _assert_type(tags, (list, NoneType), "tags", self.__class__)
        _assert_type(
            external_docs,
            (ExternalDocumentation, NoneType),
            "external_docs",
