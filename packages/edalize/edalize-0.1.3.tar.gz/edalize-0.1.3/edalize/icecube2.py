...
#        },
    ...
    def configure_main(self):
        ...
        with open(os.path.join(self.work_root, self.name+'.prj'), 'w') as synplify_file:
            for f in src_files:
                if f.file_type in ['verilogSource']:
                    synplify_file.write("add_file -verilog {}\n".format(f.name))
            ...
            synplify_file.write("impl -add {} -type fpga\n".format(self.name))
