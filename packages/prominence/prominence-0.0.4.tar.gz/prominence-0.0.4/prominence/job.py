class ProminenceJob(object):
    ...
    def __init__(self, artifacts=None, inputs=None, output_files=None, output_dirs=None, nodes=None, cpus=None, memory=None, disk=None, walltime=None, tasks=None, preemptible=None, labels=None, constraints=None):
    ...
    def labels(self):
        """
        Returns the list of labels to be set in the container
        """
        return self._labels
    ...
    def labels(self, labels):
        """
        Sets the list of labels to be set in the container
        """
        self._labels = labels
