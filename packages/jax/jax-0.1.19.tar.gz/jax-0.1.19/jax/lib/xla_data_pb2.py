...
_LAYOUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_sparse_elements', full_name='xla.Layout.max_sparse_elements', index=2,
...
_PROGRAMSHAPEPROTO.fields_by_name['parameters'].message_type = _SHAPE
_PROGRAMSHAPEPROTO.fields_by_name['result'].message_type = _SHAPE
