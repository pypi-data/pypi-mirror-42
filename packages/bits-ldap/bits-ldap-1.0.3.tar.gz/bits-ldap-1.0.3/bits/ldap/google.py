...
class Google(Server):
    ...
    def get_person_dn(self, person):
        ...
        # terminated users who are on hold
        if person.terminated and person.hold:
            base_ou = 'ou=Hold'
        # regular terminated users
        elif person.terminated:
            base_ou = 'ou=Suspended'
        # future hires starting beyond the "start" cutoff
        ...
        # create the base ou for the user based on the groups above
        ...
        # otherwise, get workday ou
            ...
            if self.ldap.primary == 'test.broadinstitute.orgX':
