...
class CommandHandlerTest(TestCase):
    ...
    def testInitCreatesDifferentViewsWithGivenNames(self):
        app = MagicMock()
        ...
        view.assert_has_calls([
            call("__command_handler_invoker_view__command"),
            call("__command_handler_invoker_view_/foo_command"),
            call("__command_handler_invoker_view__bar"),
        ])
