...
DEFAULT_SHIPANE_URL = 'http://localhost:9001'#'http://127.0.0.1:8888'
DEFAULT_SHIPANE_KEY = ''
...
#         cn_en_compare['checksum1'] = 'checksum1'
#         cn_en_compare['checksum2'] = 'checksum2'
#         cn_en_compare['序号'] = 'number'
        """查询现金和持仓
    ...
    #                     hold_headers = [cn_en_compare[item] for item in hold_headers]
                        ...
                        hold_available = hold_available.T
                        hold_available.columns = ['项目'+str(i) for i in range(hold_available.shape[1])]
    ...
    def send_order(self, accounts, code='000001', price=0, amount=100, order_direction=ORDER_DIRECTION.BUY, order_model=ORDER_MODEL.MARKET):
        """[summary]
