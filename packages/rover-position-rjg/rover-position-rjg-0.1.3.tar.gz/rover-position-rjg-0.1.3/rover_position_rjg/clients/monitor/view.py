...
class View:
    def __init__(self, stdscr):
        ...
        self.attitude_window = curses.newwin(4, 80, 6, 0)
        self.beacon_window = curses.newwin(4, 80, 10, 0)
        self.output_window = curses.newwin(4, 80, 14, 0)
    ...
    def display_template(self):
        ...
        self.main_window.addstr(r+3, 0,   'Publish:  (i)mu data, (a)ttitude data, (b)eacon data, p(o)sition data')
