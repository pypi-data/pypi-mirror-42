...
class Messenger:
    ...
    def __init__(self):
        ...
        self._publish_heading_data_switch = MessageSwitch(self._mqtt_client, 'heading/stop', 'heading/start', '{"frequency":10}', False)
    ...
    def start_publishing_data(self,
                              ...
                              heading_callback: Callable[[Vector], None]):
    ...
    def _handle_heading_message(self, mqtt_message: str):
        x, y, z, t = struct.unpack(">ffff", bytes(mqtt_message))
        self._heading_message_callback(Vector([x, y, z]))
