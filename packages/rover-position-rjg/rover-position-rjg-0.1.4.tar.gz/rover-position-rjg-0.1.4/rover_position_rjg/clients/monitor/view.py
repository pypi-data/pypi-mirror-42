...
class View:
    ...
    def display_template(self):
        ...
        self.heading_window.addstr(1, 0,  'Attitude   Roll  Pitch    Yaw')
    ...
    def display_heading_data(self, data: Vector):
        self.heading_window.addstr(2, 9, '{:6.1f} {:6.1f} {:6.1f}'.format(data.x, data.y, data.z))
        self.heading_window.refresh()
