...
class Auth(object):
    ...
    def ccure(self):
        ...
        return CCURE(
            server,
            self.settings['mssql_servers']['ccure']['db_user'],
            self.settings['mssql_servers']['ccure']['db_pass'],
            self.settings['mssql_servers']['ccure']['db'],
            self.settings['ccure']['credentials'],
            self.settings['ccure']['personnel'],
            self.settings['ccure']['newpersonnel'],
            self.settings['ccure']['photos'],
            self.settings['ccure']['workday_photos'],
        )
    ...
    def ccure_dev(self):
        ...
        return CCURE(
            server,
            self.settings['mssql_servers']['ccure_dev']['db_user'],
            self.settings['mssql_servers']['ccure_dev']['db_pass'],
            self.settings['mssql_servers']['ccure_dev']['db'],
            self.settings['ccure_dev']['credentials'],
            self.settings['ccure_dev']['personnel'],
            self.settings['ccure_dev']['newpersonnel'],
            self.settings['ccure_dev']['photos'],
            self.settings['ccure']['workday_photos'],
        )
    ...
    def ccure_prod(self):
        ...
        return CCURE(
            server,
            self.settings['mssql_servers']['ccure_prod']['db_user'],
            self.settings['mssql_servers']['ccure_prod']['db_pass'],
            self.settings['mssql_servers']['ccure_prod']['db'],
            self.settings['ccure_prod']['credentials'],
            self.settings['ccure_prod']['personnel'],
            self.settings['ccure_prod']['newpersonnel'],
            self.settings['ccure_prod']['photos'],
            self.settings['ccure']['workday_photos'],
        )
    ...
    def mx(self):
        ...
        return MX(
            aliases_cfdir=self.settings['mx']['aliases_cfdir'],
            aliases_puppetdir=self.settings['mx']['aliases_puppetdir'],
            transports_cfdir=self.settings['mx']['transports_cfdir'],
