...
## soapy_device		Device name, text
# SoapySDR provides an interface to various radio hardware. The device name specifies
...
#soapy_device  = "No device specified"

## use_soapy	Use SoapySDR, integer
# Enter 1 to turn on SoapySDR.
#use_soapy = 1

## soapy_antenna_rx	Rx antenna name, text
# This is the name of the antenna to use for receive.
soapy_antenna_rx  = ""

## soapy_gain_rx	Rx gain, number
# This is the receiver RF gain.
soapy_gain_rx  = 0.0
