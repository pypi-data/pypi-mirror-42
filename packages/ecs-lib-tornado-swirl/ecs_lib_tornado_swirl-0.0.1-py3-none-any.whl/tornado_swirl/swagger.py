...
def describe(title='Your API', description='No description', prefix='/swagger',**kwargs):
    """Describe API"""
    settings.default_settings.update({"title": title, "description": description, "swagger_prefix": prefix})
    if kwargs:
