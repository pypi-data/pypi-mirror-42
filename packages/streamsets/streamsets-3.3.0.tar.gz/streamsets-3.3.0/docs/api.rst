...
Job ACLs
^^^^^^^^
.. autoclass:: streamsets.sdk.sch_models.JobAcl
    :members:

Job Permissions
^^^^^^^^^^^^^^^
.. autoclass:: streamsets.sdk.sch_models.JobPermission
    :members:
.. autoclass:: streamsets.sdk.sch_models.JobPermissions
    :members:
...
Pipeline ACLs
^^^^^^^^^^^^^
.. autoclass:: streamsets.sdk.sch_models.PipelineAcl
    :members:

Pipeline Permissions
^^^^^^^^^^^^^^^^^^^^
.. autoclass:: streamsets.sdk.sch_models.PipelinePermission
    :members:
.. autoclass:: streamsets.sdk.sch_models.PipelinePermissions
    :members:
