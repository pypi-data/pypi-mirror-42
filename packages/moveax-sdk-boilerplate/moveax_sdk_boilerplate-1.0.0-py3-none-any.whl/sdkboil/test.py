...
class TestSDK(TestCase):
    ...
    def setUp(self):
        self.patch0 = patch('ch_sdk.actions.AuthenticatedAction.get_failure_hooks', return_value={})
        self.patch1 = patch('ch_sdk.actions.AuthenticatedAction.get_presend_hooks', return_value={})
        ...
        self.patch5 = patch('ch_sdk.actions.UnAuthenticatedAction.get_presend_hooks', return_value={})
        self.patch6 = patch('ch_sdk.actions.UnAuthenticatedAction.get_success_hooks', return_value={})
        self.patch7 = patch('ch_sdk.actions.UnAuthenticatedAction.get_failure_hooks', return_value={})
        self.patch0.start()
        self.patch1.start()
        self.patch2.start()
        self.patch3.start()
    ...
    def test_sdk_get_actions(self):
        for action_namespace in self.test_api_get_objects:
            ...
            with patch(self.to_patch,
                ...
                action.run()
                mock_get.assert_called_with(verify_ssl=False)
    ...
    def test_sdk_post_actions(self):
        for action_namespace in self.test_api_post_objects:
            ...
            with patch(self.to_patch,
                ...
                action.run()
                mock_post.assert_called_with(verify_ssl=False)
    ...
    def test_sdk_delete_actions(self):
        for action_namespace in self.test_api_delete_objects:
            ...
            with patch(self.to_patch,
                ...
                action.run()
                mock_delete.assert_called_with(verify_ssl=False)
    ...
    def test_sdk_update_actions(self):
        for action_namespace in self.test_api_update_objects:
            ...
            with patch(self.to_patch,
                ...
                action.run()
                mock_update.assert_called_with(verify_ssl=False)
    ...
    def test_sdk_nonRESTful_actions(self):
        for action_namespace in self.test_api_nonRESTful_objects:
            ...
            with patch(self.to_patch,
                ...
                action.run()
                mock_action.assert_called_with(verify_ssl=False)
