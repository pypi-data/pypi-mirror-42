import os, sys
def find(extension="*", location=(os.path.dirname(sys.modules['__main__'].__file__)), keepExtension=False):
    ...
    Args:
        ...
        location: The path to the folder to look inside.
            ...
            Defaults to the location of __main__ in your chosen project
