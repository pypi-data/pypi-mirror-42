...
def optional_assignment_tag(func=None, takes_context=None, name=None):
    ...
    def dec(func):
        params, varargs, varkw, defaults, kwonly, kwonlydefaults, annotations = getfullargspec(func)

        class AssignmentNode(TagHelperNode):
            def __init__(self, args, kwargs, target_var=None):
        ...
        def compile_func(parser, token):
            ...
            args, kwargs = parse_bits(parser, bits, params,
                                      ...
                                      kwonly, kwonlydefaults,
                                      takes_context, function_name)
            return AssignmentNode(args, kwargs, target_var)
