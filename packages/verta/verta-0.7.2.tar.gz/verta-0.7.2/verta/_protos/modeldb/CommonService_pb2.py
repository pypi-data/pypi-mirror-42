...
# source: protos/modeldb/CommonService.proto
...
KeyValue = _reflection.GeneratedProtocolMessageType('KeyValue', (_message.Message,), dict(
  ...
  __module__ = 'protos.modeldb.CommonService_pb2'
