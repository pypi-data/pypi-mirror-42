...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget();this.classList.add("no-padding")},attached:function(){this._ensureTarget();requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",0<this.scrollTarget.scrollTop);this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight);this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement;if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}})},781:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var lit_element=__webpack_require__(10),paper_spinner=__webpack_require__(163),paper_dialog=__webpack_require__(174),paper_button=__webpack_require__(95),paper_dialog_scrollable=__webpack_require__(184),ha_style=__webpack_require__(97),paper_input=__webpack_require__(78),fire_event=__webpack_require__(58),config_elements_style=__webpack_require__(177);class hui_lovelace_editor_HuiLovelaceEditor extends lit_element.a{constructor(...args){super(...args);this.hass=void 0;this.config=void 0}static get properties(){return{hass:{},config:{}}}get _title(){if(!this.config){return""}return this.config.title||""}render(){return lit_element.e`
    ...
    `}_closeDialog(){this._config=void 0;this._dialog.close()}async _save(){if(!this._config){return}if(!this._isConfigChanged()){this._closeDialog();return}this._saving=!0;const lovelace=this._lovelace,config=Object.assign({},lovelace.config,this._config);try{await lovelace.saveConfig(config);this._closeDialog()}catch(err){alert(`Saving failed: ${err.message}`)}finally{this._saving=!1}}_ConfigChanged(ev){if(ev.detail&&ev.detail.config){this._config=ev.detail.config}}_isConfigChanged(){const _config2=this._lovelace.config,lovelaceConfig=_objectWithoutPropertiesLoose(_config2,["views"]);return JSON.stringify(this._config)!==JSON.stringify(lovelaceConfig)}static get styles(){return[ha_style.b,lit_element.c`
...
//# sourceMappingURL=41ae8f355815519dc2d4.chunk.js.map