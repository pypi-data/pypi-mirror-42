(window.webpackJsonp=window.webpackJsonp||[]).push([[98],{106:function(module,__webpack_exports__,__webpack_require__){"use strict";var polymer_legacy=__webpack_require__(3);/**
@license
...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget();this.classList.add("no-padding")},attached:function(){this._ensureTarget();requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",0<this.scrollTarget.scrollTop);this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight);this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement;if(this.dialogElement&&this.dialogElement.behaviors&&0<=this.dialogElement.behaviors.indexOf(_polymer_paper_dialog_behavior_paper_dialog_behavior_js__WEBPACK_IMPORTED_MODULE_3__.b)){this.dialogElement.sizingTarget=this.scrollTarget;this.scrollTarget.classList.remove("fit")}else if(this.dialogElement){this.scrollTarget.classList.add("fit")}}})},741:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var lit_element__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(10),_polymer_paper_dialog_paper_dialog__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(174),_polymer_paper_dialog_scrollable_paper_dialog_scrollable__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(184),_resources_ha_style__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(97);class DialogSystemLogDetail extends lit_element__WEBPACK_IMPORTED_MODULE_0__.a{constructor(...args){super(...args);this._params=void 0}static get properties(){return{_params:{}}}async showDialog(params){this._params=params;await this.updateComplete}render(){if(!this._params){return lit_element__WEBPACK_IMPORTED_MODULE_0__.e``}const item=this._params.item;return lit_element__WEBPACK_IMPORTED_MODULE_0__.e`
      ...
      >
        ...
        <paper-dialog-scrollable>
          ...
          ${item.message?lit_element__WEBPACK_IMPORTED_MODULE_0__.e`
                <pre>${item.message}</pre>
              `:lit_element__WEBPACK_IMPORTED_MODULE_0__.e``}
          ${item.exception?lit_element__WEBPACK_IMPORTED_MODULE_0__.e`
                <pre>${item.exception}</pre>
              `:lit_element__WEBPACK_IMPORTED_MODULE_0__.e``}
        </paper-dialog-scrollable>
      </paper-dialog>
    `}_openedChanged(ev){if(!ev.detail.value){this._params=void 0}}static get styles(){return[_resources_ha_style__WEBPACK_IMPORTED_MODULE_3__.b,lit_element__WEBPACK_IMPORTED_MODULE_0__.c``]}}customElements.define("dialog-system-log-detail",DialogSystemLogDetail)}}]);
//# sourceMappingURL=40953967cbd61d2ee523.chunk.js.map