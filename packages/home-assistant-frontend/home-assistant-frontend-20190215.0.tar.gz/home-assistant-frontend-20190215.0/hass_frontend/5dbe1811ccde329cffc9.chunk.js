...
*/class HaAppLayout extends customElements.get("app-header-layout"){static get template(){return _polymer_polymer_lib_utils_html_tag__WEBPACK_IMPORTED_MODULE_1__.a`
    ...
    `}_onHelpTap(){this._showHelp=!this._showHelp}static get styles(){return[ha_style.a,lit_element.c`
        .content {
          margin-top: 24px;
        }
      ...
      ${this.showHelp?lit_element.e`
          ...
          `:""}
    `}async _fetchClustersForZhaNode(){if(this.hass){this._clusters=await fetchClustersForZhaNode(this.hass,this.selectedDevice.ieee);this._clusters.sort((a,b)=>{return a.name.localeCompare(b.name)})}}_selectedClusterChanged(event){this._selectedClusterIndex=event.target.selected;Object(fire_event.a)(this,"zha-cluster-selected",{cluster:this._clusters[this._selectedClusterIndex]})}static get styles(){return[ha_style.a,lit_element.c`
        .flex {
          -ms-flex: 1 1 0.000000001px;
          -webkit-flex: 1;
          flex: 1;
    ...
    `}},{kind:"method",key:"_openMoreInfo",value:function _openMoreInfo(ev){Object(fire_event.a)(this,"hass-more-info",{entityId:ev.currentTarget.entity.entity_id})}},{kind:"get",static:!0,key:"styles",value:function styles(){return[ha_style.a,lit_element.c`
