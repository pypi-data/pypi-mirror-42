(window.webpackJsonp=window.webpackJsonp||[]).push([[61],{781:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var app_header_layout=__webpack_require__(136),app_header=__webpack_require__(132),app_toolbar=__webpack_require__(110),paper_listbox=__webpack_require__(129),paper_card=__webpack_require__(160),paper_checkbox=__webpack_require__(139),paper_item=__webpack_require__(128),html_tag=__webpack_require__(2),polymer_element=__webpack_require__(18),moment=__webpack_require__(390),moment_default=__webpack_require__.n(moment),dates=__webpack_require__(207),dates_default=__webpack_require__.n(dates),ha_menu_button=__webpack_require__(137),ha_style=__webpack_require__(68),preact_compat_es=__webpack_require__(172),lib=__webpack_require__(462),lib_default=__webpack_require__.n(lib),events_mixin=__webpack_require__(59);lib_default.a.setLocalizer(lib_default.a.momentLocalizer(moment_default.a));const DEFAULT_VIEW="month";class ha_big_calendar_HaBigCalendar extends Object(events_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
      <link
        rel="stylesheet"
      ...
      <div id="root"></div>
    `}static get properties(){return{events:{type:Array,observer:"_update"}}}_update(events){const allViews=lib_default.a.Views.values,BCElement=preact_compat_es["default"].createElement(lib_default.a,{events:events,views:allViews,popup:!0,onNavigate:(date,viewName)=>this.fire("navigate",{date,viewName}),onView:viewName=>this.fire("view-changed",{viewName}),eventPropGetter:this._setEventStyle,defaultView:DEFAULT_VIEW,defaultDate:new Date});Object(preact_compat_es.render)(BCElement,this.$.root)}_setEventStyle(event){const newStyle={};if(event.color){newStyle.backgroundColor=event.color}return{style:newStyle}}}customElements.define("ha-big-calendar",ha_big_calendar_HaBigCalendar);var localize_mixin=__webpack_require__(106);const ha_panel_calendar_DEFAULT_VIEW="month";class ha_panel_calendar_HaPanelCalendar extends Object(localize_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
...
//# sourceMappingURL=4b777a25c6c3d57b78da.chunk.js.map