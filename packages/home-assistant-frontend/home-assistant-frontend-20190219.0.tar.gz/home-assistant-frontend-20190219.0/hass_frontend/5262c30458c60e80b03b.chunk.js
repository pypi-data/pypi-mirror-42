...
`;template.setAttribute("strip-whitespace","");Object(polymer_fn.a)({_template:template,is:"paper-fab",behaviors:[PaperButtonBehavior],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(icon,src){return 0<icon.length||0<src.length}})},780:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var paper_fab=__webpack_require__(225),lit_element=__webpack_require__(6),mwc_button=__webpack_require__(74),paper_menu_button=__webpack_require__(135),paper_icon_button=__webpack_require__(96),paper_listbox=__webpack_require__(131),show_edit_card_dialog=__webpack_require__(391),config_util=__webpack_require__(269);async function confDeleteCard(lovelace,path){if(!confirm("Are you sure you want to delete this card?")){return}try{await lovelace.saveConfig(Object(config_util.c)(lovelace.config,path))}catch(err){alert(`Deleting failed: ${err.message}`)}}var fire_event=__webpack_require__(59);let registeredDialog=!1;const registerEditCardDialog=element=>Object(fire_event.a)(element,"register-dialog",{dialogShowEvent:"show-move-card-view",dialogTag:"hui-dialog-move-card-view",dialogImport:()=>__webpack_require__.e(33).then(__webpack_require__.bind(null,774))}),showMoveCardViewDialog=(element,moveCardViewDialogParams)=>{if(!registeredDialog){registeredDialog=!0;registerEditCardDialog(element)}Object(fire_event.a)(element,"show-move-card-view",moveCardViewDialogParams)};class hui_card_options_HuiCardOptions extends lit_element.a{constructor(...args){super(...args);this.cardConfig=void 0;this.hass=void 0;this.lovelace=void 0;this.path=void 0}static get properties(){return{hass:{},lovelace:{},path:{}}}render(){return lit_element.e`
      <style>
        div.options {
...
//# sourceMappingURL=5262c30458c60e80b03b.chunk.js.map