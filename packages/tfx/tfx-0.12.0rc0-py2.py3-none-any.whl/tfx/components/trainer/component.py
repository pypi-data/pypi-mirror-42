...
class Trainer(base_component.BaseComponent):
  ...
  Args:
    ...
    train_steps: An int specifying steps to carry for training.
    eval_steps: An int specifying steps to carry for eval.
    warm_starting: A bool indicating whether or not the Trainer should
      warm-staring the training.
    name: Optional unique name. Necessary iff multiple Pusher components are
