...
def main():
    ...
    parser.add_argument("-w", "--width", dest="target", help="resized image width", default=320)
    parser.add_argument("-h", "--height", dest="target", help="resized image height", default=180)
