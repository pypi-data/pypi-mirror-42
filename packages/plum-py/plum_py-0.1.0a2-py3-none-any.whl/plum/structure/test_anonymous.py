...
from .test_predefined import TestCompare as _TestCompare
from .test_predefined import TestIndexAccess as _TestIndexAccess
from .test_predefined import TestNameAccess as _TestNameAccess
