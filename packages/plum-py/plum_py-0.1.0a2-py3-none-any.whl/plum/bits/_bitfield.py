...
class BitField:
    ...
    def __init__(self, pos, size, default, signed, ignore):
        ...
        self.pos = pos
        self.size = size
        self._type = None  # assigned during Bits class construction (by BitsType.__new__)
        self._make_type = None  # assigned during Bits class construction (by BitsType.__new__)
