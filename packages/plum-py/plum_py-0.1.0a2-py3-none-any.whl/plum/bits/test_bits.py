...
class TestBasic(object):
    ...
    @staticmethod
    def test_pack_dict():
        assert pack(MyBits, dict(f1=0, f2=2, f3=1)) == b'\x00\x12'

    def test_unpack(self):
        i = unpack(MyBits, b'\x00\x12')
        assert getdump(i) == TestInit.expected_dump
...
class ForCompare(Bits, nbytes=1, fill=0x0, ignore=0xc0):
