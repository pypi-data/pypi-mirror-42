...
class Middle(Bits, fill=0xc, ignore=0x4):
...
class Outer(Bits, nbytes=2, fill=0x70, ignore=0x10):
...
class TestNested:
    ...
    def test_get(self):
        """Verify read access."""
        instance = Outer(o0=0, o1=1, o2=Middle(m0=0, m1=1, m2=Inner(i0=0, i1=1, i2=2)))
    ...
    def test_set(self):
        """Verify write access."""
        # initialize all fields to zero (except initialize to 1 all fields that should be 0)
        instance = Outer(o0=1, o1=0, o2=Middle(m0=1, m1=0, m2=Inner(i0=1, i1=0, i2=0)))
    ...
    def test_init_with_dict(self):
        ...
        dict_value = dict(o0=0, o1=1, o2=dict(m0=0, m1=1, m2=dict(i0=0, i1=1, i2=2)))
    ...
    def test_ignore_fields(self):
        ...
        """
        item1 = Outer(o0=0, o1=1, o2=Middle(m0=0, m1=1, m2=Inner(i0=0, i1=1, i2=2)))
        item2 = Outer(o0=3, o1=1, o2=Middle(m0=1, m1=1, m2=Inner(i0=1, i1=1, i2=2)))
        assert item1 == item2
    ...
    def test_fill(self):
        ...
        instance = Outer(o0=0, o1=0, o2=Middle(m0=0, m1=0, m2=Inner(i0=0, i1=0, i2=0)))
