...
class Mysat(KaitaiStruct):
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ax25_info = self._root.MysatPayload(io, self, self._root)
    ...
    class MysatPayload(KaitaiStruct):
        ...
        def _read(self):
            _on = self._io.size()
            if _on == 42:
                self.beacon_type = self._root.MysatTlm(self._io, self, self._root)
            else:
                self.beacon_type = self._root.MysatMessage(self._io, self, self._root)
    ...
    class MysatTlm(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.sp1_temperature = self._io.read_u1()
            self.sp2_temperature = self._io.read_u1()
            self.sp3_temperature = self._io.read_u1()
            self.sp4_temperature = self._io.read_u1()
            self.sp5_temperature = self._io.read_u1()
            self.sp6_temperature = self._io.read_u1()
            self.obc_3v3_voltage = self._io.read_u1()
            self.obc_5v_voltage = self._io.read_u1()
