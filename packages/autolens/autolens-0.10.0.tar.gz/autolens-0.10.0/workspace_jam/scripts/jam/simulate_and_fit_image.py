...
# galaxy light.
image_plane_grid_stack = grids.GridStack.grid_stack_for_simulation(shape=(200, 200), pixel_scale=pixel_scale,
...
# lens_galaxy = g.Galaxy(mass=mp.EllipticalSersic(centre=(0.0, 0.0), intensity=1.0, mass_to_light_ratio=0.4,
...
phase = Phase(lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalIsothermal)),
                                 ...
                                 phase_name='simulate_and_fit_image/sie_to_gNFW_1')
