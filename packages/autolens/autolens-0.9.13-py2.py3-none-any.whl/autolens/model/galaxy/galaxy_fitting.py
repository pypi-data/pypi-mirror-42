...
class GalaxyFit(fitter.DataFitterStack):
    ...
    def __init__(self, galaxy_datas, model_galaxy):
        ...
        model_data_ = galaxy_datas[0].profile_quantity_from_galaxy_and_sub_grid(galaxies=model_galaxy,
    ...
    def fast_likelihood(cls, galaxy_datas, galaxy):
        ...
        model_datas_ = galaxy_datas[0].profile_quantity_from_galaxy_and_sub_grid(galaxies=galaxy,
                                                                                 sub_grid=galaxy_datas[0].grids.sub)
...
class GalaxyFitDeflections(fitter.DataFitterStack):
    ...
    def fast_likelihood(cls, galaxy_datas, model_galaxy):
        """Perform the fit of this class as described above, but storing no results as class instances, thereby \
        minimizing memory use and maximizing run-speed."""
        model_datas_ = galaxy_datas[0].profile_quantity_from_galaxy_and_sub_grid(galaxies=model_galaxy,
                                                                                 sub_grid=galaxy_datas[0].grids.sub)
