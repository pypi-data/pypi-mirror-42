...
def plot_fitting_subplot_lens_plane_only(fit, should_plot_mask=True, positions=None, should_plot_image_plane_pix=True,
    ...
    Parameters
    -----------
    fit : autolens.lens.fittingting.Fitter
        Class containing fitting between the model datas_ and observed lens datas_ (including residual_map, chi_squared_map etc.)
    output_path : str
