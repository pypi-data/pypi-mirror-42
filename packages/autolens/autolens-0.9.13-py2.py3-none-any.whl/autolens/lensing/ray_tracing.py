...
class TracerImagePlane(AbstractTracer):
    ...
    def __init__(self, lens_galaxies, image_plane_grids, border=None, cosmology=None):
        """Ray-tracer_normal for a lens system with just one plane, the datas-plane. Because there is 1 plane, there are \
        ...
        image_plane_grids : [grid_stacks.GridStack]
...
class TracerImageSourcePlanes(AbstractTracer):
    ...
    def __init__(self, lens_galaxies, source_galaxies, image_plane_grids, border=None, cosmology=None):
        """Ray-tracer_normal for a lens system with two planes, an datas-plane and source-plane.
        ...
        source_plane_grids = self.image_plane.trace_grid_stack_to_next_plane()
    ...
    def masses_of_image_plane_galaxies_within_circles(self, radius):
        ...
        Use of other radii may be subject to systematic offsets, because lens does not directly measure the mass of
...
class AbstractTracerMulti(AbstractTracer):
    ...
    def __init__(self, galaxies, cosmology):
        """The ray-tracing calculations, defined by a lens system with just one datas-plane and source-plane.
...
class TracerMulti(AbstractTracerMulti):
    ...
    def __init__(self, galaxies, image_plane_grids, border=None, cosmology=cosmo.Planck15):
        """Ray-tracer_normal for a lens system with any number of planes.
...
class TracerImageSourcePlanesPositions(AbstractTracer):
    ...
    def __init__(self, lens_galaxies, positions, cosmology=None):
        """Positional ray-tracer_normal for a lens system with two planes, an datas-plane and source-plane (source-plane \
...
class TracerMultiPositions(AbstractTracerMulti):
    ...
    def __init__(self, galaxies, positions, cosmology):
        """Positional ray-tracer_normal for a lens system with any number of planes.
