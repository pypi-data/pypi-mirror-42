...
def test_lensing_hyper_image(image, mask, hyper):
    ...
    return li.LensData(ccd_data=image, mask=mask, hyper_model_image=hyper.hyper_model_image,
...
def test_fit_hyper_lens_only(lensing_hyper_image, hyper):
    ...
    return lens_fit.fit_lens_data_with_tracer(lens_image=lensing_hyper_image, tracer=tracer)
...
def test__fit_sub_plot_hyper_lens_only__output_dependent_on_config(fit_hyper_lens_only, general_config,
    ...
    lens_fit_plotters.plot_fit_subplot(fit=fit_hyper_lens_only, should_plot_mask=True,
...
def test__fit_individuals__lens_only__depedent_on_config(fit_lens_only, general_config, lensing_fitting_plotter_path):
    ...
    lens_fit_plotters.plot_fit_individuals(fit=fit_lens_only, output_path=lensing_fitting_plotter_path,
                                           output_format='png')
...
def test__fit_individuals__hyper_lens_only__depedent_on_config(fit_hyper_lens_only, general_config,
    ...
    lens_fit_plotters.plot_fit_individuals(fit=fit_hyper_lens_only, output_path=lensing_fitting_plotter_path,
                                           output_format='png')
...
def test__fit_individuals__source_and_lens__depedent_on_config(fit_source_and_lens, general_config,
    ...
    lens_fit_plotters.plot_fit_individuals(fit=fit_source_and_lens, output_path=lensing_fitting_plotter_path,
                                           output_format='png')
