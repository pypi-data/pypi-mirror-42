...
from autolens.model.hyper import image
...
class TestHyperImage(object):
    class TestSkyScle(object):
        ...
        def test__scale_sky_in_image__increases_all_image_values(self):
            ...
            hyp = image.HyperImage(background_sky_scale=10.0)

            scaled_image = hyp.sky_scaled_hyper_image_from_image(image=image)
    ...
    class TestScaledNoise(object):
        ...
        def test__scaled_background_noise__adds_to_input_noise(self):
            ...
            hyp = image.HyperImage(background_noise_scale=2.0)

            scaled_noise = hyp.hyper_noise_from_background_noise(noise=noise, background_noise=background_noise)
        ...
        def test__variable_background_noise__adds_to_input_noise_different_for_each_value(self):
            ...
            hyp = image.HyperImage(background_noise_scale=3.0)
