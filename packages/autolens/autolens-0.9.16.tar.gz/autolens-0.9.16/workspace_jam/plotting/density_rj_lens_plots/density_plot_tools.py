...
class SLACS(object):
    ...
    def density_vs_radii_ltm2(self, values, radius_kpc, center_skip, ltm_skip, gradient=None, number_bins=60):
        ...
        for r in range(number_bins):
            ...
            envelope_density = self.critical_density_arcsec * (self.lens_galaxy.envelope.mass_within_circle(radii[r+1]) -
                             self.lens_galaxy.envelope.mass_within_circle(radii[r])) / annuli_area
    ...
    def masses_of_all_samples_sie(self, radius_kpc, values):
        ...
        sie_mass =  self.critical_density_arcsec * self.lens_galaxy.sie.mass_within_circle(radius=radius_arc)
    ...
    def masses_of_all_samples_ltm2(self, radius_kpc, values, center_skip, ltm_skip):
        ...
        envelope_mass = self.critical_density_arcsec * self.lens_galaxy.envelope.mass_within_circle(radius=radius_arc)
