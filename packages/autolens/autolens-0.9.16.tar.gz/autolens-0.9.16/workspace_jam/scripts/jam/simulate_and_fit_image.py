...
lens_galaxy = g.Galaxy(mass=mp.EllipticalSersic(centre=(0.0, 0.0), intensity=1.0, mass_to_light_ratio=1.0,
                                                effective_radius=2.0, sersic_index=1.0, axis_ratio=0.2))


# light=lp.EllipticalSersic(centre=(0.0, 0.0), intensity=1.0,
#                       sersic_index=2.0, effective_radius=1.0, axis_ratio=0.2),

# lens_galaxy = g.Galaxy(mass=mp.EllipticalSersicRadialGradient(centre=(0.0, 0.0), intensity=1.0, mass_to_light_ratio=1.0,
#                        sersic_index=4.0, effective_radius=1.0, axis_ratio=0.2, mass_to_light_gradient=0.3))
...
phase = Phase(lens_galaxies=dict(lens=gm.GalaxyModel(mass=mp.EllipticalIsothermal)),
                                 ...
                                 phase_name='simulate_and_fit_image/sie_to_sersicell_axis02')
