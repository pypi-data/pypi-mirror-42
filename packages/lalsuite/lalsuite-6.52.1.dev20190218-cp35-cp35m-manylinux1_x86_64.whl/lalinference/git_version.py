...
id = "fc06f1b69da9c12404abc5e84859f72d45895a1f"
date = "2019-02-18 05:10:43 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "fc06f1b69da9c12404abc5e84859f72d45895a1f":
        return
    msg = "Program id (fc06f1b69da9c12404abc5e84859f72d45895a1f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
