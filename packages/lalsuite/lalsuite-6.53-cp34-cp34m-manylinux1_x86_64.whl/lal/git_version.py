...
id = "8338ed2a08f41d362e3c601e2775b70a282c520d"
date = "2019-02-27 22:17:35 +0000"
branch = "None"
tag = "lalsuite-v6.53"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "8338ed2a08f41d362e3c601e2775b70a282c520d":
        return
    msg = "Program id (8338ed2a08f41d362e3c601e2775b70a282c520d) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
