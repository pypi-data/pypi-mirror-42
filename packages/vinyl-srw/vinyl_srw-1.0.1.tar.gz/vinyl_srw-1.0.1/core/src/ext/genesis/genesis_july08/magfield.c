...
/* nsecl is even because fodo cell is symmetric */
	wigcom_1.nstepz /= 2;
/* the length is calculated above but must corre */
    }
...
/*     write file with field description. */
    ...
    if (inputcom_1.magout != 0 && mpicom_1.mpi_id__ == 0) {
...
integer *imz, *isup;
{
    ...
    /* Local variables */
    static char line[255], cmagtype[30*12];
    ...
    static char cin[30];
    static doublereal values[4], val;
    static integer nr2, idx;
    extern /* Subroutine */ int getmagfileinfo_();
    static integer loopcnt;
...
/*     function prototypes */
    ...
    /* Function Body */
    s_copy(cmagtype, " undulator field", (ftnlen)30, (ftnlen)16);
    s_copy(cmagtype + 30, " drift section", (ftnlen)30, (ftnlen)14);
    s_copy(cmagtype + 90, " quadrupole field", (ftnlen)30, (ftnlen)17);
    s_copy(cmagtype + 120, " quadrupole offset in x", (ftnlen)30, (ftnlen)23);
    s_copy(cmagtype + 150, " quadrupole offset in y", (ftnlen)30, (ftnlen)23);
    s_copy(cmagtype + 180, " orbit correction in x", (ftnlen)30, (ftnlen)22);
    s_copy(cmagtype + 210, " orbit correction in y", (ftnlen)30, (ftnlen)22);
    s_copy(cmagtype + 240, " solenoid field", (ftnlen)30, (ftnlen)15);
    s_copy(cmagtype + 270, " undulator offset in x", (ftnlen)30, (ftnlen)22);
    s_copy(cmagtype + 300, " undulator offset in y", (ftnlen)30, (ftnlen)22);
