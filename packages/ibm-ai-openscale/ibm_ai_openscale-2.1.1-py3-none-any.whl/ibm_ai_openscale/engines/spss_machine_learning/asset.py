...
class SPSSMachineLearningAsset(KnownServiceAsset):
    ...
    :param probability_columns: names of columns/fields containing probabilities (optional)
    :type probability_columns: list
    ...
    def __init__(self, source_uid, binding_uid=None, problem_type=None, input_data_type=None,
                 ...
                 class_probability_columns=None, probability_columns=None, feature_columns=None, categorical_columns=None):
        ...
        validate_type(probability_columns, 'probability_columns', list, mandatory=False)
        ...
        KnownServiceAsset.__init__(self, source_uid=source_uid, binding_uid=binding_uid, problem_type=problem_type,
                                   ...
                                   class_probability_columns=class_probability_columns, probability_columns=probability_columns,
