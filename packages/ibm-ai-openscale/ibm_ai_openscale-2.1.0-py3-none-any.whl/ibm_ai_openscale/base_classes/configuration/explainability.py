...
class Explainability(TableFromRestApiViewer):
    ...
    def enable(self, training_data_statistics=None, training_data=None, **kwargs):
        ...
        if self._subscription._service_type == AzureConsts.SERVICE_TYPE:  # TODO
            ...
            problem_type = subscription_details['entity']['asset_properties']['problem_type']
        ...
        validate_asset_properties(asset_properties, ['input_data_type', ['class_probability_fields', 'prediction_probability_field']])
        ...
        if training_data_statistics is not None:
            ...
            training_data_statistics_4_explainability = TrainingStats(training_data, training_data_information, fairness=False)._TrainingStats__get_explanability_configuration()
