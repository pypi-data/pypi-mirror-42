...
class ExecutionError(Exception):
    ...
    def __init__(self, error_response):
        error_code = error_response['errorData']['errorCode']
        error_message = error_response['errorData']['errorMessage'] if 'errorMessage' in error_response['errorData'] else ""
        message = error_messages[error_code]
        if ((error_code == 'ExpressionError' or
             error_code == 'StorageError') and
