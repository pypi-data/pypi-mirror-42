...
class GeoPackageMapBoxVectorTiles(GeoPackageVectorTiles):
    ...
    def insert_vector_layers_and_fields_from_tile_data(cursor,
        ...
        GeoPackageVectorLayers.insert_vector_layers_entries_bulk(cursor=cursor,
                                                                 vector_layers_entries=vector_layers_entries)

        for layer_name, vector_fields_entries in layer_field_dictionary.items():
            GeoPackageVectorFields.insert_or_update_vector_field_entries_in_bulk(cursor=cursor,
