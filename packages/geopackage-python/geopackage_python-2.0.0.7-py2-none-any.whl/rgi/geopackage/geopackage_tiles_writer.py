...
class GeoPackageTilesWriter(object):
    ...
    def add_tiles(self,
        ...
        if self.writing_mode == WritingMode.VALIDATION_MODE:
            ...
            contents_tile_type = self.__get_tile_type_by_contents_entry(self.__database_connection(),
    ...
    def __add_tile_matrix_entry_for_zoom_level(self,
        ...
        if self.writing_mode == WritingMode.VALIDATION_MODE:
            ...
            matrix_entry = gpkg_tiles_creator.get_tile_matrix_for_zoom_level(
    ...
    def __get_tile_type_by_contents_entry(cls, database_connection, tile_table_name):
        ...
        # check if vector-tiles- Mapbox
            ...
            geojson_extension = GeoPackageGeoJSONVectorTiles(vector_tiles_table_name=tile_table_name)
            mapbox_extension = GeoPackageMapBoxVectorTiles(vector_tiles_table_name=tile_table_name)
