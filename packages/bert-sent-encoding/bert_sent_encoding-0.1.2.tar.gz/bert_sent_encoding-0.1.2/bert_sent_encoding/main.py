...
class bert_sent_encoding:
	def __init__(self, model_path, seq_length=64, batch_size=8, word_vector=False, layer=-1):
	...
	def get_vector(self, texts):
		...
		for input_ids, input_mask, example_indices in eval_dataloader:
			...
			last_encoder_layer = all_encoder_layers[self.layer]
	...
	def write_txt2vector(self, path_txt, path_vector):
