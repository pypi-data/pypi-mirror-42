...
from rheos_common.util.common import *
...
class Locus(object):
    ...
    def update_gls_to_min_if_zero(self):
        self.gl_hom = self.min_gl_if_zero(self.gl_hom)
        self.gl_het = self.min_gl_if_zero(self.gl_het)
        self.gl_ref = self.min_gl_if_zero(self.gl_ref)
