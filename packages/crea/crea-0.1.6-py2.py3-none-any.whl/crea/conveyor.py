...
from creagraphenebase.ecdsasig import sign_message
try:
...
class Conveyor(object):
    """ Class to access Creary Conveyor instances:
        https://github.com/creait/conveyor
        ...
        * Draft handling: saving, listing and removing post drafts
        ...
        described here: https://github.com/creait/rpc-auth

    """

    def __init__(self, url="https://conveyor.creary.net",
                 crea_instance=None):
        """ Initialize a Conveyor instance
            :param str url: (optional) URL to the Conveyor API, defaults to
                https://conveyor.creary.net
        ...
        self.K = hashlib.sha256(py23_bytes('crea_jsonrpc_auth',
    ...
    def _request(self, account, method, params, key):
        """Assemble the request, hash it, sign it and send it to the Conveyor
            ...
            :param str key: Crea posting key for signing
    ...
    def _conveyor_method(self, account, signing_account, method, params):
        ...
        if signing_account is None:
            ...
            signer = Account(signing_account, crea_instance=self.crea)
    ...
    def get_user_data(self, account, signing_account=None):
        """ Get the account's email address and phone number. The request has to be
            ...
            .. code-block:: python
                ...
                s = Crea(keys=["5JPOSTINGKEY"])
                c = Conveyor(crea_instance=s)
