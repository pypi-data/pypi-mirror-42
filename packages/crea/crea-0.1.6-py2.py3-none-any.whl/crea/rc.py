...
from crea.constants import state_object_size_info, resource_execution_time, EXEC_FOLLOW_CUSTOM_OP_SCALE
import hashlib
...
class RC(object):
    ...
    def comment(self, tx_size=1000, permlink_length=10, parent_permlink_length=10):
        ...
        return self.crea.get_rc_cost(resource_count)
