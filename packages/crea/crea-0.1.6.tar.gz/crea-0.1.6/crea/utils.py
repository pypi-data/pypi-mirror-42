...
def resolve_authorperm(identifier):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> author, permlink = resolve_authorperm("https://creary.net/witness-category/@gtg/24lfrm-gtg-witness-log")
...
def construct_authorperm(*args):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> from crea.utils import construct_authorperm
...
def construct_authorpermvoter(*args):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            >>> from crea.utils import construct_authorpermvoter
