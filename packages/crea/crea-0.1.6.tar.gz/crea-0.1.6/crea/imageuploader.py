...
from creagraphenebase.py23 import integer_types, string_types, text_type, py23_bytes
from creagraphenebase.account import PrivateKey
from creagraphenebase.ecdsasig import sign_message, verify_message


class ImageUploader(object):
    def __init__(
        self,
        base_url="https://creaitimages.com",
    ...
    def upload(self, image, account, image_name=None):
        ...
        for authority in account["posting"]["key_auths"]:
            posting_wif = self.crea.wallet.getPrivateKeyForPublicKey(authority[0])
