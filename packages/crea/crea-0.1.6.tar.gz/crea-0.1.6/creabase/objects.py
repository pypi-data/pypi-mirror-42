...
from creagraphenebase.objects import GrapheneObject, isArgsThisClass
from .objecttypes import object_type
from creagraphenebase.account import PublicKey
from creagraphenebase.objects import Operation as GPHOperation
...
class Operation(GPHOperation):
    ...
    def _getklass(self, name):
        module = __import__("creabase.operations", fromlist=["operations"])
