...
try:
    ...
    HighAscii = str(struct.pack("128B", *list(range(0x80, 0xff + 1))).decode('ascii'))
    LowAscii = str(struct.pack("32B", *list(range(0x00, 0x1f + 1))).decode('ascii'))
    AllChars = str(struct.pack("256B", *list(range(0x00, 0xff + 1))).decode('ascii'))
    Punctuation = str(struct.pack("31B", *(list(range(0x21, 0x2f + 1)) + list(range(0x3a, 0x3F + 1)) + list(range(0x5b, 0x60 + 1)) + list(range(0x7b, 0x7e + 1)))).decode('ascii'))
...
def rand_base(length, bad, *foo):
    ...
    return str(struct.pack("{}B".format(length), *outp).decode('ascii'))
