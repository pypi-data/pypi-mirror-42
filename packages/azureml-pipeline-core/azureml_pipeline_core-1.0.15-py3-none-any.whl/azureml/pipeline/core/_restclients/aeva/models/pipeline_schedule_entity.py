...
class PipelineScheduleEntity(Model):
    ...
    def __init__(self, name=None, pipeline_id=None, provisioning_status=None, pipeline_submission_info=None, recurrence=None, id=None, etag=None, created_date=None, last_modified_date=None, entity_status=None):
