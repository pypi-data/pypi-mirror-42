...
class QQuickItem(PySide2.QtCore.QObject, PySide2.QtQml.QQmlParserStatus):
    ...
    def inputMethodQuery(self, query:PySide2.QtCore.Qt.InputMethodQuery) -> support.signature.typing27.Any: ...
...
class QSGGeometry(Shiboken.Object):
    ...
    class ColoredPoint2D(Shiboken.Object):
        ...
        def __copy__(self): ...
        def set(self, nx:float, ny:float, nr:support.signature.typing27.Union[str, int], ng:support.signature.typing27.Union[str, int], nb:support.signature.typing27.Union[str, int], na:support.signature.typing27.Union[str, int]): ...
