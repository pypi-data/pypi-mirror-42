...
class Qt3DExtras(Shiboken.Object):
    ...
    class QDiffuseSpecularMaterial(PySide2.Qt3DRender.Qt3DRender.QMaterial):
        ...
        def __init__(self, parent:PySide2.Qt3DCore.Qt3DCore.QNode=...): ...
        def ambient(self) -> PySide2.QtGui.QColor: ...
        def diffuse(self) -> support.signature.typing27.Any: ...
        def isAlphaBlendingEnabled(self) -> bool: ...
        def normal(self) -> support.signature.typing27.Any: ...
        def setAlphaBlendingEnabled(self, enabled:bool): ...
        def setAmbient(self, ambient:PySide2.QtGui.QColor): ...
        def setDiffuse(self, diffuse:support.signature.typing27.Any): ...
        def setNormal(self, normal:support.signature.typing27.Any): ...
        def setShininess(self, shininess:float): ...
        def setSpecular(self, specular:support.signature.typing27.Any): ...
        def setTextureScale(self, textureScale:float): ...
        def shininess(self) -> float: ...
        def specular(self) -> support.signature.typing27.Any: ...
        def textureScale(self) -> float: ...
    ...
    class QMetalRoughMaterial(PySide2.Qt3DRender.Qt3DRender.QMaterial):
        ...
        def __init__(self, parent:PySide2.Qt3DCore.Qt3DCore.QNode=...): ...
        def ambientOcclusion(self) -> support.signature.typing27.Any: ...
        def baseColor(self) -> support.signature.typing27.Any: ...
        def metalness(self) -> support.signature.typing27.Any: ...
        def normal(self) -> support.signature.typing27.Any: ...
        def roughness(self) -> support.signature.typing27.Any: ...
        def setAmbientOcclusion(self, ambientOcclusion:support.signature.typing27.Any): ...
        def setBaseColor(self, baseColor:support.signature.typing27.Any): ...
        def setMetalness(self, metalness:support.signature.typing27.Any): ...
        def setNormal(self, normal:support.signature.typing27.Any): ...
        def setRoughness(self, roughness:support.signature.typing27.Any): ...
        def setTextureScale(self, textureScale:float): ...
        def textureScale(self) -> float: ...
