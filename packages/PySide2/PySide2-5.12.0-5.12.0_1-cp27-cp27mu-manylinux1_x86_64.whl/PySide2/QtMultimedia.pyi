...
class QAbstractAudioDeviceInfo(PySide2.QtCore.QObject):
    ...
    def supportedCodecs(self) -> support.signature.typing27.List: ...
...
class QAbstractVideoBuffer(Shiboken.Object):
    ...
    def handle(self) -> support.signature.typing27.Any: ...
...
class QAudioDecoder(PySide2.QtMultimedia.QMediaObject):
    ...
    @staticmethod
    def hasSupport(mimeType:str, codecs:support.signature.typing27.List=...) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
...
class QAudioEncoderSettings(Shiboken.Object):
    ...
    def encodingOption(self, option:str) -> support.signature.typing27.Any: ...
    ...
    def setEncodingOption(self, option:str, value:support.signature.typing27.Any): ...
...
class QAudioEncoderSettingsControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def supportedAudioCodecs(self) -> support.signature.typing27.List: ...
...
class QAudioRecorder(PySide2.QtMultimedia.QMediaRecorder):
    ...
    def audioInputs(self) -> support.signature.typing27.List: ...
...
class QCameraExposureControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
    def actualValue(self, parameter:PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> support.signature.typing27.Any: ...
    def isParameterSupported(self, parameter:PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> bool: ...
    def requestedValue(self, parameter:PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> support.signature.typing27.Any: ...
    def setValue(self, parameter:PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter, value:support.signature.typing27.Any) -> bool: ...
...
class QCameraImageCapture(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    def supportedBufferFormats(self) -> PySide2.QtMultimedia.QVideoFrame.PixelFormat: ...
    def supportedImageCodecs(self) -> support.signature.typing27.List: ...
...
class QCameraImageProcessingControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def isParameterValueSupported(self, parameter:PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter, value:support.signature.typing27.Any) -> bool: ...
    def parameter(self, parameter:PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter) -> support.signature.typing27.Any: ...
    def setParameter(self, parameter:PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter, value:support.signature.typing27.Any): ...
...
class QCameraViewfinderSettingsControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def setViewfinderParameter(self, parameter:PySide2.QtMultimedia.QCameraViewfinderSettingsControl.ViewfinderParameter, value:support.signature.typing27.Any): ...
    def viewfinderParameter(self, parameter:PySide2.QtMultimedia.QCameraViewfinderSettingsControl.ViewfinderParameter) -> support.signature.typing27.Any: ...
...
class QCustomAudioRoleControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def supportedCustomAudioRoles(self) -> support.signature.typing27.List: ...
...
class QMediaContainerControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def supportedContainers(self) -> support.signature.typing27.List: ...
...
class QMediaObject(PySide2.QtCore.QObject):
    ...
    def availability(self) -> PySide2.QtMultimedia.QMultimedia.AvailabilityStatus: ...
    def availableMetaData(self) -> support.signature.typing27.List: ...
    def bind(self, arg__1:PySide2.QtCore.QObject) -> bool: ...
    def isAvailable(self) -> bool: ...
    def isMetaDataAvailable(self) -> bool: ...
    def metaData(self, key:str) -> support.signature.typing27.Any: ...
    def notifyInterval(self) -> int: ...
...
class QMediaPlayer(PySide2.QtMultimedia.QMediaObject):
    ...
    def errorString(self) -> str: ...
    @staticmethod
    def hasSupport(mimeType:str, codecs:support.signature.typing27.List=..., flags:PySide2.QtMultimedia.QMediaPlayer.Flags=...) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
    ...
    def supportedCustomAudioRoles(self) -> support.signature.typing27.List: ...
    @staticmethod
    def supportedMimeTypes(flags:PySide2.QtMultimedia.QMediaPlayer.Flags=...) -> support.signature.typing27.List: ...
    def unbind(self, arg__1:PySide2.QtCore.QObject): ...
    def volume(self) -> int: ...
...
class QMediaRecorder(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    def setMediaObject(self, object:PySide2.QtMultimedia.QMediaObject) -> bool: ...
    def setMetaData(self, key:str, value:support.signature.typing27.Any): ...
    def setMuted(self, muted:bool): ...
    ...
    def supportedAudioCodecs(self) -> support.signature.typing27.List: ...
    def supportedContainers(self) -> support.signature.typing27.List: ...
    def supportedVideoCodecs(self) -> support.signature.typing27.List: ...
...
class QMediaServiceProviderHint(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, mimeType:str, codecs:support.signature.typing27.List): ...
    @typing.overload
    ...
    def codecs(self) -> support.signature.typing27.List: ...
...
class QMediaServiceSupportedFormatsInterface(Shiboken.Object):
    ...
    def __init__(self): ...
    def hasSupport(self, mimeType:str, codecs:support.signature.typing27.List) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
    def supportedMimeTypes(self) -> support.signature.typing27.List: ...
...
class QMediaStreamsControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def metaData(self, streamNumber:int, key:str) -> support.signature.typing27.Any: ...
...
class QRadioTuner(PySide2.QtMultimedia.QMediaObject):
    ...
    def frequencyRange(self, band:PySide2.QtMultimedia.QRadioTuner.Band) -> support.signature.typing27.Tuple: ...
...
class QRadioTunerControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def errorString(self) -> str: ...
    def frequency(self) -> int: ...
    def frequencyRange(self, b:PySide2.QtMultimedia.QRadioTuner.Band) -> support.signature.typing27.Tuple: ...
...
class QSoundEffect(PySide2.QtCore.QObject):
    ...
    def stop(self): ...
    @staticmethod
    def supportedMimeTypes() -> support.signature.typing27.List: ...
    def volume(self) -> float: ...
...
class QVideoFrame(Shiboken.Object):
    ...
    def bits(self) -> support.signature.typing27.Union[str, int]: ...
    @typing.overload
...
class QVideoSurfaceFormat(Shiboken.Object):
    ...
    def pixelAspectRatio(self) -> PySide2.QtCore.QSize: ...
    def pixelFormat(self) -> PySide2.QtMultimedia.QVideoFrame.PixelFormat: ...
    def property(self, name:str) -> support.signature.typing27.Any: ...
    ...
    def setProperty(self, name:str, value:support.signature.typing27.Any): ...
