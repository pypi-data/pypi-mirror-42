...
class QTextToSpeech(PySide2.QtCore.QObject):
    ...
    @staticmethod
    def availableEngines() -> support.signature.typing27.List: ...
...
class QTextToSpeechEngine(PySide2.QtCore.QObject):
    ...
    def availableVoices(self) -> PySide2.QtTextToSpeech.QVoice: ...
    @staticmethod
    def createVoice(name:str, gender:PySide2.QtTextToSpeech.QVoice.Gender, age:PySide2.QtTextToSpeech.QVoice.Age, data:support.signature.typing27.Any) -> PySide2.QtTextToSpeech.QVoice: ...
    def locale(self) -> PySide2.QtCore.QLocale: ...
    def pause(self): ...
    def pitch(self) -> float: ...
    def rate(self) -> float: ...
    ...
    def voice(self) -> PySide2.QtTextToSpeech.QVoice: ...
    @staticmethod
    def voiceData(voice:PySide2.QtTextToSpeech.QVoice) -> support.signature.typing27.Any: ...
    def volume(self) -> float: ...
