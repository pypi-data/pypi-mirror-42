...
class QAbstractXmlNodeModel(Shiboken.Object):
    ...
    def typedValue(self, n:PySide2.QtXmlPatterns.QXmlNodeModelIndex) -> support.signature.typing27.Any: ...


class QAbstractXmlReceiver(Shiboken.Object):

    def __init__(self): ...
    def atomicValue(self, value:support.signature.typing27.Any): ...
...
class QXmlItem(Shiboken.Object):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, atomicValue:support.signature.typing27.Any): ...
    @typing.overload
    ...
    def isNull(self) -> bool: ...
    def toAtomicValue(self) -> support.signature.typing27.Any: ...
