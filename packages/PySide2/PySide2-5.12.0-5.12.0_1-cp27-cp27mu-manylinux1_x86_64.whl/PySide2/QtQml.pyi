...
class QJSEngine(PySide2.QtCore.QObject):
    ...
    def toScriptValue(self, arg__1:support.signature.typing27.Any) -> PySide2.QtQml.QJSValue: ...
...
class QJSValue(Shiboken.Object):
    ...
    def toUInt(self) -> int: ...
    def toVariant(self) -> support.signature.typing27.Any: ...
...
class QQmlContext(PySide2.QtCore.QObject):
    ...
    def contextProperty(self, arg__1:str) -> support.signature.typing27.Any: ...
    def engine(self) -> PySide2.QtQml.QQmlEngine: ...
    ...
    @typing.overload
    def setContextProperty(self, arg__1:str, arg__2:support.signature.typing27.Any): ...
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    @staticmethod
    def debuggerServices() -> support.signature.typing27.List: ...
    @staticmethod
    def inspectorServices() -> support.signature.typing27.List: ...
    @staticmethod
    def nativeDebuggerServices() -> support.signature.typing27.List: ...
    @staticmethod
    def profilerServices() -> support.signature.typing27.List: ...
    @staticmethod
    def setServices(services:support.signature.typing27.List): ...
    @staticmethod
...
class QQmlEngine(PySide2.QtQml.QJSEngine):
    ...
    def importPathList(self) -> support.signature.typing27.List: ...
    ...
    def pluginPathList(self) -> support.signature.typing27.List: ...
    ...
    def setImportPathList(self, paths:support.signature.typing27.List): ...
    ...
    def setPluginPathList(self, paths:support.signature.typing27.List): ...
...
class QQmlExpression(PySide2.QtCore.QObject):
    ...
    def evaluate(self, valueIsUndefined:bool=...) -> support.signature.typing27.Any: ...
...
class QQmlFileSelector(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setExtraSelectors(self, strings:support.signature.typing27.List): ...
    @typing.overload
    def setExtraSelectors(self, strings:support.signature.typing27.List): ...
...
class QQmlProperty(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def read() -> support.signature.typing27.Any: ...
    @typing.overload
    @staticmethod
    def read(arg__1:PySide2.QtCore.QObject, arg__2:str) -> support.signature.typing27.Any: ...
    @typing.overload
    @staticmethod
    def read(arg__1:PySide2.QtCore.QObject, arg__2:str, arg__3:PySide2.QtQml.QQmlContext) -> support.signature.typing27.Any: ...
    @typing.overload
    @staticmethod
    def read(arg__1:PySide2.QtCore.QObject, arg__2:str, arg__3:PySide2.QtQml.QQmlEngine) -> support.signature.typing27.Any: ...
    def reset(self) -> bool: ...
    def type(self) -> PySide2.QtQml.QQmlProperty.Type: ...
    @typing.overload
    @staticmethod
    def write(arg__1:PySide2.QtCore.QObject, arg__2:str, arg__3:support.signature.typing27.Any) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1:PySide2.QtCore.QObject, arg__2:str, arg__3:support.signature.typing27.Any, arg__4:PySide2.QtQml.QQmlContext) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1:PySide2.QtCore.QObject, arg__2:str, arg__3:support.signature.typing27.Any, arg__4:PySide2.QtQml.QQmlEngine) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1:support.signature.typing27.Any) -> bool: ...
...
class QQmlPropertyMap(PySide2.QtCore.QObject):
    ...
    def count(self) -> int: ...
    def insert(self, key:str, value:support.signature.typing27.Any): ...
    def isEmpty(self) -> bool: ...
    def keys(self) -> support.signature.typing27.List: ...
    def size(self) -> int: ...
    def updateValue(self, key:str, input:support.signature.typing27.Any) -> support.signature.typing27.Any: ...
    def value(self, key:str) -> support.signature.typing27.Any: ...
