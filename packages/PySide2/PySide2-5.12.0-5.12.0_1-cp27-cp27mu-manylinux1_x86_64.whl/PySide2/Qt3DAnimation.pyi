...
class Qt3DAnimation(Shiboken.Object):
    ...
    class QMorphTarget(PySide2.QtCore.QObject):
        ...
        def attributeNames(self) -> support.signature.typing27.List: ...
        @staticmethod
        def fromGeometry(geometry:PySide2.Qt3DRender.Qt3DRender.QGeometry, attributes:support.signature.typing27.List) -> PySide2.Qt3DAnimation.Qt3DAnimation.QMorphTarget: ...
