...
class QSensor(PySide2.QtCore.QObject):
    ...
    def availableDataRates(self) -> support.signature.typing27.Tuple: ...
...
class QSensorGestureManager(PySide2.QtCore.QObject):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
    def gestureIds(self) -> support.signature.typing27.List: ...
    def recognizerSignals(self, recognizerId:str) -> support.signature.typing27.List: ...
...
class QSensorGesturePluginInterface(Shiboken.Object):
    ...
    def name(self) -> str: ...
    def supportedIds(self) -> support.signature.typing27.List: ...
...
class QSensorGestureRecognizer(PySide2.QtCore.QObject):
    ...
    def gestureSignals(self) -> support.signature.typing27.List: ...
    def id(self) -> str: ...
    def isActive(self) -> bool: ...
    def start(self) -> bool: ...
...
class QSensorReading(PySide2.QtCore.QObject):
    ...
    def value(self, index:int) -> support.signature.typing27.Any: ...
