...
class QtDataVisualization(Shiboken.Object):
    ...
    class QAbstract3DAxis(PySide2.QtCore.QObject):
        ...
        def labels(self) -> support.signature.typing27.List: ...
        def max(self) -> float: ...
        def min(self) -> float: ...
        ...
        def setLabels(self, labels:support.signature.typing27.List): ...
    ...
    class QBarDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QAbstractDataProxy):
        ...
        @typing.overload
        def addRows(self, rows:support.signature.typing27.List) -> int: ...
        @typing.overload
        def addRows(self, rows:support.signature.typing27.List, labels:support.signature.typing27.List) -> int: ...
        def array(self) -> support.signature.typing27.List: ...
        def columnLabels(self) -> support.signature.typing27.List: ...
        @typing.overload
        def insertRow(self, rowIndex:int, row:list): ...
        @typing.overload
        def insertRow(self, rowIndex:int, row:list, label:str): ...
        @typing.overload
        def insertRows(self, rowIndex:int, rows:support.signature.typing27.List): ...
        @typing.overload
        def insertRows(self, rowIndex:int, rows:support.signature.typing27.List, labels:support.signature.typing27.List): ...
        @typing.overload
        ...
        def resetArray(self): ...
        @typing.overload
        def resetArray(self, newArray:support.signature.typing27.List): ...
        @typing.overload
        def resetArray(self, newArray:support.signature.typing27.List, rowLabels:support.signature.typing27.List, columnLabels:support.signature.typing27.List): ...
        def rowAt(self, rowIndex:int) -> PySide2.QtDataVisualization.QtDataVisualization.QBarDataItem: ...
        def rowCount(self) -> int: ...
        def rowLabels(self) -> support.signature.typing27.List: ...
        def series(self) -> PySide2.QtDataVisualization.QtDataVisualization.QBar3DSeries: ...
        def setColumnLabels(self, labels:support.signature.typing27.List): ...
        @typing.overload
        ...
        def setRowLabels(self, labels:support.signature.typing27.List): ...
        @typing.overload
        def setRows(self, rowIndex:int, rows:support.signature.typing27.List): ...
        @typing.overload
        def setRows(self, rowIndex:int, rows:support.signature.typing27.List, labels:support.signature.typing27.List): ...
    ...
    class QCustom3DVolume(PySide2.QtDataVisualization.QtDataVisualization.QCustom3DItem):
        ...
        def createTextureData(self, images:list) -> support.signature.typing27.Union[str, int]: ...
        ...
        @typing.overload
        def setSubTextureData(self, axis:PySide2.QtCore.Qt.Axis, index:int, data:support.signature.typing27.Union[str, int]): ...
        @typing.overload
        ...
        def textureData(self) -> support.signature.typing27.Union[str, int]: ...
    ...
    class QItemModelBarDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QBarDataProxy):
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rotationRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        def columnCategories(self) -> support.signature.typing27.List: ...
        ...
        def remap(self, rowRole:str, columnRole:str, valueRole:str, rotationRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List): ...
        def rotationRole(self) -> str: ...
        def rotationRolePattern(self) -> PySide2.QtCore.QRegExp: ...
        def rotationRoleReplace(self) -> str: ...
        def rowCategories(self) -> support.signature.typing27.List: ...
        ...
        def setColumnCategories(self, categories:support.signature.typing27.List): ...
        ...
        def setRowCategories(self, categories:support.signature.typing27.List): ...
    ...
    class QItemModelSurfaceDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QSurfaceDataProxy):
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, xPosRole:str, yPosRole:str, zPosRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, yPosRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        def remap(self, rowRole:str, columnRole:str, xPosRole:str, yPosRole:str, zPosRole:str, rowCategories:support.signature.typing27.List, columnCategories:support.signature.typing27.List): ...
        def rowCategories(self) -> support.signature.typing27.List: ...
        def rowCategoryIndex(self, category:str) -> int: ...
        def rowRole(self) -> str: ...
        def rowRolePattern(self) -> PySide2.QtCore.QRegExp: ...
    ...
    class QValue3DAxisFormatter(PySide2.QtCore.QObject):
        ...
        def labelStrings(self) -> support.signature.typing27.List: ...
        def locale(self) -> PySide2.QtCore.QLocale: ...
