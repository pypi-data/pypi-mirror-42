...
class QAbstractSocket(PySide2.QtCore.QIODevice):
    ...
    def setSocketOption(self, option:PySide2.QtNetwork.QAbstractSocket.SocketOption, value:support.signature.typing27.Any): ...
    def setSocketState(self, state:PySide2.QtNetwork.QAbstractSocket.SocketState): ...
    def socketDescriptor(self) -> int: ...
    def socketOption(self, option:PySide2.QtNetwork.QAbstractSocket.SocketOption) -> support.signature.typing27.Any: ...
...
class QAuthenticator(Shiboken.Object):
    ...
    def option(self, opt:str) -> support.signature.typing27.Any: ...
    def options(self) -> dict: ...
    def password(self) -> str: ...
    def realm(self) -> str: ...
    def setOption(self, opt:str, value:support.signature.typing27.Any): ...
...
class QHostAddress(Shiboken.Object):
    ...
    @typing.overload
    def isInSubnet(self, subnet:support.signature.typing27.Tuple) -> bool: ...
    ...
    @staticmethod
    def parseSubnet(subnet:str) -> support.signature.typing27.Tuple: ...
...
class QHttpPart(Shiboken.Object):
    ...
    def setHeader(self, header:PySide2.QtNetwork.QNetworkRequest.KnownHeaders, value:support.signature.typing27.Any): ...
...
class QNetworkAccessManager(PySide2.QtCore.QObject):
    ...
    def supportedSchemes(self) -> support.signature.typing27.List: ...
    def supportedSchemesImplementation(self) -> support.signature.typing27.List: ...
...
class QNetworkCacheMetaData(Shiboken.Object):
    ...
    def rawHeaders(self) -> support.signature.typing27.Tuple: ...
...
class QNetworkProxy(Shiboken.Object):
    ...
    def header(self, header:PySide2.QtNetwork.QNetworkRequest.KnownHeaders) -> support.signature.typing27.Any: ...
    def hostName(self) -> str: ...
...
class QNetworkReply(PySide2.QtCore.QIODevice):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
    def abort(self): ...
    def attribute(self, code:PySide2.QtNetwork.QNetworkRequest.Attribute) -> support.signature.typing27.Any: ...
    def close(self): ...
    ...
    def rawHeader(self, headerName:PySide2.QtCore.QByteArray) -> PySide2.QtCore.QByteArray: ...
    def rawHeaderList(self) -> PySide2.QtCore.QByteArray: ...
    def rawHeaderPairs(self) -> support.signature.typing27.Tuple: ...
    def readBufferSize(self) -> int: ...
    def request(self) -> PySide2.QtNetwork.QNetworkRequest: ...
    def setAttribute(self, code:PySide2.QtNetwork.QNetworkRequest.Attribute, value:support.signature.typing27.Any): ...
...
class QNetworkRequest(Shiboken.Object):
    ...
    def __copy__(self): ...
    def attribute(self, code:PySide2.QtNetwork.QNetworkRequest.Attribute, defaultValue:support.signature.typing27.Any=...) -> support.signature.typing27.Any: ...
    def hasRawHeader(self, headerName:PySide2.QtCore.QByteArray) -> bool: ...
    def header(self, header:PySide2.QtNetwork.QNetworkRequest.KnownHeaders) -> support.signature.typing27.Any: ...
...
class QNetworkSession(PySide2.QtCore.QObject):
    ...
    def open(self): ...
    def reject(self): ...
    def sessionProperty(self, key:str) -> support.signature.typing27.Any: ...
    def setSessionProperty(self, key:str, value:support.signature.typing27.Any): ...
...
class QSslCertificate(Shiboken.Object):
    ...
    @typing.overload
    def issuerInfo(self, attribute:PySide2.QtCore.QByteArray) -> support.signature.typing27.List: ...
    @typing.overload
    def issuerInfo(self, info:PySide2.QtNetwork.QSslCertificate.SubjectInfo) -> support.signature.typing27.List: ...
    ...
    def subjectAlternativeNames(self) -> support.signature.typing27.DefaultDict: ...
    def subjectDisplayName(self) -> str: ...
    @typing.overload
    def subjectInfo(self, attribute:PySide2.QtCore.QByteArray) -> support.signature.typing27.List: ...
    @typing.overload
    def subjectInfo(self, info:PySide2.QtNetwork.QSslCertificate.SubjectInfo) -> support.signature.typing27.List: ...
...
class QSslCertificateExtension(Shiboken.Object):
    ...
    def value(self) -> support.signature.typing27.Any: ...
...
class QSslConfiguration(Shiboken.Object):
    ...
    def setBackendConfigurationOption(self, name:PySide2.QtCore.QByteArray, value:support.signature.typing27.Any): ...
