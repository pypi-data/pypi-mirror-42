...
class QTest(Shiboken.Object):
    ...
    @staticmethod
    def asciiToKey(ascii:support.signature.typing27.Union[str, int]) -> PySide2.QtCore.Qt.Key: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyClick(widget:PySide2.QtWidgets.QWidget, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyClick(window:PySide2.QtGui.QWindow, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @staticmethod
    def keyClicks(widget:PySide2.QtWidgets.QWidget, sequence:str, modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    def keyEvent(action:PySide2.QtTest.QTest.KeyAction, widget:PySide2.QtWidgets.QWidget, ascii:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyEvent(action:PySide2.QtTest.QTest.KeyAction, window:PySide2.QtGui.QWindow, ascii:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyPress(widget:PySide2.QtWidgets.QWidget, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyPress(window:PySide2.QtGui.QWindow, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyRelease(widget:PySide2.QtWidgets.QWidget, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def keyRelease(window:PySide2.QtGui.QWindow, key:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers=..., delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def keyToAscii(key:PySide2.QtCore.Qt.Key) -> support.signature.typing27.Union[str, int]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def sendKeyEvent(action:PySide2.QtTest.QTest.KeyAction, widget:PySide2.QtWidgets.QWidget, code:PySide2.QtCore.Qt.Key, ascii:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers, delay:int=...): ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def sendKeyEvent(action:PySide2.QtTest.QTest.KeyAction, window:PySide2.QtGui.QWindow, code:PySide2.QtCore.Qt.Key, ascii:support.signature.typing27.Union[str, int], modifier:PySide2.QtCore.Qt.KeyboardModifiers, delay:int=...): ...
    @typing.overload
    @staticmethod
