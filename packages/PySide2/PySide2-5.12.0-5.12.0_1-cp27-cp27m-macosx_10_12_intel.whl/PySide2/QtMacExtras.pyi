...
def qRegisterDraggedTypes(types:support.signature.typing27.List): ...


class QMacPasteboardMime(Shiboken.Object):

    def __init__(self, arg__1:support.signature.typing27.Union[str, int]): ...
    def canConvert(self, mime:str, flav:str) -> bool: ...
    def convertFromMime(self, mime:str, data:support.signature.typing27.Any, flav:str) -> PySide2.QtCore.QByteArray: ...
    def convertToMime(self, mime:str, data:list, flav:str) -> support.signature.typing27.Any: ...
...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    def allowedItems(self) -> PySide2.QtMacExtras.QMacToolBarItem: ...
    def attachToWindow(self, window:PySide2.QtGui.QWindow): ...
    def detachFromWindow(self): ...
    def items(self) -> PySide2.QtMacExtras.QMacToolBarItem: ...
    def setAllowedItems(self, allowedItems:list): ...
