...
class QWebEngineContextMenuData(Shiboken.Object):
    ...
    def spellCheckerSuggestions(self) -> support.signature.typing27.List: ...
...
class QWebEnginePage(PySide2.QtCore.QObject):
    ...
    def chooseFiles(self, mode:PySide2.QtWebEngineWidgets.QWebEnginePage.FileSelectionMode, oldFiles:support.signature.typing27.List, acceptedMimeTypes:support.signature.typing27.List) -> support.signature.typing27.List: ...
...
class QWebEngineProfile(PySide2.QtCore.QObject):
    ...
    def setSpellCheckLanguages(self, languages:support.signature.typing27.List): ...
    def settings(self) -> PySide2.QtWebEngineWidgets.QWebEngineSettings: ...
    def spellCheckLanguages(self) -> support.signature.typing27.List: ...
