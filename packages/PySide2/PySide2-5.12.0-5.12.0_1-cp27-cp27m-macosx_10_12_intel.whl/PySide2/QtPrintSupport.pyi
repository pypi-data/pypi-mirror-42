...
class QPrintEngine(Shiboken.Object):
    ...
    def property(self, key:PySide2.QtPrintSupport.QPrintEngine.PrintEnginePropertyKey) -> support.signature.typing27.Any: ...
    def setProperty(self, key:PySide2.QtPrintSupport.QPrintEngine.PrintEnginePropertyKey, value:support.signature.typing27.Any): ...
...
class QPrinterInfo(Shiboken.Object):
    ...
    def __copy__(self): ...
    @staticmethod
    def availablePrinterNames() -> support.signature.typing27.List: ...
    @staticmethod
    ...
    def supportedResolutions(self) -> int: ...
    def supportedSizesWithNames(self) -> support.signature.typing27.Tuple: ...
