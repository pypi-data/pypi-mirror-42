...
class QSqlDatabase(Shiboken.Object):
    ...
    @staticmethod
    def connectionNames() -> support.signature.typing27.List: ...
    @staticmethod
    ...
    @staticmethod
    def drivers() -> support.signature.typing27.List: ...
    ...
    def tables(self, type:PySide2.QtSql.QSql.TableType=...) -> support.signature.typing27.List: ...
...
class QSqlDriver(PySide2.QtCore.QObject):
    ...
    def subscribedToNotifications(self) -> support.signature.typing27.List: ...
    def tables(self, tableType:PySide2.QtSql.QSql.TableType) -> support.signature.typing27.List: ...
...
class QSqlField(Shiboken.Object):
    ...
    def __copy__(self): ...
    def clear(self): ...
    def defaultValue(self) -> support.signature.typing27.Any: ...
    ...
    def setDefaultValue(self, value:support.signature.typing27.Any): ...
    ...
    def setValue(self, value:support.signature.typing27.Any): ...
...
class QSqlQuery(Shiboken.Object):
    ...
    def __copy__(self): ...
    def addBindValue(self, val:support.signature.typing27.Any, type:PySide2.QtSql.QSql.ParamType=...): ...
    def at(self) -> int: ...
    @typing.overload
    def bindValue(self, placeholder:str, val:support.signature.typing27.Any, type:PySide2.QtSql.QSql.ParamType=...): ...
    @typing.overload
    def bindValue(self, pos:int, val:support.signature.typing27.Any, type:PySide2.QtSql.QSql.ParamType=...): ...
    @typing.overload
    def boundValue(self, placeholder:str) -> support.signature.typing27.Any: ...
    @typing.overload
    def boundValue(self, pos:int) -> support.signature.typing27.Any: ...
    ...
    def last(self) -> bool: ...
    def lastError(self) -> PySide2.QtSql.QSqlError: ...
    def lastInsertId(self) -> support.signature.typing27.Any: ...
    ...
    def size(self) -> int: ...
    @typing.overload
    def value(self, i:int) -> support.signature.typing27.Any: ...
    @typing.overload
    def value(self, name:str) -> support.signature.typing27.Any: ...
...
class QSqlQueryModel(PySide2.QtCore.QAbstractTableModel):
    ...
    def data(self, item:PySide2.QtCore.QModelIndex, role:int=...) -> support.signature.typing27.Any: ...
    ...
    def headerData(self, section:int, orientation:PySide2.QtCore.Qt.Orientation, role:int=...) -> support.signature.typing27.Any: ...
    ...
    def setHeaderData(self, section:int, orientation:PySide2.QtCore.Qt.Orientation, value:support.signature.typing27.Any, role:int=...) -> bool: ...
...
class QSqlRecord(Shiboken.Object):
    ...
    @typing.overload
    def setValue(self, i:int, val:support.signature.typing27.Any): ...
    @typing.overload
    def setValue(self, name:str, val:support.signature.typing27.Any): ...
    @typing.overload
    def value(self, i:int) -> support.signature.typing27.Any: ...
    @typing.overload
    def value(self, name:str) -> support.signature.typing27.Any: ...
...
class QSqlRelationalTableModel(PySide2.QtSql.QSqlTableModel):
    ...
    def setData(self, item:PySide2.QtCore.QModelIndex, value:support.signature.typing27.Any, role:int=...) -> bool: ...
...
class QSqlResult(Shiboken.Object):
    ...
    def boundValues(self) -> support.signature.typing27.Any: ...
    def clear(self): ...
    def data(self, i:int) -> support.signature.typing27.Any: ...
...
class QSqlTableModel(PySide2.QtSql.QSqlQueryModel):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=..., db:PySide2.QtSql.QSqlDatabase=...): ...
    def clear(self): ...
    def data(self, idx:PySide2.QtCore.QModelIndex, role:int=...) -> support.signature.typing27.Any: ...
    ...
    def selectStatement(self) -> str: ...
    def setData(self, index:PySide2.QtCore.QModelIndex, value:support.signature.typing27.Any, role:int=...) -> bool: ...
