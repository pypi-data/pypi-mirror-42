...
class QXmlInputSource(Shiboken.Object):
    ...
    def next(self) -> support.signature.typing27.Union[str, int]: ...
    def reset(self): ...
    @typing.overload
...
class QXmlNamespaceSupport(Shiboken.Object):
    ...
    @typing.overload
    def prefixes(self) -> support.signature.typing27.List: ...
    @typing.overload
    def prefixes(self, arg__1:str) -> support.signature.typing27.List: ...
