...
class QGeoServiceProvider(PySide2.QtCore.QObject):
    ...
    @staticmethod
    def availableServiceProviders() -> support.signature.typing27.List: ...
...
class QPlace(Shiboken.Object):
    ...
    def contactTypes(self) -> support.signature.typing27.List: ...
    ...
    def extendedAttributeTypes(self) -> support.signature.typing27.List: ...
...
class QPlaceContentRequest(Shiboken.Object):
    ...
    def __copy__(self): ...
    def clear(self): ...
    def contentContext(self) -> support.signature.typing27.Any: ...
    def contentType(self) -> PySide2.QtLocation.QPlaceContent.Type: ...
    def limit(self) -> int: ...
    def placeId(self) -> str: ...
    def setContentContext(self, context:support.signature.typing27.Any): ...
...
class QPlaceManager(PySide2.QtCore.QObject):
    ...
    def childCategoryIds(self, parentId:str=...) -> support.signature.typing27.List: ...
...
class QPlaceManagerEngine(PySide2.QtCore.QObject):
    ...
    def category(self, categoryId:str) -> PySide2.QtLocation.QPlaceCategory: ...
    def childCategories(self, parentId:str) -> PySide2.QtLocation.QPlaceCategory: ...
    def childCategoryIds(self, categoryId:str) -> support.signature.typing27.List: ...
...
class QPlaceSearchRequest(Shiboken.Object):
    ...
    def searchContext(self) -> support.signature.typing27.Any: ...
    ...
    def setSearchContext(self, context:support.signature.typing27.Any): ...
...
class QPlaceSearchSuggestionReply(PySide2.QtLocation.QPlaceReply):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
    def setSuggestions(self, suggestions:support.signature.typing27.List): ...
    def suggestions(self) -> support.signature.typing27.List: ...
    def type(self) -> PySide2.QtLocation.QPlaceReply.Type: ...
