...
class QHelpContentModel(PySide2.QtCore.QAbstractItemModel):
    ...
    def data(self, index:PySide2.QtCore.QModelIndex, role:int) -> support.signature.typing27.Any: ...
...
class QHelpEngineCore(PySide2.QtCore.QObject):
    ...
    def __init__(self, collectionFile:str, parent:PySide2.QtCore.QObject=...): ...
    def addCustomFilter(self, filterName:str, attributes:support.signature.typing27.List) -> bool: ...
    ...
    def customFilters(self) -> support.signature.typing27.List: ...
    def customValue(self, key:str, defaultValue:support.signature.typing27.Any=...) -> support.signature.typing27.Any: ...
    def documentationFileName(self, namespaceName:str) -> str: ...
    def error(self) -> str: ...
    def fileData(self, url:PySide2.QtCore.QUrl) -> PySide2.QtCore.QByteArray: ...
    def files(self, namespaceName:str, filterAttributes:support.signature.typing27.List, extensionFilter:str=...) -> PySide2.QtCore.QUrl: ...
    def filterAttributeSets(self, namespaceName:str) -> support.signature.typing27.List: ...
    @typing.overload
    def filterAttributes(self) -> support.signature.typing27.List: ...
    @typing.overload
    def filterAttributes(self, filterName:str) -> support.signature.typing27.List: ...
    ...
    @staticmethod
    def metaData(documentationFileName:str, name:str) -> support.signature.typing27.Any: ...
    @staticmethod
    def namespaceName(documentationFileName:str) -> str: ...
    def registerDocumentation(self, documentationFileName:str) -> bool: ...
    def registeredDocumentations(self) -> support.signature.typing27.List: ...
    ...
    def setCustomValue(self, key:str, value:support.signature.typing27.Any) -> bool: ...
...
class QHelpSearchEngine(PySide2.QtCore.QObject):
    ...
    def hits(self, start:int, end:int) -> support.signature.typing27.Tuple: ...
...
class QHelpSearchQuery(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, field:PySide2.QtHelp.QHelpSearchQuery.FieldName, wordList_:support.signature.typing27.List): ...
    def __copy__(self): ...
