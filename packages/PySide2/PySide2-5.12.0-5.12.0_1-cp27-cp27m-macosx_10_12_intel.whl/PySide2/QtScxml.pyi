...
class QScxmlCompiler(Shiboken.Object):
    ...
    class Loader(Shiboken.Object):
        ...
        def __init__(self): ...
        def load(self, name:str, baseDir:str, errors:support.signature.typing27.List) -> PySide2.QtCore.QByteArray: ...
...
class QScxmlCppDataModel(PySide2.QtScxml.QScxmlDataModel):
    ...
    def scxmlProperty(self, name:str) -> support.signature.typing27.Any: ...
    def setScxmlEvent(self, scxmlEvent:PySide2.QtScxml.QScxmlEvent): ...
    def setScxmlProperty(self, name:str, value:support.signature.typing27.Any, context:str) -> bool: ...
...
class QScxmlDataModel(PySide2.QtCore.QObject):
    ...
    def evaluateToVariant(self, id:int, ok:bool) -> support.signature.typing27.Any: ...
...
class QScxmlEvent(Shiboken.Object):
    ...
    def clear(self): ...
    def data(self) -> support.signature.typing27.Any: ...
    def delay(self) -> int: ...
    ...
    def sendId(self) -> str: ...
    def setData(self, data:support.signature.typing27.Any): ...
...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    def activeStateNames(self, compress:bool=...) -> support.signature.typing27.List: ...
    ...
    def start(self): ...
    def stateNames(self, compress:bool=...) -> support.signature.typing27.List: ...
    def stop(self): ...
    @typing.overload
    ...
    @typing.overload
    def submitEvent(self, eventName:str, data:support.signature.typing27.Any): ...
