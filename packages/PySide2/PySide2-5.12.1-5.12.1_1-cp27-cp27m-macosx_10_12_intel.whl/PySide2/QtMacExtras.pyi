...
def qRegisterDraggedTypes(types:typing.List[str]): ...


class QMacPasteboardMime(Shiboken.Object):

    def __init__(self, arg__1:typing.Union[str, int]): ...
    def canConvert(self, mime:str, flav:str) -> bool: ...
    def convertFromMime(self, mime:str, data:typing.Any, flav:str) -> PySide2.QtCore.QByteArray: ...
    def convertToMime(self, mime:str, data:list, flav:str) -> typing.Any: ...
