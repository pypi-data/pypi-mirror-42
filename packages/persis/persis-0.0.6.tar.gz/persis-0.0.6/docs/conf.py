...
module_dir = os.path.join(__location__, "../src/persis")
...
try:
    from persis import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'Persis Documentation',
