...
class SmartBook(dict):
    ...
    **Examples**
    ...
    def __init__(self, units={}, bounds={}, *args,
        ...
        self._bounds = bounds
        self._source = source
        #: Dictionary of boolean pairs dictating whether or not to include lower and upper bounds.
    ...
    def boundscheck(self, key, value):
        ...
        **Parameters**
        ...
        source = self._source
        units = self._units.get(key, '')
        inclusive = self.inclusive.get(key, (True, True))
        if bounds is None:
            within_bounds = True
        else:
