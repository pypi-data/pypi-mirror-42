...
class EntityChunk(TokenSpan):
	def __init__(self, entity):
		...
		self._start = min([entity.start]+[noun_chunk.start for noun_chunk in entity.parent_noun_chunks])
		self._end = max([entity.end]+[noun_chunk.end for noun_chunk in entity.parent_noun_chunks])
