    ...
    **Description**
    ...
    def minimize_co2_consumption(self, obj_operated_unit_list=None, weight=1):
        ...
        final_operated_unit_list = self._check_operated_unit_list(
            obj_operated_unit_list)
        for operated_unit in final_operated_unit_list:
            self.min_co2_consumption = Objective(name='min_co2_consumption{}'
    ...
    def power_consumption_minimum(self, min_p, time,
        ...
        cst_name = 'min_power_conso_{}'.format(consumption_name_string)
    ...
    def power_consumption_maximum(self, max_p, time,
        ...
        cst_name = 'max_power_conso_{}'.format(consumption_name_string)
