...
def subsection_title(book, title, subtitle):
  t = total_subtitles = len(book[title])
  n = book[title].index(subtitle)
  ...
  return """
    ...
    """.format(ARROW=arrow, GROUP=group, NAME=name, INDEX=n, TOTAL=t)
