...
__version__ = "0.1b59"            # this is the definitive version for distribution
...
def timed_fn(fn):
    ...
    def wrapped(*args, **kwargs):
        ...
        xanity.log('[timed_fn] starting "{}"'.format(fn.__name__))
        starttime = time.time()

        results = fn(*args, **kwargs)

        elapsed = time.time() - starttime
        xanity.log('[timed_fn] "{}" took {} s'.format(fn.__name__, elapsed))
