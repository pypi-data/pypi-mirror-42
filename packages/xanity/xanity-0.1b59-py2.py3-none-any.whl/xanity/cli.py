...
def parser(xanity, clargs=None):
    ...
    if action_arg.action in COMMANDS.RUN:
        ...
        parser.add_argument('--initialize', action='store_true', help='run xanity init before experiments')
        parser.add_argument('--setup', action='store_true', help='run xanity setup before experiments')
