...
# source: protobuf/proto/net/DeviceProto.proto
...
_DEVICEPROTO.fields_by_name['type'].enum_type = protobuf_dot_proto_dot_net_dot_device_dot_DeviceEnumsProto__pb2._DEVICETYPEPROTO
...
DeviceProto = _reflection.GeneratedProtocolMessageType('DeviceProto', (_message.Message,), dict(
  ...
  AnnotationsEntry = _reflection.GeneratedProtocolMessageType('AnnotationsEntry', (_message.Message,), dict(
    ...
    __module__ = 'protobuf.proto.net.DeviceProto_pb2'
...
_DEVICEPROTO_ANNOTATIONSENTRY._options = None
