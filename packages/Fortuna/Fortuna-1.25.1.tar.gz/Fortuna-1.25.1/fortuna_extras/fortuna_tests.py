...
if __name__ == "__main__":
    ...
    distribution_timer(random.shuffle, population, dist=False)
    print(f"random.random():")
    distribution_timer(random.random, dist=False)
    ...
    print(f"shuffle(population):")
    distribution_timer(shuffle, population, dist=False)
