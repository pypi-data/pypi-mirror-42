    ...
    def fit(self, X, y):
        ...
        if memory is None:
            ...
            raise ValueError("'memory' should either be a string or"
                             " a h2o4gpu.externals.joblib.Memory"
...
class RandomizedLassoSklearn(BaseRandomizedLinearModel):
    ...
    memory : Instance of h2o4gpu.externals.joblib.Memory or string, optional \
            (default=None)
    ...
    >>> randomized_lasso = RandomizedLassoSklearn()
...
class RandomizedLogisticRegressionSklearn(BaseRandomizedLinearModel):
    ...
    >>> randomized_logistic = RandomizedLogisticRegressionSklearn()
