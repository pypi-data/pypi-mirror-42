...
class _DPGMMBase(_GMMBase):
    ...
    def _fit(self, X, y=None):
        ...
        or
        http://h2o4gpu.org/stable/modules/dp-derivation.html
        ...
        if 'm' in self.init_params or not hasattr(self, 'means_'):
            self.means_ = cluster.KMeansSklearn(
...
@deprecated("The `DPGMM` class is not working correctly and it's better "
            "to use `h2o4gpu.mixture.BayesianGaussianMixture` class with "
...
class DPGMM(_DPGMMBase):
    ...
    .. deprecated:: 0.18
        ...
        Use :class:`h2o4gpu.mixture.BayesianGaussianMixture` with
        parameter ``weight_concentration_prior_type='dirichlet_process'``
        instead.
...
class VBGMM(_DPGMMBase):
    ...
    .. deprecated:: 0.18
        This class will be removed in 0.20.
        Use :class:`h2o4gpu.mixture.BayesianGaussianMixture` with parameter
