...
# - 'h2o4gpu/mixture/dpgmm.py'
# - 'h2o4gpu/mixture/gmm.py'
# - 'h2o4gpu/mixture/test_gmm.py'
import unittest
import sys

import numpy as np

from h2o4gpu.mixture import DPGMM, VBGMM
from h2o4gpu.mixture.dpgmm import log_normalize
from h2o4gpu.datasets import make_blobs
from h2o4gpu.utils.testing import assert_array_less, assert_equal
from h2o4gpu.utils.testing import assert_warns_message, ignore_warnings
from h2o4gpu.mixture.tests.test_gmm import GMMTester
from h2o4gpu.externals.six.moves import cStringIO as StringIO
from h2o4gpu.mixture.dpgmm import digamma, gammaln
from h2o4gpu.mixture.dpgmm import wishart_log_det, wishart_logz
...
def test_DPGMM_deprecation():
    assert_warns_message(
      ...
      "it's better to use `h2o4gpu.mixture.BayesianGaussianMixture` class "
