...
# This assert_warns behavior is specific to h2o4gpu because
...
def test_check_docstring_parameters():
    ...
    assert_equal(
        incorrect,
        ['h2o4gpu.utils.tests.test_testing.f_check_param_definition There was '
         'no space between the param name and colon ("a: int")',
         'h2o4gpu.utils.tests.test_testing.f_check_param_definition There was '
         'no space between the param name and colon ("b:")',
         'h2o4gpu.utils.tests.test_testing.f_check_param_definition Incorrect '
