...
examples:
    ...
    def parse_args(self, args):
        ...
        if parsed_args['collection']:
            resource['workspace'], resource['name'] = parse_collection_path(parsed_args['<name>'])
    ...
    def go_collection(self, resource):
        ...
        self.lprint(0, 'Collection "%s" was created successfully in workspace "%s".' % (c.name, c.workspace))
        return 0
