...
class ShowCodec(Dat['ShowCodec']):
    ...
    def __init__(self, id: int, seriesName: str, overview: str, status: str, firstAired: str) -> None:
        self.id = id
...
class TvdbShow(Dat['TvdbShow']):
    ...
    def __init__(self, id: int, name: str, overview: str, ended: bool, year: str) -> None:
        self.id = id
        self.name = name
        self.overview = overview
        self.ended = ended
