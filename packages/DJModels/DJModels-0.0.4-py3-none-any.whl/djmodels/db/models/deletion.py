...
from djmodels.db import IntegrityError, connections, transaction
from djmodels.db.models import signals, sql
...
def SET(value):
    if callable(value):
        ...
        def set_on_delete(collector, field, sub_objs, using):
            collector.add_field_update(field, value, sub_objs)
    set_on_delete.deconstruct = lambda: ('djmodels.db.models.SET', (value,), {})
