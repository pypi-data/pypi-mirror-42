...
from djmodels.conf import UserSettingsHolder, settings
from djmodels.core.exceptions import ImproperlyConfigured
from djmodels.core.signals import request_started
from djmodels.db import DEFAULT_DB_ALIAS, connections, reset_queries
from djmodels.db.models.options import Options
from djmodels.test.signals import setting_changed, template_rendered
from djmodels.utils.translation import deactivate
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = 'djmodels.core.mail.backends.locmem.EmailBackend'
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from djmodels.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    test_func = override_settings(TEMPLATES=[{
        'BACKEND': 'djmodels.template.backends.djmodels.DjangoTemplates',
        'APP_DIRS': True,
    }, {
        'BACKEND': 'djmodels.template.backends.jinja2.Jinja2',
        'APP_DIRS': True,
