...
from djmodels.db.migrations.utils import COMPILED_REGEX_TYPE, RegexObject
from djmodels.utils.functional import LazyObject, Promise
...
class DatetimeDatetimeSerializer(BaseSerializer):
    ...
    def serialize(self):
        ...
        if self.value.tzinfo is not None:
            imports.append("from djmodels.utils.timezone import utc")
...
class DeconstructableSerializer(BaseSerializer):
    ...
    def _serialize_path(path):
        ...
        if module == "djmodels.db.models":
            imports = {"from djmodels.db import models"}
            name = "models.%s" % name
        else:
...
class SettingsReferenceSerializer(BaseSerializer):
    def serialize(self):
        return "settings.%s" % self.value.setting_name, {"from djmodels.conf import settings"}
