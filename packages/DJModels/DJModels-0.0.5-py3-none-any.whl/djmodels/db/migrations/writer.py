...
from djmodels.db.migrations.serializer import serializer_factory
from djmodels.utils.inspect import get_func_args
...
class OperationWriter:
    ...
    def serialize(self):
        ...
        # See if this operation is in djmodels.db.migrations. If it is,
    ...
    def as_string(self):
        ...
        for dependency in self.migration.dependencies:
            if dependency[0] == "__setting__":
                ...
                imports.add("from djmodels.conf import settings")
            else:
