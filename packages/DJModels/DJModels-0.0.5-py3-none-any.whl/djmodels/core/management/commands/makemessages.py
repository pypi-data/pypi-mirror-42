...
from djmodels.utils.jslex import prepare_js_for_gettext
from djmodels.utils.text import get_text_list
from djmodels.utils.translation import templatize
...
class Command(BaseCommand):
    help = (
        ...
        "file in the conf/locale (in the djmodels tree) or locale (for projects and "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--domain', '-d', default='djmodels',
            help='The domain of the message files (default: "djmodels").',
        )
        parser.add_argument(
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        django_dir = os.path.normpath(os.path.join(os.path.dirname(djmodels.__file__)))
        if self.domain == 'djangojs':
            domains = ('djangojs', 'djmodels')
        else:
            domains = ('djmodels',)
