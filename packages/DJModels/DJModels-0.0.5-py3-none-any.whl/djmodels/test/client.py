...
class Client(RequestFactory):
    ...
    def login(self, **credentials):
        ...
        are incorrect.
        """
        from djmodels.contrib.auth import authenticate
    ...
    def force_login(self, user, backend=None):
        def get_backend():
            from djmodels.contrib.auth import load_backend
    ...
    def _login(self, user, backend=None):
        from djmodels.contrib.auth import login
        engine = import_module(settings.SESSION_ENGINE)
    ...
    def logout(self):
        ...
        from djmodels.contrib.auth import get_user, logout
