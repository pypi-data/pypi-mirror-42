...
from djmodels.core.serializers import base
from djmodels.db import DEFAULT_DB_ALIAS, models
from djmodels.utils.xmlutils import (
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("djmodels-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("djmodels-objects")
