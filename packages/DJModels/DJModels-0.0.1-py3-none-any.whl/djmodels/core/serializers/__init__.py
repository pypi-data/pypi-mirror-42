...
from djmodels.core.serializers.base import SerializerDoesNotExist

# Built-in serializers
BUILTIN_SERIALIZERS = {
    "xml": "djmodels.core.serializers.xml_serializer",
    "python": "djmodels.core.serializers.python",
    "json": "djmodels.core.serializers.json",
    "yaml": "djmodels.core.serializers.pyyaml",
}
