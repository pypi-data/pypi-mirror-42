"""
 ...
 Example:
  >>> from djmodels.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from djmodels.contrib.gis.gdal import OGRGeomType
...
from djmodels.contrib.gis.gdal.base import GDALBase
from djmodels.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from djmodels.contrib.gis.gdal.error import GDALException, SRSException
from djmodels.contrib.gis.gdal.geomtype import OGRGeomType
from djmodels.contrib.gis.gdal.libgdal import GDAL_VERSION
from djmodels.contrib.gis.gdal.prototypes import geom as capi, srs as srs_api
from djmodels.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from djmodels.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
...
class Point(OGRGeometry):
    ...
    def _geos_ptr(self):
        from djmodels.contrib.gis import geos
