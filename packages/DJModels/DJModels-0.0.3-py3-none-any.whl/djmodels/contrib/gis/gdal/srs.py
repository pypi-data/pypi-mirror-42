"""
  ...
  Example:
  >>> from djmodels.contrib.gis.gdal import SpatialReference
...
from djmodels.contrib.gis.gdal.error import SRSException
from djmodels.contrib.gis.gdal.prototypes import srs as capi
