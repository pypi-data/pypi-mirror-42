...
be executed through ``djmodels-admin`` or ``manage.py``).
"""
import os
import sys
...
from djmodels.core.management.color import color_style, no_style
...
class BaseCommand:
    ...
    1. ``djmodels-admin`` or ``manage.py`` loads the command class
