...
from djmodels.db.models.expressions import Case, Func, Star, When
from djmodels.db.models.fields import DecimalField, FloatField, IntegerField
...
class Avg(Aggregate):
    ...
    def as_oracle(self, compiler, connection):
        if self.output_field.get_internal_type() == 'DurationField':
            ...
            from djmodels.db.backends.oracle.functions import IntervalToSeconds, SecondsToInterval
