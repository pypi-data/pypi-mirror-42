...
from djmodels.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    """
    compiler_module = "djmodels.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, sequences, allow_cascade=False):
        ...
        color_style() or no_style() in djmodels.core.management.color.
