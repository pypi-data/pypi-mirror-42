...
from djmodels.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
...
from djmodels.contrib.gis.geos.prototypes.io import wkb_r
from djmodels.contrib.gis.measure import Distance
from djmodels.db.backends.oracle.operations import DatabaseOperations
...
class OracleOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from djmodels.contrib.gis.db.backends.oracle.models import OracleGeometryColumns
        return OracleGeometryColumns

    def spatial_ref_sys(self):
        from djmodels.contrib.gis.db.backends.oracle.models import OracleSpatialRefSys
