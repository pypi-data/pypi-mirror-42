...
from djmodels.contrib.gis.geos import prototypes as capi
from djmodels.contrib.gis.geos.base import GEOSBase
from djmodels.contrib.gis.geos.coordseq import GEOSCoordSeq
from djmodels.contrib.gis.geos.error import GEOSException
from djmodels.contrib.gis.geos.libgeos import GEOM_PTR
from djmodels.contrib.gis.geos.mutable_list import ListMixin
from djmodels.contrib.gis.geos.prepared import PreparedGeometry
from djmodels.contrib.gis.geos.prototypes.io import (
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of djmodels.utils.tree;
