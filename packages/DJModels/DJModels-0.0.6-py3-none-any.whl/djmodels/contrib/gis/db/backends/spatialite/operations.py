...
"""
from djmodels.contrib.gis.db.backends.base.operations import (
    BaseSpatialOperations,
)
from djmodels.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
from djmodels.contrib.gis.db.backends.utils import SpatialOperator
from djmodels.contrib.gis.db.models import aggregates
from djmodels.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from djmodels.contrib.gis.geos.prototypes.io import wkb_r, wkt_r
from djmodels.contrib.gis.measure import Distance
from djmodels.core.exceptions import ImproperlyConfigured
from djmodels.db.backends.sqlite3.operations import DatabaseOperations
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from djmodels.contrib.gis.db.backends.spatialite.models import SpatialiteGeometryColumns
        return SpatialiteGeometryColumns

    def spatial_ref_sys(self):
        from djmodels.contrib.gis.db.backends.spatialite.models import SpatialiteSpatialRefSys
