...
path_to_labels = os.path.join(site_package_path, 'hand_detection_v3/data/hand_label_map.pbtxt')
path_to_ckpt = os.path.join(site_package_path,'hand_detection_v3/models/hand.our6_rfcnmv_320_500000/frozen_inference_graph.pb')
num_classes = 1
