...
class CostAvoidanceTask(Model):
    ...
    :param reason: The reason for the cost avoidance task. May be any of the
     following:
     * Reset baseline
     * Saved and reprocessed meter
     * Process savings
     * Special adjustment added, edited, or deleted
     * Special adjustment added, edited, or deleted via setup sheet
     * Meter cost avoidance settings globally updated
     * AUC range modified
    :type reason: str
