...
def main():
	...
	for name in files:
		...
		if(bool_stdcurve):
			...
			plot1(fluor, 'H2O2 Standard Curve Data', 'H2O2 Standard Curve.png')
			plot1(atp_xy, 'ATP Standard Curve', 'ATP Standard Curve.png')
		...
		# ----AVERAGES - STANDARD CURVE----
			...
			plot2(slopes_stdcurve, 'H2O2 Standard Curve Slopes Data', 'H2O2 Standard Curve Slopes.png')
			plot2(slopes_stdcurve_atp, 'ATP Standard Curve Slopes Data', 'ATP Standard Curve Slopes.png')
			...
			# Plots averaged standard curve data
			plot2(correct_slopes_stdcurve, 'H2O2 Corrected Standard Curve Slopes Data', 'H2O2 Corrected Standard Curve Slopes.png')
			plot2(correct_slopes_stdcurve_atp, 'ATP Corrected Standard Curve Slopes Data', 'ATP Corrected Standard Curve Slopes.png')
		...
		if(bool_stdcurve):
			fluor.to_excel(writer,('H2O2 Standard Curve'))
			slopes_stdcurve.to_excel(writer,('H2O2 Standard Curve Slopes'))
			correct_slopes_stdcurve.to_excel(writer,('H2O2 Corrected Standard Curve Slopes'))

			atp_xy.to_excel(writer, ('ATP Standard Curve'))
			slopes_stdcurve_atp.to_excel(writer,('ATP Standard Curve Slopes'))
			correct_slopes_stdcurve_atp.to_excel(writer,('ATP Corrected Standard Curve Slopes'))
