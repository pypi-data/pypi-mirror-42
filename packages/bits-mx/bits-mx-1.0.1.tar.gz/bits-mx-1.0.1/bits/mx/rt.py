...
class RT(object):
    ...
    def __init__(self, update):
        ...
        # server hosts
        self.help_host = 'help.broadintitute.org'
    ...
    def get_alias(self, queue, mailhost):
        ...
        correspond_entry = '%s: %s@%s' % (correspond, correspond, mailhost)

        # create comment entry
        comment_entry = '%s: %s@%s' % (comment, comment, mailhost)
    ...
    def get_aliases(self, queues, mailhost):
        ...
        aliases = []
        for qid in sorted(queues, key=lambda x: queues[x]['Name']):
            queue = queues[qid]
