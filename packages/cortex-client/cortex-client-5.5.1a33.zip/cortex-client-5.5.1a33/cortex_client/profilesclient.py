...
class ProfilesClient(_Client):
    ...
    def describeCommit(self, profileId:str, commitId:str):
        """
        Describe a specific commit ...
        :param commitId:
        :return:
        """
        return self._internal_profiles_client.get_commit_by_id(profileId, commitId)
    ...
    def describeAttributeByKey(self, profileId:str, attributeKey:str, commitId:Optional[str]=None) -> Optional[ProfileAttribute]:
        ...
        commit = (
            ...
            if commitId is None else self._internal_profiles_client.get_commit_by_id(profileId, commitId)
        )
        if not commit:
            return None
