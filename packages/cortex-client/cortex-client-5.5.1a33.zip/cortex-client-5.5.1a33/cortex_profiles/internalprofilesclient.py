...
class InternalProfilesClient(_Client):
    ...
    def get_commit_by_id(self, profileId:str, commitId:str) -> Optional[ProfileCommit]:
    ...
    def get_attribute_by_id(self, profileId:str, attributeId:str) -> Optional[ProfileAttribute]:
    ...
    def get_latest_profile_commit(self, profileId:str) -> Optional[ProfileCommit]:
        ...
        if not latest_commit_pointer:
            return None
        return self.get_commit_by_id(profileId, latest_commit_pointer.commitId)
