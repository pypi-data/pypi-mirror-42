...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_4cupy_4core_4core_Indexer = __Pyx_ImportType("cupy.core.core", "Indexer", sizeof(struct __pyx_obj_4cupy_4core_4core_Indexer), 1); if (unlikely(!__pyx_ptype_4cupy_4core_4core_Indexer)) __PYX_ERR(4, 89, __pyx_L1_error)
