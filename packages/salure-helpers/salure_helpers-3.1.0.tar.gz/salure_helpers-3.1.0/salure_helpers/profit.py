...
class UpdateConnector:
    ...
    def new_wage_mutation(self, data: dict, overload_fields={}):
        ...
        required_fields = ['startdate', 'employee_id', 'year', 'month', 'employer_id', 'wage_component_id', 'value']
        ...
        # Add fields that you want to update a dict (adding to body itself is too much text)
        selector_to_update.update({"@PtId": data['period_table']}) if 'period_table' in data else fields_to_update.update({"@PtId": 5})
