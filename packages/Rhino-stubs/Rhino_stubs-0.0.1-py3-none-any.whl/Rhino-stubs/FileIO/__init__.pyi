...
class FilePdfEventArgs:
    ...
    def GetType (self) -> Type: ...
class FilePdf:
    def add_PreWrite (value : EventHandler): ...
    def remove_PreWrite (value : EventHandler): ...
    def Create () -> FilePdf: ...
    def AddPage (self, settings : ViewCaptureSettings) -> int: ...
    def AddPage (self, widthInDots : int, heightInDots : int, dotsPerInch : int) -> int: ...
    def DrawText (self, pageNumber : int, text : str, x : float, y : float, heightPoints : Single, onfont : Font, fillColor : Color, strokeColor : Color, strokeWidth : Single, angleDegrees : Single, horizontalAlignment : TextHorizontalAlignment, verticalAlignment : TextVerticalAlignment): ...
    def DrawPolyline (self, pageNumber : int, polyline : Set(PointF), fillColor : Color, strokeColor : Color, strokeWidth : Single): ...
    def DrawLine (self, pageNumber : int, from_ : PointF, to : PointF, strokeColor : Color, strokeWidth : Single): ...
    def DrawBitmap (self, pageNumber : int, bitmap : Bitmap, left : Single, top : Single, width : Single, height : Single, rotationInDegrees : Single): ...
...
class FilePlyWriteOptions:
    ...
    @ExportASCII.setter
    def ExportASCII (self, value : bool): ...
    @property
    def ExportNormals (self) -> bool: ...
    @ExportNormals.setter
    def ExportNormals (self, value : bool): ...
...
class File3dm:
    ...
    def StartSectionComments (self, value : str): ...
    @property
    def Notes (self) -> File3dmNotes: ...
    @Notes.setter
    def Notes (self, value : File3dmNotes): ...
    @property
    ...
    def ApplicationUrl (self, value : str): ...
    @property
    def ApplicationDetails (self) -> str: ...
    @ApplicationDetails.setter
    def ApplicationDetails (self, value : str): ...
    @property
    ...
    def SetPreviewImage (self, image : Bitmap): ...
    @property
    ...
    def DumpToTextLog (self, log : TextLog): ...
    def Dispose (self): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
...
class File3dmWriteOptions:
    ...
    def SaveRenderMeshes (self, value : bool): ...
    def EnableRenderMeshes (self, objectType : ObjectType, enable : bool): ...
    @property
    def SaveAnalysisMeshes (self) -> bool: ...
    @SaveAnalysisMeshes.setter
    def SaveAnalysisMeshes (self, value : bool): ...
    def EnableAnalysisMeshes (self, objectType : ObjectType, enable : bool): ...
    @property
    def SaveUserData (self) -> bool: ...
    @SaveUserData.setter
    def SaveUserData (self, value : bool): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class ManifestTable:
    ...
    def CopyTo (self, array : Set(ModelComponent), arrayIndex : int): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class File3dmObjectTable:
    ...
    def Add (self, item : File3dmObject): ...
...
class File3dmDimStyleTable:
    ...
    def Delete (self, index : int): ...
    def Add (self, item : DimensionStyle): ...
    def Dump (self) -> str: ...
    @property
    def Count (self) -> int: ...
    def GetEnumerator (self) -> IEnumerator: ...
...
class File3dmHatchPatternTable:
    ...
    def Delete (self, index : int): ...
    def Add (self, item : HatchPattern): ...
    def Dump (self) -> str: ...
    @property
    def Count (self) -> int: ...
    def GetEnumerator (self) -> IEnumerator: ...
...
class File3dmInstanceDefinitionTable:
    ...
    def Delete (self, index : int): ...
    def Add (self, item : InstanceDefinitionGeometry): ...
    def Dump (self) -> str: ...
    @property
    def Count (self) -> int: ...
    def GetEnumerator (self) -> IEnumerator: ...
...
class File3dmViewTable:
    ...
    def Add (self, item : ViewInfo): ...
    def Clear (self): ...
    def Contains (self, item : ViewInfo) -> bool: ...
    def CopyTo (self, array : Set(ViewInfo), arrayIndex : int): ...
    @property
    def Count (self) -> int: ...
...
class File3dmNamedConstructionPlanes:
    ...
    def Add (self, cplane : ConstructionPlane): ...
    def Clear (self): ...
    def Contains (self, cplane : ConstructionPlane) -> bool: ...
    def CopyTo (self, array : Set(ConstructionPlane), arrayIndex : int): ...
    @property
    def Count (self) -> int: ...
    def GetEnumerator (self) -> IEnumerator: ...
    def ToString (self) -> str: ...
...
class File3dmStringTable:
    ...
    def Delete (self, section : str, entry : str): ...
...
class TextLog:
    ...
    @IndentSize.setter
    def IndentSize (self, value : int): ...
    def PrintWrappedText (self, text : str, lineLength : int): ...
    def Print (self, text : str): ...
    def Print (self, format : str, arg0 : Object): ...
    def Print (self, format : str, arg0 : Object, arg1 : Object): ...
    def Dispose (self): ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class FileWriteOptions:
    ...
    @Xform.setter
    def Xform (self, value : Transform): ...
    @property
...
class FileReadOptions:
    ...
    @ImportMode.setter
    def ImportMode (self, value : bool): ...
    @property
    def OpenMode (self) -> bool: ...
    @OpenMode.setter
    def OpenMode (self, value : bool): ...
    @property
    def NewMode (self) -> bool: ...
    @NewMode.setter
    def NewMode (self, value : bool): ...
    @property
    def InsertMode (self) -> bool: ...
    @InsertMode.setter
    def InsertMode (self, value : bool): ...
    @property
    def ImportReferenceMode (self) -> bool: ...
    @ImportReferenceMode.setter
    def ImportReferenceMode (self, value : bool): ...
    @property
    def BatchMode (self) -> bool: ...
    @BatchMode.setter
    def BatchMode (self, value : bool): ...
    @property
    def UseScaleGeometry (self) -> bool: ...
    @UseScaleGeometry.setter
    def UseScaleGeometry (self, value : bool): ...
    @property
    def ScaleGeometry (self) -> bool: ...
    @ScaleGeometry.setter
    def ScaleGeometry (self, value : bool): ...
    def Dispose (self): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
...
class File3dmNotes:
    ...
    def WindowRectangle (self, value : Rectangle): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class BinaryArchiveWriter:
    ...
    def WriteErrorOccured (self, value : bool): ...
    @property
    ...
    def Write3dmChunkVersion (self, major : int, minor : int): ...
    def WriteDictionary (self, dictionary : ArchivableDictionary): ...
    def WriteBool (self, value : bool): ...
    def WriteByte (self, value : Byte): ...
    def WriteSByte (self, value : SByte): ...
    def WriteShort (self, value : Int16): ...
    def WriteUShort (self, value : UInt16): ...
    def WriteInt (self, value : int): ...
    def WriteUInt (self, value : UInt32): ...
    def WriteInt64 (self, value : Int64): ...
    def WriteSingle (self, value : Single): ...
    def WriteDouble (self, value : float): ...
    def WriteGuid (self, value : Guid): ...
    def WriteString (self, value : str): ...
    def WriteUtf8String (self, value : str): ...
    def WriteBoolArray (self, value : Iterable(bool)): ...
    def WriteByteArray (self, value : Iterable(Byte)): ...
    def WriteCompressedBuffer (self, value : Iterable(Byte)): ...
    def WriteSByteArray (self, value : Iterable(SByte)): ...
    def WriteShortArray (self, value : Iterable(Int16)): ...
    def WriteIntArray (self, value : Iterable(int)): ...
    def WriteSingleArray (self, value : Iterable(Single)): ...
    def WriteDoubleArray (self, value : Iterable(float)): ...
    def WriteGuidArray (self, value : Iterable(Guid)): ...
    def WriteStringArray (self, value : Iterable(str)): ...
    def WriteColor (self, value : Color): ...
    def WritePoint (self, value : Point): ...
    def WritePointF (self, value : PointF): ...
    def WriteRectangle (self, value : Rectangle): ...
    def WriteRectangleF (self, value : RectangleF): ...
    def WriteSize (self, value : Size): ...
    def WriteSizeF (self, value : SizeF): ...
    def WriteFont (self, value : Font): ...
    def WriteObjRef (self, objref : ObjRef): ...
    def WriteObjRefArray (self, objrefs : Iterable(ObjRef)): ...
    def WriteGeometryArray (self, geometry : Iterable(GeometryBase)): ...
    def WriteInterval (self, value : Interval): ...
    def WritePoint2d (self, value : Point2d): ...
    def WritePoint3d (self, value : Point3d): ...
    def WritePoint4d (self, value : Point4d): ...
    def WriteVector2d (self, value : Vector2d): ...
    def WriteVector3d (self, value : Vector3d): ...
    def WriteBoundingBox (self, value : BoundingBox): ...
    def WriteRay3d (self, value : Ray3d): ...
    def WriteTransform (self, value : Transform): ...
    def WritePlane (self, value : Plane): ...
    def WriteLine (self, value : Line): ...
    def WritePoint3f (self, value : Point3f): ...
    def WriteVector3f (self, value : Vector3f): ...
    def WriteMeshingParameters (self, value : MeshingParameters): ...
    def WriteGeometry (self, value : GeometryBase): ...
    def WriteRenderSettings (self, value : RenderSettings): ...
    def WriteEmptyCheckSum (self): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class BinaryArchiveReader:
    ...
    def ReadErrorOccured (self, value : bool): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class SerializationOptions:
    ...
    @RhinoVersion.setter
    def RhinoVersion (self, value : int): ...
    @property
    def WriteUserData (self) -> bool: ...
    @WriteUserData.setter
    def WriteUserData (self, value : bool): ...
