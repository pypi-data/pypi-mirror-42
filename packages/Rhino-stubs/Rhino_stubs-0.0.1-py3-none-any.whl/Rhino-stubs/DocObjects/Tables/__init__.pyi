...
class RuntimeDocumentDataTable:
    ...
    @Item.setter
    def Item (self, key : Object, value : Object): ...
...
class ViewTable:
    ...
    @ActiveView.setter
    def ActiveView (self, value : RhinoView): ...
    def IsCameraIconVisible (self, view : RhinoView) -> bool: ...
    def EnableCameraIcon (self, view : RhinoView): ...
    def FlashObjects (self, list : Iterable(RhinoObject), useSelectionColor : bool): ...
    def Redraw (self): ...
    ...
    def FourViewLayout (self, useMatchingViews : bool): ...
    def ThreeViewLayout (self, useMatchingViews : bool): ...
    @property
    def RedrawEnabled (self) -> bool: ...
    @RedrawEnabled.setter
    def RedrawEnabled (self, value : bool): ...
...
class ObjectTable:
    ...
    def AddRhinoObject (self, meshObject : CustomMeshObject): ...
    def AddRhinoObject (self, meshObject : CustomMeshObject, history : HistoryRecord): ...
    def AddRhinoObject (self, meshObject : MeshObject, mesh : Mesh): ...
    def AddRhinoObject (self, brepObject : CustomBrepObject): ...
    def AddRhinoObject (self, brepObject : CustomBrepObject, history : HistoryRecord): ...
    def AddRhinoObject (self, brepObject : BrepObject, brep : Brep): ...
    def AddRhinoObject (self, pointObject : CustomPointObject): ...
    def AddRhinoObject (self, pointObject : CustomPointObject, history : HistoryRecord): ...
    def AddRhinoObject (self, pointObject : PointObject, point : Point): ...
    def AddRhinoObject (self, curveObject : CurveObject, curve : Curve): ...
    def AddRhinoObject (self, curveObject : CustomCurveObject, history : HistoryRecord): ...
...
class HatchPatternTable:
    ...
    def CurrentHatchPatternIndex (self, value : int): ...
    @property
    def ComponentType (self) -> ModelComponentType: ...
...
class InstanceDefinitionTable:
    ...
    def Compact (self, ignoreUndoReferences : bool): ...
...
class LinetypeTable:
    ...
    def CurrentLinetypeSource (self, value : ObjectLinetypeSource): ...
...
class MaterialTable:
    ...
    def CurrentMaterialIndex (self, value : int): ...
    @property
    def CurrentMaterialSource (self) -> ObjectMaterialSource: ...
    @CurrentMaterialSource.setter
    def CurrentMaterialSource (self, value : ObjectMaterialSource): ...
    @property
    def ComponentType (self) -> ModelComponentType: ...
    def Add (self) -> int: ...
