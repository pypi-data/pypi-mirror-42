...
class SimpleArrayMeshPointer:
    ...
    @property
    def Count (self) -> int: ...
    def Add (self, mesh : Mesh, asConst : bool): ...
    def Dispose (self): ...
...
class SimpleArrayBrepPointer:
    ...
    @property
    def Count (self) -> int: ...
    def Add (self, brep : Brep, asConst : bool): ...
    def Dispose (self): ...
...
class SimpleArrayExtrusionPointer:
    ...
    @property
    def Count (self) -> int: ...
    def Add (self, extrusion : Extrusion, asConst : bool): ...
    def Dispose (self): ...
...
class SimpleArrayBinaryArchiveReader:
    ...
    def ConstPointer (self) -> IntPtr: ...
    def NonConstPointer (self) -> IntPtr: ...
    def Add (self, reader : BinaryArchiveReader): ...
    @property
    def Count (self) -> int: ...
...
class SimpleArrayClippingPlaneObjectPointer:
    ...
    @property
    def Count (self) -> int: ...
    def Add (self, clippingplane : ClippingPlaneObject, asConst : bool): ...
    def Dispose (self): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
...
class StringWrapper:
    ...
    def SetStringOnPointer (pON_wString : IntPtr, s : str): ...
