...
class GumballObject:
    ...
    @Frame.setter
    def Frame (self, value : GumballFrame): ...
...
class GumballDisplayConduit:
    ...
    @PreTransform.setter
    def PreTransform (self, value : Transform): ...
    @property
    ...
    def SetBaseGumball (self, gumball : GumballObject): ...
    def SetBaseGumball (self, gumball : GumballObject, appearanceSettings : GumballAppearanceSettings): ...
...
class GumballFrame:
    ...
    def ScaleGripDistance (self, value : Vector3d): ...
    @property
    def ScaleMode (self) -> GumballScaleMode: ...
    @ScaleMode.setter
    def ScaleMode (self, value : GumballScaleMode): ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def ToString (self) -> str: ...
    def GetType (self) -> Type: ...
