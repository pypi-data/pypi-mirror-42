...
class BrepFaceList:
    ...
    def Flip (self, onlyReversedFaces : bool): ...
    def RemoveAt (self, faceIndex : int): ...
...
class MeshVertexList:
    ...
    @Item.setter
    def Item (self, index : int, value : Point3f): ...
    @property
    def UseDoublePrecisionVertices (self) -> bool: ...
    @UseDoublePrecisionVertices.setter
    def UseDoublePrecisionVertices (self, value : bool): ...
    def Clear (self): ...
    def Destroy (self): ...
    ...
    def AddVertices (self, vertices : Iterable(Point3d)): ...
    def AddVertices (self, vertices : Iterable(Point3f)): ...
    ...
    def Hide (self, vertexIndex : int): ...
    def Show (self, vertexIndex : int): ...
    def HideAll (self): ...
    def ShowAll (self): ...
...
class MeshVertexNormalList:
    ...
    @Item.setter
    def Item (self, index : int, value : Vector3f): ...
    def Clear (self): ...
    def Destroy (self): ...
    def Add (self, x : Single, y : Single, z : Single) -> int: ...
    def Add (self, x : float, y : float, z : float) -> int: ...
...
class MeshFaceList:
    ...
    def Insert (self, index : int, face : MeshFace): ...
    ...
    @Item.setter
    def Item (self, index : int, value : MeshFace): ...
    ...
    def RemoveAt (self, index : int, compact : bool): ...
...
class MeshNgonList:
    ...
    def UnsignedCount (self, value : UInt32): ...
    def Clear (self): ...
...
class MeshVertexColorList:
    ...
    @Item.setter
    def Item (self, index : int, value : Color): ...
    @property
    def Tag (self) -> MappingTag: ...
    @Tag.setter
    def Tag (self, value : MappingTag): ...
    def Clear (self): ...
...
class MeshTextureCoordinateList:
    ...
    @Item.setter
    def Item (self, index : int, value : Point2f): ...
    def Clear (self): ...
...
class MeshVertexStatusList:
    ...
    @Item.setter
    def Item (self, index : int, value : bool): ...
    def Clear (self): ...
    def Add (self, hidden : bool): ...
    def AddRange (self, values : Iterable(bool)): ...
    def Destroy (self): ...
    def Contains (self, hidden : bool) -> bool: ...
    def CopyTo (self, array : Set(bool), arrayIndex : int): ...
    def GetEnumerator (self) -> IEnumerator: ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
...
class NurbsCurveKnotList:
    ...
    def CopyTo (self, array : Set(float), arrayIndex : int): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class NurbsCurvePointList:
    ...
    @Item.setter
    def Item (self, index : int, value : ControlPoint): ...
    @property
    ...
    def CopyTo (self, array : Set(ControlPoint), arrayIndex : int): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
