...
class Point3dList:
    ...
    def SetAllX (self, xValue : float): ...
    def SetAllY (self, yValue : float): ...
    def SetAllZ (self, zValue : float): ...
    ...
    @Item.setter
    def Item (self, index : int, value : Point3d): ...
    @property
    def First (self) -> Point3d: ...
    @First.setter
    def First (self, value : Point3d): ...
    @property
    def Last (self) -> Point3d: ...
    @Last.setter
    def Last (self, value : Point3d): ...
    def RemapIndex (self, index : int) -> int: ...
    def Clear (self): ...
    def Add (self, item : Point3d): ...
    def AddRange (self, collection : Iterable(Point3d)): ...
    def AddRange (self, collection : IEnumerable): ...
    def Insert (self, index : int, item : Point3d): ...
    def InsertRange (self, index : int, collection : Iterable(Point3d)): ...
    ...
    def Sort (self, keys : Set(float)): ...
    def Sort (self, keys : Set(int)): ...
    def Reverse (self): ...
    ...
    def CopyTo (self, array : Set(Point3d)): ...
    def CopyTo (self, array : Set(Point3d), arrayIndex : int): ...
    def CopyTo (self, index : int, array : Set(Point3d), arrayIndex : int, count : int): ...
...
class CurveList:
    ...
    def Add (self, polyline : Iterable(Point3d)): ...
    def Add (self, ellipse : Ellipse): ...
    def Insert (self, index : int, line : Line): ...
    def Insert (self, index : int, circle : Circle): ...
    def Insert (self, index : int, arc : Arc): ...
    def Insert (self, index : int, polyline : Iterable(Point3d)): ...
    def Insert (self, index : int, ellipse : Ellipse): ...
    ...
    @Item.setter
    def Item (self, index : int, value : Curve): ...
    @property
    def First (self) -> Curve: ...
    @First.setter
    def First (self, value : Curve): ...
    @property
    def Last (self) -> Curve: ...
    @Last.setter
    def Last (self, value : Curve): ...
    def RemapIndex (self, index : int) -> int: ...
    def Clear (self): ...
    def Add (self, item : Curve): ...
    def AddRange (self, collection : Iterable(Curve)): ...
    def AddRange (self, collection : IEnumerable): ...
    def Insert (self, index : int, item : Curve): ...
    def InsertRange (self, index : int, collection : Iterable(Curve)): ...
    ...
    def AsReadOnly (self) -> ReadOnlyCollection: ...
    def ConvertAll (self, converter : Converter) -> RhinoList: ...
    def CopyTo (self, array : Set(Curve)): ...
    def CopyTo (self, array : Set(Curve), arrayIndex : int): ...
    def CopyTo (self, index : int, array : Set(Curve), arrayIndex : int, count : int): ...
    def Duplicate (self) -> RhinoList: ...
    def GetEnumerator (self) -> IEnumerator: ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
...
class TransformObjectList:
    ...
    def DisplayFeedbackEnabled (self, value : bool): ...
    ...
    def Add (self, rhinoObject : RhinoObject): ...
    def Add (self, objref : ObjRef): ...
...
class ArchivableDictionary:
    ...
    @Item.setter
    def Item (self, key : str, value : Object): ...
    def Clear (self): ...
...
class XAccess:
    ...
    @Item.setter
    def Item (self, index : int, value : float): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
