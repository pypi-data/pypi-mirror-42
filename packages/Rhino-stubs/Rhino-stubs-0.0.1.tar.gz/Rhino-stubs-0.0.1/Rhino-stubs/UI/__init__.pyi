...
class IPanelsService:
    ...
    def DestroyNativeWindow (self, host : Object, nativeObject : Object, disposeOfNativeObject : bool): ...
    def SetF1Hook (self, nativeObject : Object, hook : EventHandler): ...
class PanelIds:
    @property
    def Materials () -> Guid: ...
    @property
    ...
    def GetType (self) -> Type: ...
class IPanel:
    def PanelShown (self, documentSerialNumber : UInt32, reason : ShowPanelReason): ...
    def PanelHidden (self, documentSerialNumber : UInt32, reason : ShowPanelReason): ...
    def PanelClosing (self, documentSerialNumber : UInt32, onCloseDocument : bool): ...
class Panels:
    def IsShowing (reason : ShowPanelReason) -> bool: ...
    def IsHiding (reason : ShowPanelReason) -> bool: ...
    def RegisterPanel (plugIn : PlugIn, type : Type, caption : str, icon : Icon, panelType : PanelType): ...
    def RegisterPanel (plugin : PlugIn, panelType : Type, caption : str, icon : Icon): ...
    @property
    def IconSize () -> Size: ...
    @property
    def ScaledIconSize () -> Size: ...
    def ChangePanelIcon (panelType : Type, icon : Icon): ...
    ...
    def OpenPanel (panelId : Guid): ...
    def OpenPanel (panelId : Guid, makeSelectedPanel : bool): ...
    def OpenPanel (panelType : Type): ...
    def OpenPanel (panelType : Type, makeSelectedPanel : bool): ...
    ...
    def ClosePanel (panelId : Guid): ...
    def ClosePanel (panelType : Type): ...
    def GetOpenPanelIds () -> Set(Guid): ...
    def OnShowPanel (panelId : Guid, documentSerialNumber : UInt32, show : bool): ...
    def add_Show (value : EventHandler): ...
    def remove_Show (value : EventHandler): ...
    def OnClosePanel (panelId : Guid, documentSerialNumber : UInt32): ...
    def add_Closed (value : EventHandler): ...
    def remove_Closed (value : EventHandler): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class ObjectPropertiesPage:
    ...
    def OnCreateParent (self, hwndParent : IntPtr): ...
    def OnSizeParent (self, width : int, height : int): ...
    ...
    def InitializeControls (self, rhObj : RhinoObject): ...
    def UpdatePage (self, e : ObjectPropertiesPageEventArgs): ...
    def ModifyPage (self, callbackAction : Action): ...
    @property
...
class OptionsDialogPage:
    ...
    def AddChildPage (self, pageToAdd : StackedDialogPage): ...
    @property
    ...
    def RemovePage (self): ...
    def MakeActivePage (self): ...
    @property
    def PageControl (self) -> Object: ...
    def OnCreateParent (self, hwndParent : IntPtr): ...
    def OnSizeParent (self, width : int, height : int): ...
    def SetEnglishPageTitle (self, newPageTile : str): ...
    @property
    def EnglishPageTitle (self) -> str: ...
    @property
    def LocalPageTitle (self) -> str: ...
    ...
    def NavigationTextIsBold (self, value : bool): ...
    @property
    def NavigationTextColor (self) -> Color: ...
    @NavigationTextColor.setter
    def NavigationTextColor (self, value : Color): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class MouseCursor:
    def SetToolTip (tooltip : str): ...
    @property
    ...
    def GetType (self) -> Type: ...
class StatusBar:
    def SetDistancePane (distance : float): ...
    def SetNumberPane (number : float): ...
    def SetPointPane (point : Point3d): ...
    def SetMessagePane (message : str): ...
    ...
    def HideProgressMeter (docSerialNumber : UInt32): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class IStackedDialogPageService:
    ...
    def RedrawPageControl (self, pageControl : Object): ...
...
class Toolbar:
    ...
    def BitmapSize () -> Size: ...
    @BitmapSize.setter
    def BitmapSize (value : Size): ...
    @property
    def TabSize () -> Size: ...
    @TabSize.setter
    def TabSize (value : Size): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
...
class ToolbarFileCollection:
    ...
    def SidebarIsVisible (value : bool): ...
    @property
    def MruSidebarIsVisible () -> bool: ...
    @MruSidebarIsVisible.setter
    def MruSidebarIsVisible (value : bool): ...
    def ToString (self) -> str: ...
    def Equals (self, obj : Object) -> bool: ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class RuiUpdateUi:
    ...
    @RadioChecked.setter
    def RadioChecked (self, value : bool): ...
    @property
...
class ILocalizationService:
    ...
    def LocalizeForm (self, assembly : Assembly, languageId : int, formOrUserControl : Object): ...
...
class Localization:
    ...
    def LocalizeForm (formOrUserControl : Object): ...
...
class GetColorEventArgs:
    ...
    def SelectedColor (self, value : Color): ...
    @property
...
class ShowMessageMode:
    ...
    TaskModal = 8192
class Dialogs:
    def ShowAboutDialog (forceSimpleDialog : bool): ...
    def ShowContextMenu (items : Iterable(str), screenPoint : Point, modes : Iterable(int)) -> int: ...
    def SetCustomColorDialog (handler : EventHandler): ...
    def KillSplash (): ...
    def ShowSemiModal (form : Form) -> DialogResult: ...
    def ShowTextDialog (message : str, title : str): ...
...
class UpdateMenuItemEventHandler:
    ...
    def Invoke (self, sender : Object, cmdui : RuiUpdateUi): ...
