...
class UserData:
    ...
    def Copy (source : CommonObject, destination : CommonObject): ...
    def MoveUserDataFrom (objectWithUserData : CommonObject) -> Guid: ...
    def MoveUserDataTo (objectToGetUserData : CommonObject, id : Guid, append : bool): ...
    @property
...
class CustomBrepObject:
    ...
    def RenderMaterial (self, value : RenderMaterial): ...
    ...
    def SetCustomRenderMeshParameter (self, providerId : Guid, parameterName : str, value : Object): ...
    ...
    @Attributes.setter
    def Attributes (self, value : ObjectAttributes): ...
    @property
    ...
    def Description (self, textLog : TextLog): ...
...
class GripsDrawEventArgs:
    ...
    def ControlPolygonStyle (self, value : int): ...
    @property
    def GripColor (self) -> Color: ...
    @GripColor.setter
    def GripColor (self, value : Color): ...
    @property
    def LockedGripColor (self) -> Color: ...
    @LockedGripColor.setter
    def LockedGripColor (self, value : Color): ...
    @property
    def SelectedGripColor (self) -> Color: ...
    @SelectedGripColor.setter
    def SelectedGripColor (self, value : Color): ...
    @property
    def GripStatusCount (self) -> int: ...
    def GripStatus (self, index : int) -> GripStatus: ...
    def DrawControlPolygonLine (self, line : Line, startStatus : GripStatus, endStatus : GripStatus): ...
    def DrawControlPolygonLine (self, line : Line, startStatus : int, endStatus : int): ...
    def DrawControlPolygonLine (self, start : Point3d, end : Point3d, startStatus : int, endStatus : int): ...
...
class TurnOnGripsEventHandler:
    ...
    def Invoke (self, rhObj : RhinoObject): ...
...
class CustomObjectGrips:
    def RegisterGripsEnabler (enabler : TurnOnGripsEventHandler, customGripsType : Type): ...
    @property
    ...
    @NewLocation.setter
    def NewLocation (self, value : bool): ...
    @property
...
class CustomGripObject:
    ...
    def OriginalLocation (self, value : Point3d): ...
    @property
    ...
    def CurrentLocation (self, value : Point3d): ...
    @property
    def OriginalLocation (self) -> Point3d: ...
    @property
    def Moved (self) -> bool: ...
    def Move (self, xform : Transform): ...
    def Move (self, delta : Vector3d): ...
    def Move (self, newLocation : Point3d): ...
    def UndoMove (self): ...
    @property
