...
from suanpan.components import Component, Arguments
...
class Stream(interfaces.HasBaseServices, interfaces.HasLogger, interfaces.HasDevMode):
    ...
    STREAM_ARGUMENTS = [
        ...
        String("stream-send-queue-max-length", default=1000),
    ]
    ...
    def send(self, message, data, queue=None, extra=None):
        ...
        return mq.sendMessage(queue, data, maxlen=self.options["sendQueueMaxLength"])
