...
def ipclean():
    ...
    if args.s:
        parapheur.setconfigproperty("Ipclean", "url", args.s)
    if args.P:
        parapheur.setconfigproperty("Ipclean", "port", args.P)
    if args.u:
        parapheur.setconfigproperty("Ipclean", "name", args.u)
    if args.p:
        parapheur.setconfigproperty("Ipclean", "password", args.p)
