...
def ipclean():
    ...
    parser.add_argument('-f', help='Fichier de propriété')
    parser.add_argument('-h', help='URL de la base de données')
    parser.add_argument('-P', help='Port de la base de données')
    parser.add_argument('-u', help='Nom de la base de données')
    parser.add_argument('-p', help='Mot de passe de la base de données')

    args = parser.parse_args()

    if args.c:
        parapheur.setconfig(args.f)
    if args.s:
        parapheur.setconfigproperty("Database", "url", args.h)
    if args.u:
        parapheur.setconfigproperty("Database", "port", args.P)
    if args.p:
        parapheur.setconfigproperty("Database", "name", args.u)
    if args.i:
        parapheur.setconfigproperty("Database", "password", args.p)
