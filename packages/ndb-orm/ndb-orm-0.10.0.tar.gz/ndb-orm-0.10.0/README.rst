...
|Travis CI| |Python versions| |Apache License 2.0|
...
Most property types should work just fine. Even the StructuredProperty
...
.. |Travis CI| image:: https://travis-ci.org/berlincode/ndb-orm.svg?branch=master&style=flat
   :target: https://travis-ci.org/berlincode/ndb-orm
.. |Python versions| image:: https://img.shields.io/pypi/pyversions/ndb-orm.svg
   :target: https://pypi.python.org/pypi/ndb-orm/
.. |Apache License 2.0| image:: https://img.shields.io/pypi/l/ndb-orm.svg
   :target: https://github.com/berlincode/ndb-orm/blob/master/LICENSE.txt
