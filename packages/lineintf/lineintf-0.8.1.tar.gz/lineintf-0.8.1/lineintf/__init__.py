...
class LineIntf:
    ...
    def new_message(self, the_message, **options):
        rtn = messagebox.showinfo(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn

    def new_error(self, the_message, **options):
        rtn = messagebox.showerror(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn

    def new_warning(self, the_message, **options):
        rtn = messagebox.showwarning(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn

    def new_string(self, the_message, **options):
        rtn = simpledialog.askstring(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn

    def new_integer(self, the_message, **options):
        rtn = simpledialog.askinteger(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn

    def new_float(self, the_message, **options):
        rtn = simpledialog.askfloat(self.li_title, the_message, **options)
        if hasattr(self.root, 'focus_force'):
            self.root.focus_force()
        return rtn
