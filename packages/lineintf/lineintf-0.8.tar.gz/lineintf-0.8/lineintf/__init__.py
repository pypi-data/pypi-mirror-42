...
class LineIntf:
    ...
    def new_line(self):
        self.__last_line = Frame(self.root.contentWindow, pady=8)
    ...
    def new_message(self, the_message, **options):
        return messagebox.showinfo(self.li_title, the_message, **options)

    def new_error(self, the_message, **options):
        return messagebox.showerror(self.li_title, the_message, **options)

    def new_warning(self, the_message, **options):
        return messagebox.showwarning(self.li_title, the_message, **options)

    def new_string(self, the_message, **options):
        return simpledialog.askstring(self.li_title, the_message, **options)

    def new_integer(self, the_message, **options):
        return simpledialog.askinteger(self.li_title, the_message, **options)

    def new_float(self, the_message, **options):
        return simpledialog.askfloat(self.li_title, the_message, **options)
