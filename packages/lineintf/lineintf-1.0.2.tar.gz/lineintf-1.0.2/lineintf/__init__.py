...
class LineIntf:
    ...
    def __init__(self, master, with_title=None):
        ...
        self.root.contentFrame.pack(side=LEFT, padx=12, pady=12, fill="y", anchor="nw")
        self.new_line()

    def new_barer(self):
        new_barer = Frame(self.root, width=2, bg="SystemWindowText")
        new_barer.pack(side=LEFT, padx=0, pady=12, fill="y", anchor="nw")
        return new_barer
