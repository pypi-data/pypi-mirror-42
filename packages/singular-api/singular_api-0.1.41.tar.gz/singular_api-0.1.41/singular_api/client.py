...
class Client:
    ...
    def __init__(self, singular_token=None, singular_url=SINGULAR_URL,
                 ...
                 client_secret=None, singular_internal_url=SINGULAR_INTERNAL_URL):
...
client_secret (optional) -- used to refresh token(see OpenID"""
        ...
        self._singular_internal_url = singular_internal_url
...
state -- oauth state interpreted by app"""
    ...
    def register_user(self, client_id, client_secret, code, redirect_uri, verify_ssl=True, headers=None):
...
-d "refresh_token=58dae7dc2c9d41748aebb9520256a5d5"
    ...
    def _call_singular(self, url, method, params=None, json_body=None,
                       encoded_body=None, request_headers=None, verify_ssl=True):
...
request_headers (optional) -- HTTP request headers"""
        url = self._singular_internal_url + url
        ...
        def try_request():
            if json_body is not None:
                ...
                response = requests.request(method, url, json=json_body,
                                            ...
                                            timeout=timeouts, verify=verify_ssl)
                ...
                response = requests.request(method, url, headers=headers,
                                            params=params, timeout=timeouts, verify=verify_ssl)
            return response
