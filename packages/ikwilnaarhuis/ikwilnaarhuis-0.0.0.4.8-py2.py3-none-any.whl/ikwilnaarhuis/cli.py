...
def main():
  ...
  if args.time == None:
    ...
    print(colored("Script executed without specified time, using current time of day.", 'red'))
  ...
  print(colored("You are allowed to leave at " + leave.strftime("%H:%M") + ", you " + insults.long_insult() + ".", 'red'))
