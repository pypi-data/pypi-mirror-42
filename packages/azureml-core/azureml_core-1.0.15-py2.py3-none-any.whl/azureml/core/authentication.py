...
class AbstractAuthentication(object):
    ...
    def _perform_subscription_check(self, subscription_id):
        ...
        _check_if_subscription_exists(self, subscription_id, all_subscription_list, tenant_id)
...
def _check_if_subscription_exists(auth, subscription_id, subscription_id_list, tenant_id):
