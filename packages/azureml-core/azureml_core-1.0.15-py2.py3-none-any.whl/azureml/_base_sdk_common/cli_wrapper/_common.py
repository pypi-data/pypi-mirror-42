...
def get_workspace_or_default_name(workspace_name, throw_error=False, auth=None, project_path=None):
    ...
    if not workspace_name:
        ...
        if project_object:
            return project_object.workspace_object.name
...
def get_resource_group_or_default_name(resource_group_name, throw_error=False, auth=None, project_path=None):
    ...
    if not resource_group_name:
        project_object = _get_project_object(auth=auth, project_path=project_path)
        if project_object:
            return project_object.workspace_object.resource_group
...
def _get_project_object(auth=None, project_path=None):
    ...
    if project_object:
        if project_object.workspace_object.subscription_id != default_subscription_id:
