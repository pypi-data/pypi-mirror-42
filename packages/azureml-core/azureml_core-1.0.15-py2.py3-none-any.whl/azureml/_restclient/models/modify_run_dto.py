...
class ModifyRunDto(Model):
    ...
    def __init__(self, name=None, data_container_id=None, description=None, hidden=None, run_type=None, properties=None, script_name=None, target=None, tags=None, run_definition=None):
