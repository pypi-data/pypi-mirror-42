...
class LegacyRunOperations(object):
    ...
    def list(
            self, subscription_id, resource_group_name, workspace_name, project_name, filter=None, continuationtoken=None, orderby=None, sortorder=None, top=None, count=None, custom_headers=None, raw=False, **operation_config):
        """
