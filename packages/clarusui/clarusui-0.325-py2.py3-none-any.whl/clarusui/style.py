...
class DarkStyle(Style):
    def __init__(self, **options):
        super(DarkStyle, self).__init__(backgroundColour='#000000', 
                                        foregroundColour='#111111', fontColour='white', borderColour='#3E3E3E', tableCssClass='table-inverse', **options)
        
class DarkBlueStyle(Style):
    def __init__(self, **options):
        super(DarkBlueStyle, self).__init__(backgroundColour='#252830', 
                                            foregroundColour='#111111', fontColour='white', borderColour='#434857', tableCssClass='table-inverse', **options)

class LightStyle(Style):
    def __init__(self, **options):
        super(LightStyle, self).__init__(backgroundColour='white', 
                                         foregroundColour='white', fontColour='#555555', borderColour='#e9ecef', **options)

def getAutoStyle(event, colours):
    if event is None or event.get('__theme') != 'dark':
