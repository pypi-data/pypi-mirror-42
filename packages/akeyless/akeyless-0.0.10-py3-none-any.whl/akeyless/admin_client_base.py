...
import six
from akeyless_uam_api import GetAccountDetailsReplyObj, GetUserReplyObj, GetRoleReplyObj, GetUserItemsReplyObj, \
    GetAccountRolesReplyObj, GetAccountUsersReplyObj
