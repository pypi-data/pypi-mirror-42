from tokenizer.tokenize_sentence import tokenize_sentence
import pytest
...
def test_tokenize_sentance(sentance, tokens):
    tokens_found, _,_ = tokenize_sentence(sentance,'DE')
...
def test_tokenize_sentance_indexes(sentance, indexes):
    _, indexes_found,_ = tokenize_sentence(sentance,'DE')
...
@pytest.mark.parametrize("sentance, indexes", testdata)
def test_tokenize_sentance_indexes(sentance, indexes):
    _, _, indexes_found = tokenize_sentence(sentance,'DE')
    assert indexes_found == indexes
