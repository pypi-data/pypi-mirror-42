...
function GetOciSubcommands_compute_management() {
    $ociSubcommands = @{
        ...
        'compute-management instance-pool' = 'create get list list-instances reset softreset start stop terminate update'
    }
...
function GetOciCommandsToLongParams_compute_management() {
    $ociCommandsToLongParams = @{
        ...
        'compute-management instance-pool create' = 'compartment-id defined-tags display-name freeform-tags from-json help instance-configuration-id max-wait-seconds placement-configurations size wait-for-state wait-interval-seconds'
