...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        'iam' = 'auth-token availability-domain compartment customer-secret-key dynamic-group fault-domain group identity-provider-group mfa-totp-device policy region region-subscription scim-client-credentials smtp-credential tag tag-namespace user work-request'
