...
class ShipApi(object):
    ...
    def cancel_ship_with_http_info(self, carrier, order_ref, **kwargs):  # noqa: E501
        ...
        all_params = ['carrier', 'order_ref', 'body']  # noqa: E501
        ...
        if ('carrier' not in params or
                params['carrier'] is None):
            raise ValueError("Missing the required parameter `carrier` when calling `cancel_ship`")  # noqa: E501
        # verify the required parameter 'order_ref' is set
        if ('order_ref' not in params or
                params['order_ref'] is None):
            raise ValueError("Missing the required parameter `order_ref` when calling `cancel_ship`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'carrier' in params:
            path_params['carrier'] = params['carrier']  # noqa: E501
        if 'order_ref' in params:
            path_params['order_ref'] = params['order_ref']  # noqa: E501
    ...
    def query_ship_with_http_info(self, carrier, order_ref, **kwargs):  # noqa: E501
        ...
        if ('carrier' not in params or
                params['carrier'] is None):
            raise ValueError("Missing the required parameter `carrier` when calling `query_ship`")  # noqa: E501
        # verify the required parameter 'order_ref' is set
        if ('order_ref' not in params or
                params['order_ref'] is None):
            raise ValueError("Missing the required parameter `order_ref` when calling `query_ship`")  # noqa: E501
        ...
        query_params = []
        if 'seller_order_ref' in params:
            query_params.append(('seller_order_ref', params['seller_order_ref']))  # noqa: E501
    ...
    def ship(self, carrier, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ship(carrier, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str carrier: Carrier to ship with (required)
        :param Package body: Package to ship (required)
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ship_with_http_info(carrier, body, **kwargs)  # noqa: E501
        else:
            (data) = self.ship_with_http_info(carrier, body, **kwargs)  # noqa: E501
            return data

    def ship_with_http_info(self, carrier, body, **kwargs):  # noqa: E501
        """Create a new waybill  # noqa: E501

        Requests waybill creation from specified carrier. Receives waybill details in return, most carriers provide id and PDF packing label  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ship_with_http_info(carrier, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['carrier', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('carrier' not in params or
                params['carrier'] is None):
            raise ValueError("Missing the required parameter `carrier` when calling `ship`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `ship`")  # noqa: E501
