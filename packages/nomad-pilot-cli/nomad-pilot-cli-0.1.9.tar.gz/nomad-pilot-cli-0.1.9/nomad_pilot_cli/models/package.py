...
class Package(object):
    ...
    def __init__(self, dimension=None, items=None, ship_from=None, ship_to=None, bill=None, order_ref=None, seller_order_ref=None, order_time=None, gross_weight=None, net_weight=None, total_price=None, currency=None, mass_unit='Kilogram'):  # noqa: E501
