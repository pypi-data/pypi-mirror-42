...
#
# Generated Tue Feb 12 18:05:39 2019 by generateDS.py version 2.30.11.
...
#
# Command line:
#   /var/lib/jenkins/jobs/new-init/workspace/opennebula-5.7.90/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class TEMPLATEType106Sub(TemplatedType, supermod.TEMPLATEType106):
    def __init__(self, VCENTER_FROM_WILD=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType106Sub, self).__init__(VCENTER_FROM_WILD, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, VCENTER_TEMPLATE_REF, anytypeobjs_,  **kwargs_)
