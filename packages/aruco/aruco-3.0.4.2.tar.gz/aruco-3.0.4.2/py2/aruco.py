...
def CvDrawingUtils_draw3dCube(Image, m, CP, setYperpendicular=False):
...
class Dictionary(_object):
    ...
    def getMarkerImage_id(self, id, bit_size, addWaterMark=True, enclosed_corners=False, printExternalWhiteBorder=False):
...
class Params(_object):
    ...
    def setThresholdMethod(self, method, thresHold=-1, wsize=15, wsize_range=0):
    ...
    def setAutoSizeSpeedUp(self, v, ts=0.25):
        return _aruco.Params_setAutoSizeSpeedUp(self, v, ts)

    def getAutoSizeSpeedUp(self):
...
class MarkerDetector(_object):
    ...
    def warp(self, arg2, out, size, points):
...
class MarkerPoseTracker(_object):
    ...
    def estimatePose(self, m, cam_params, markerSize, minErrorRatio=4):
...
class DictionaryBased(MarkerLabeler):
    ...
    def setParams(self, dic, max_correction_rate):
