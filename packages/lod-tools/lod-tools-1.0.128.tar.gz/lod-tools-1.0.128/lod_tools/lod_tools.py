...
subparser.add_argument('-red', '--required-external-domains', nargs='+', default=None,
    help="A list of internet domains the Program needs access to. If none are given, defaults to the content of the file 'DOMAINS.txt' stored in the folder that is being uploaded. If no such file exists, the Program is marked as requiring no external domains.")
