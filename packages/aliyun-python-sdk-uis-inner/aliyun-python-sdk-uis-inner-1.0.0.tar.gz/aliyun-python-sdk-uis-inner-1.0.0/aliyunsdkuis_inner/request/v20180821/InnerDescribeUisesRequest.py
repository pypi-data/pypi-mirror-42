...
class InnerDescribeUisesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Uis-inner', '2018-08-21', 'InnerDescribeUises','uis')
	...
	def get_UisConnId(self):
		return self.get_query_params().get('UisConnId')

	def set_UisConnId(self,UisConnId):
		self.add_query_param('UisConnId',UisConnId)
