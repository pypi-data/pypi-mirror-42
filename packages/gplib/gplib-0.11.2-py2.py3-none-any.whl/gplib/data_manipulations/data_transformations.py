...
class DataTransformation(object):
    ...
    def scale(self, data, inv=False):
        ...
        return {
            key: DataTransformation._scale(
                value,
                self.transform_matrices_dict[key],
                inv
            )
            for key, value in data.items()
        }
    ...
    @staticmethod
    def _scale(matrix, transform_matrices, inv=False):
        """

        :param matrix:
        :type matrix:
        :param transform_matrices:
        :type transform_matrices:
        :param inv:
        :type inv:
        :return:
        :rtype:
        ...
        return np.dot(
            ...
            transform_matrices[1 if inv else 0]
        )
