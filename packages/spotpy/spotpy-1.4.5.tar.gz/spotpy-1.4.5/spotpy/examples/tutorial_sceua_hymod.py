...
if __name__ == "__main__":
    ...
    sampler=spotpy.algorithms.lhs(spot_setup, dbname='SCEUA_hymod', dbformat='hdf5', alt_objfun=None)
    ...
    with tables.open_file(filename + '.h5', 'r') as db:
        results =  db.root[filename]
