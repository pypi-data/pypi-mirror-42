...
class CloudFoxy(BaseUpstream):
    ...
    def getupstreamconnection(self):
        ...
        # adapter = requests.adapters.HTTPAdapter(max_retries=3, pool_connections=1)
    ...
    def closeupstreamconnection(self, session):
        ...
        :param session:
        :type session: urllib3.PoolManager
        :return:
        """
    ...
    def cmd(self, session, command, terminal, reset=0):
        ...
        return self._get_request(session, self.server.upstream_cmd, payload)
    ...
    def _get_request(self, session, cmd, payload):
        ...
        try:
            ...
            r = session.request('GET', self.server.upstream_url + cmd,
                                headers=self.server.upstream_headers, fields=payload)
