...
class DbStorage:
    ...
    def __init__(self, *credentials):
        self.host, self.port, self.user, self.password = credentials
        self.dbpool = None
        self.datapoints = {}
        self.roads = {}
        self.zones = {}
    ...
    async def async_init(self):
        self.dbpool = await asyncpg.create_pool(host=self.host, port=self.port, user=self.user, password=self.password)
