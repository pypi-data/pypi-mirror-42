...
class D3MDatasetLoader(Loader):
    ...
    def load(self, dataset_uri: str, *, dataset_id: str = None, dataset_version: str = None, dataset_name: str = None, lazy: bool = False,
        ...
        dataset_schema_version = dataset_doc.get('about', {}).get('datasetSchemaVersion', '3.2.0')
        ...
        # "license" is required by the schema, but we want to be compatible with
        # dataset descriptions which do not adhere to the schema. Moreover,
