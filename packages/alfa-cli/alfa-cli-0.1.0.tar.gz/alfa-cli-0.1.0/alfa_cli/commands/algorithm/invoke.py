...
@click.option("--is-path", is_flag=True, help="Indicates that the problem refers to a filepath.")
@click.option(
...
@click.pass_obj
def invoke(obj, algorithm_id, environment_name, problem, *, is_path=False, **kwargs):
