...
#define EPICS_VERSION_SHORT "7.0.2.0"
#define EPICS_VERSION_FULL "7.0.2.0-DEV"
#define EPICS_VERSION_STRING "EPICS 7.0.2.0-DEV"
#define epicsReleaseVersion  "EPICS 7.0.2.0-DEV"
