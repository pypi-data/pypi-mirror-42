...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeMessage, TypeHighScore, TypeDocument, TypeChat, TypeInlineBotSwitchPM, TypeStickerSetCovered, TypeChatFull, TypeDialog, TypeStickerPack, TypeBotInlineResult, TypeUser, TypeFoundGif, TypeStickerSet
