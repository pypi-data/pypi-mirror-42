...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecurePasswordKdfAlgo, TypePasswordKdfAlgo, TypeSecureSecretSettings, TypeWebAuthorization, TypeSecureRequiredType, TypePrivacyRule, TypeWallPaper, TypeSecureValue, TypeUser, TypeAuthorization, TypeSecureValueError
