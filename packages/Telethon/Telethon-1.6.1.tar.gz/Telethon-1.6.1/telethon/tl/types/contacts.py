...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypePeer, TypeChat, TypeTopPeerCategoryPeers, TypeContactLink, TypeImportedContact, TypeContact, TypeContactBlocked, TypeUser
