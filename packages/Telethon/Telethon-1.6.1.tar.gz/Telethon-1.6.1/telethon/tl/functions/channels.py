...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatAdminRights, TypeInputChatPhoto, TypeChatBannedRights, TypeChannelParticipantsFilter, TypeBool, TypeInputUser, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeInputStickerSet, TypeInputChannel
