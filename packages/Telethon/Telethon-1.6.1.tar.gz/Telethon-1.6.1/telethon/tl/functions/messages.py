...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeChatBannedRights, TypeMessagesFilter, TypeInputMedia, TypeInputStickerSet, TypeBool, TypeInputDialogPeer, TypeInputMessage, TypeInputBotInlineMessageID, TypeInputSingleMedia, TypeInputStickeredMedia, TypeInputEncryptedChat, TypeMessageEntity, TypeInputDocument, TypeInputGeoPoint, TypeInputUser, TypeSendMessageAction, TypeShippingOption, TypeReplyMarkup, TypeInlineBotSwitchPM, TypeReportReason, TypeInputPeer, TypeInputEncryptedFile, TypeInputBotInlineResult
