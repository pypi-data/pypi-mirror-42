...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeCodeSettings, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeSecureValueHash, TypeSecureCredentialsEncrypted, TypeWallPaperSettings, TypeAccountDaysTTL, TypeBool, TypeInputSecureValue, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeInputWallPaper, TypeInputFile, TypeReportReason, TypeInputCheckPasswordSRP, TypeInputPeer, TypeSecureValueType
