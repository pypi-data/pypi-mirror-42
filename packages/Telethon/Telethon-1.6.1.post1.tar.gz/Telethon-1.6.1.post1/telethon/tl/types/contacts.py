...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypePeer, TypeImportedContact, TypeContactLink, TypeTopPeerCategoryPeers, TypeContact, TypePopularContact, TypeContactBlocked, TypeUser
