...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeDialog, TypeChat, TypeInlineBotSwitchPM, TypeMessage, TypeBotInlineResult, TypeStickerPack, TypeFoundGif, TypeDocument, TypeStickerSetCovered, TypeHighScore, TypeStickerSet, TypeUser, TypeChatFull
