...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeWallPaper, TypeSecureSecretSettings, TypePasswordKdfAlgo, TypeSecureValueError, TypeWebAuthorization, TypeAuthorization, TypeSecurePasswordKdfAlgo, TypePrivacyRule, TypeSecureRequiredType, TypeSecureValue, TypeUser
