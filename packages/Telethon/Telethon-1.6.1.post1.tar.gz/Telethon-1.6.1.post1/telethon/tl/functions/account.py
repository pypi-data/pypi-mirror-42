...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeSecureValueType, TypeInputNotifyPeer, TypeInputWallPaper, TypeInputFile, TypeSecureCredentialsEncrypted, TypeInputCheckPasswordSRP, TypeBool, TypeCodeSettings, TypeSecureValueHash, TypeReportReason, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeInputSecureValue, TypeWallPaperSettings, TypeInputPeer
