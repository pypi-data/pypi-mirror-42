...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputStickerSet, TypeChannelParticipantsFilter, TypeInputChannel, TypeInputChatPhoto, TypeChatBannedRights, TypeBool, TypeInputUser, TypeChatAdminRights, TypeChannelAdminLogEventsFilter
