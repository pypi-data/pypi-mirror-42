...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeChatBannedRights, TypeInputChatPhoto, TypeInputSingleMedia, TypeInputBotInlineResult, TypeInputStickerSet, TypeBool, TypeInputEncryptedChat, TypeInputPeer, TypeInputStickeredMedia, TypeInputMessage, TypeReplyMarkup, TypeInputDialogPeer, TypeInputDocument, TypeMessagesFilter, TypeSendMessageAction, TypeReportReason, TypeInputUser, TypeInputGeoPoint, TypeMessageEntity, TypeInputMedia, TypeShippingOption
