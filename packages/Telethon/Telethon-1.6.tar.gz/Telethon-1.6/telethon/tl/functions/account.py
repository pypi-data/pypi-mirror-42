...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputCheckPasswordSRP, TypeInputPeer, TypeInputNotifyPeer, TypeInputFile, TypeInputPeerNotifySettings, TypeSecureValueType, TypeSecureCredentialsEncrypted, TypeReportReason, TypeInputPrivacyKey, TypeCodeSettings, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeSecureValueHash, TypeWallPaperSettings, TypeInputSecureValue, TypeBool, TypeInputWallPaper
