...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeInputUser, TypeInputMessage, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeChatAdminRights, TypeChatBannedRights, TypeBool, TypeInputChatPhoto
