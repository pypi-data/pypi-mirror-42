...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSendMessageAction, TypeInlineBotSwitchPM, TypeInputDocument, TypeChatBannedRights, TypeInputSingleMedia, TypeBool, TypeInputPeer, TypeInputBotInlineMessageID, TypeInputUser, TypeMessagesFilter, TypeInputStickerSet, TypeInputGeoPoint, TypeReplyMarkup, TypeInputStickeredMedia, TypeInputEncryptedChat, TypeInputBotInlineResult, TypeMessageEntity, TypeInputChatPhoto, TypeInputEncryptedFile, TypeInputMedia, TypeReportReason, TypeInputMessage, TypeShippingOption, TypeInputDialogPeer
