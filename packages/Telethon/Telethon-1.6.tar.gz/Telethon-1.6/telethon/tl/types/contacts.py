...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeImportedContact, TypePeer, TypeTopPeerCategoryPeers, TypePopularContact, TypeContactBlocked, TypeContact, TypeContactLink, TypeUser, TypeChat
