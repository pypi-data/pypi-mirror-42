...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeChatFull, TypeFoundGif, TypeStickerSetCovered, TypeInlineBotSwitchPM, TypeDocument, TypeStickerPack, TypeHighScore, TypeBotInlineResult, TypeUser, TypeChat, TypeDialog, TypeEncryptedFile, TypeStickerSet
