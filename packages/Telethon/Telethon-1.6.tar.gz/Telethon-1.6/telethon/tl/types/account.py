...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecurePasswordKdfAlgo, TypeWebAuthorization, TypePrivacyRule, TypeSecureValueError, TypePasswordKdfAlgo, TypeSecureRequiredType, TypeSecureSecretSettings, TypeWallPaper, TypeUser, TypeAuthorization, TypeSecureValue
