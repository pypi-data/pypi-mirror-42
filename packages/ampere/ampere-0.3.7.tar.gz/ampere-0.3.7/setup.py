...
ida_requirements2 = [ida_dir+"/ida.h",ida_dir+"/ida_band.h",ida_dir+"/ida_dense.h",ida_dir+"/ida_direct.h",ida_dir+"/ida_ic.h",ida_dir+"/ida_io.h",
...
# if USE_CYTHON:
ext_modules += [
    Extension("ampere.models.P2D.P2D_fd", ["ampere/models/P2D/P2D_fd.c", *ida_requirements1],#, "ampere/models/P2D/p2d_fd_source.c", *ida_requirements],
    include_dirs = [numpy.get_include()])#,  "ampere/models/P2D/p2d_fd_source.c", *ida_requirements2]),
