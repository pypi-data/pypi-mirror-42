...
class Check(object):
    ...
    @property
    def async(self):
        """Gets the async of this Check.  # noqa: E501
        ...
        :return: The async of this Check.  # noqa: E501
        :rtype: bool
        """
        return self._async
    ...
    def async(self, async):
        """Sets the async of this Check.

        If this is set to true, we will queue checks for processing and return a response immediately. You can configure webhooks to notify you when the report is complete. Write-only.   # noqa: E501

        :param async: The async of this Check.  # noqa: E501
        :type: bool
        """
