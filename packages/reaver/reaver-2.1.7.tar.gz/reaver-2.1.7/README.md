...
This section is only relevant if you already had PySC2 installed, otherwise you can skip ahead.  
As of 20/02 the PySC2 version distributed through PIP is outdated, so you will need to reinstall it from source with forced upgrade:
