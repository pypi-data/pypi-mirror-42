...
# The base URL for the CSV-formated (disaggregated) data service
CSVGEN_WEBSERVER_URL_BASE = 'https://hlvkw7mzu7.execute-api.us-east-1.amazonaws.com/V1/dashboard'
