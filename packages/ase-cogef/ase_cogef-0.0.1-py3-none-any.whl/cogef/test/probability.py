...
print('\n' +
      ...
      'respectively')
rates8_12, backrates8_12, \
forces8_12 = load_all_rate_constants(join(path, 'rate_8_12.dat'))
rates29_11, backrates29_11, \
forces29_11 = load_all_rate_constants(join(path, 'rate_29_11.dat'))
forces = forces8_12
...
rates_sp_inter, backrates_sp_inter, \
forces_sp_inter = load_all_rate_constants(join(path, 'rate_SP-INTER.dat'))
