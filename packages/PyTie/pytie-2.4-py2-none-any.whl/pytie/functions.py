...
def freq_corr(DEPTH, gain, f, length, dt):
    """
    ...
    seismogram2 = np.convolve(gain[idx_high[0][1]:idx_low[0][0]], wavelet, mode='same')
    seismogram3 = np.convolve(gain[idx_low[0][1]:], wavelet2, mode='same')
