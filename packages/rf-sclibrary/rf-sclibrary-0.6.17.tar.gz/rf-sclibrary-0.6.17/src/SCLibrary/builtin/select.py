...
class SelectKeywords(object):
    @keyword("SELECT ${properties} FROM ${array}")
    ...
    @keyword("SELECT ONE ${properties} FROM ${array}")
    ...
    @keyword("SELECT ONE ${properties} FROM ${array} WHERE ${conditions}")
