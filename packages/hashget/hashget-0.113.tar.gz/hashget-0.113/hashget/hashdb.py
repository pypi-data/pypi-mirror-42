...
class HashDBClient(HashDB):
    ...
    def hashspec2hp(self, hspec, remote=True):


        for hdb in self.hashdb.values():
            try:
                return hdb.hashspec2hp(hspec)
            except KeyError:
                pass
